...
> [!note] **`03_Gastrointestinal` continues below this file, into `GI_06_Liver_Disease`.**
> That source block is split across `GI_05_Upper_GI_Disease` · `GI_06_Liver_Disease` · `GI_07_Biliary_Pancreas_Small_Bowel_and_IBD` · `GI_08_Obstruction_Appendix_Colorectal_and_Anorectal`.
> The alias `03_Gastrointestinal` resolves to `GI_07_Biliary_Pancreas_Small_Bowel_and_IBD`, which holds its largest part.
