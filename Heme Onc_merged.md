...
- **Mx:**
  ...
  - If VTE occurs, prophylactic DOAC for 3 months (6 months if unprovoked) — see [[01_Cardiovascular]] 0.28 Deep Vein Thrombosis (DVT) and 0.29 Pulmonary Embolism (PE) for the disease-level Mx this feeds into, not repeated here.
...
> **AXIS 2 — THE RETICULOCYTE COUNT: is the marrow responding?**
> **· HIGH reticulocytes → the marrow is working, so the problem is LOSS or DESTRUCTION — bleeding or haemolysis.**
> **· LOW or inappropriately normal reticulocytes → the marrow is NOT responding, so the problem is PRODUCTION — deficiency, marrow failure, infiltration, chronic disease, or renal.**
> **THE RETICULOCYTE COUNT IS THE MOST UNDER-USED TEST IN ANAEMIA.** It costs nothing extra, it splits the differential in half, and it is routinely not requested.

> [!warning] Request the blood film — and read the report
> **The FILM identifies things no numerical index can: BLASTS · schistocytes (fragments) indicating microangiopathy · spherocytes · sickle cells · HYPERSEGMENTED NEUTROPHILS · target cells · a DIMORPHIC picture indicating combined deficiency · rouleaux suggesting a paraprotein · and leucoerythroblastic change suggesting marrow infiltration.**
> **A raised RDW (red cell distribution width) indicates a mixed population** — which is a clue to combined deficiency where a normal MCV is the average of small and large cells.
...
## 0.2 Microcytic Anaemia

> [!info] The causes — TAILS
> **T — THALASSAEMIA · A — Anaemia of chronic disease (usually normocytic, sometimes microcytic) · I — IRON DEFICIENCY · L — Lead poisoning · S — Sideroblastic anaemia.**
> **In practice it is almost always iron deficiency, thalassaemia trait, or chronic disease.**

> [!danger] A normal ferritin does not exclude iron deficiency
> **Ferritin is the single best test for iron deficiency — and it is an ACUTE PHASE REACTANT.**
> **It rises with INFLAMMATION, INFECTION, MALIGNANCY, LIVER DISEASE and chronic kidney disease** — so an inflamed patient can have a "normal" or even raised ferritin while being genuinely iron deficient.
> **This is one of the commonest reasons iron deficiency is missed in hospital inpatients, who are inflamed by definition.**
> **When ferritin may be unreliable, check the CRP alongside it, and look at the TRANSFERRIN SATURATION**, which is less affected by inflammation.
...
> **The clue: MICROCYTOSIS DISPROPORTIONATE TO THE DEGREE OF ANAEMIA — a strikingly low MCV with a haemoglobin that is normal or only mildly reduced — with a NORMAL OR HIGH red cell COUNT (in iron deficiency the red cell count is low).**
> **The ferritin is NORMAL.**
> **The Mentzer index (MCV divided by red cell count) is a useful discriminator.** `UNVERIFIED — the cut-off.`
...
## 0.3 Macrocytic Anaemia

> [!tip] Megaloblastic versus non-megaloblastic
> **MEGALOBLASTIC — impaired DNA synthesis: B12 and FOLATE deficiency, and drugs interfering with DNA synthesis.** **HYPERSEGMENTED NEUTROPHILS on the film are the clue.**
> **NON-MEGALOBLASTIC — everything else:**
> **· ALCOHOL — the commonest cause of macrocytosis in Australian practice, and it causes macrocytosis WITHOUT anaemia very frequently. A raised MCV should prompt an alcohol history.**
> **· LIVER DISEASE · HYPOTHYROIDISM · RETICULOCYTOSIS (reticulocytes are large, so brisk haemolysis or recovery from bleeding raises the MCV) · pregnancy · MYELODYSPLASIA · and DRUGS (hydroxycarbamide, azathioprine, methotrexate, antiretrovirals, anticonvulsants).**

> [!danger] B12 deficiency causes neurological damage that can occur without anaemia
...
> **CHECK BOTH B12 AND FOLATE, and if giving folate before the B12 result is available, GIVE B12 TOO.**
> **This is a classic examination point and a genuine clinical harm.**

> [!warning] The causes of B12 deficiency — and the drugs
> **· PERNICIOUS ANAEMIA — autoimmune, with anti-intrinsic factor antibodies (specific but insensitive) and anti-parietal cell antibodies (sensitive but non-specific). Associated with other autoimmune disease and with an increased gastric cancer risk.**
> **· GASTRIC — gastrectomy, bariatric surgery, atrophic gastritis.**
...
> **MACROCYTOSIS + one or more cytopenias + a DYSPLASTIC film in an older patient = MYELODYSPLASTIC SYNDROME until proven otherwise.**
> **Look for: hypogranular or hyposegmented neutrophils (pseudo-Pelger-Huët), dysplastic red cells, and blasts.**
> **It requires haematology referral and bone marrow examination**, and it matters because it can transform to acute leukaemia and because supportive management changes quality of life.

---

## 0.4 Normocytic Anaemia

> [!tip] Anaemia of chronic disease versus iron deficiency — the iron studies distinguish them
> | | **IRON DEFICIENCY** | **ANAEMIA OF CHRONIC DISEASE** |
> |---|---|---|
> | Ferritin | **LOW** | **Normal or HIGH** |
> | Serum iron | Low | Low |
> | **TIBC / transferrin** | **HIGH** (the body is trying to capture iron) | **LOW** |
> | Transferrin saturation | Low | Low or normal |
> | MCV | Low | Normal, sometimes low |
> **THE TIBC IS THE DISCRIMINATOR: HIGH in iron deficiency, LOW in chronic disease.**
> **The mechanism of anaemia of chronic disease is HEPCIDIN — inflammation raises hepcidin, which blocks intestinal iron absorption and traps iron in macrophages.** **There is plenty of iron; it is just not available.** **This is why oral iron does not work in inflammatory anaemia** and why treating the underlying inflammation is the actual treatment.
...
## 0.5 White Cell Disorders

> [!tip] Interpreting a raised white cell count
> **· NEUTROPHILIA — bacterial infection · inflammation and tissue necrosis · CORTICOSTEROIDS (through demargination, so a steroid-treated patient has a high neutrophil count without infection) · stress and exercise · smoking · myeloproliferative disorders · and malignancy.** **A "left shift" with toxic granulation supports infection.**
> **· LYMPHOCYTOSIS — viral infection, particularly EBV (with ATYPICAL LYMPHOCYTES) · PERTUSSIS (which classically causes a marked lymphocytosis) · and CHRONIC LYMPHOCYTIC LEUKAEMIA in an older person, with a persistent lymphocytosis and SMEAR (smudge) CELLS on the film.**
> **· MONOCYTOSIS — chronic infection (TB), inflammation, and chronic myelomonocytic leukaemia.**
> **A very high white cell count with immature cells and BLASTS is leukaemia and requires urgent haematology involvement** — see 0.6.
> **LEUKAEMOID REACTION — an extreme reactive neutrophilia mimicking leukaemia, seen in severe infection and in malignancy. Distinguished from chronic myeloid leukaemia by the clinical context and by molecular testing (BCR-ABL).**

> [!danger] Eosinophilia — and the one that kills if you give steroids
> **Causes: ALLERGY and atopy (asthma, eczema, allergic rhinitis) · DRUGS (a very common cause — and DRESS syndrome presents with eosinophilia, rash, fever and organ involvement) · PARASITES · vasculitis, particularly EOSINOPHILIC GRANULOMATOSIS WITH POLYANGIITIS · malignancy including lymphoma · ADRENAL INSUFFICIENCY · and hypereosinophilic syndrome.**
> **THE CRITICAL AUSTRALIAN POINT: *STRONGYLOIDES STERCORALIS*.**
...
## 0.6 Platelet Disorders and Pancytopenia

> [!danger] Always exclude pseudothrombocytopenia first
> **EDTA in the standard blood tube causes platelets to CLUMP in some individuals, producing a spuriously low automated count in a patient with entirely normal platelets.**
> **THE FILM SHOWS CLUMPS. Repeating the sample in a CITRATE tube gives the true count.**
> **Checking this first prevents unnecessary investigation, unnecessary transfusion, and cancelled procedures** — and it is the first thing to do with an unexpected isolated thrombocytopenia in a patient who is not bleeding.

> [!tip] Thrombocytopenia by mechanism
> **· REDUCED PRODUCTION — marrow failure, infiltration, myelodysplasia, B12 and folate deficiency, alcohol, viral infection, drugs.**
...
> **· IN CHILDREN — typically follows a viral illness, presents with petechiae and bruising in a WELL child, and is usually SELF-LIMITING. Most require observation rather than treatment.**
> **· IN ADULTS — more often chronic and requiring treatment.**
> **TREATMENT IS BASED ON BLEEDING AND RISK, NOT ON THE PLATELET COUNT ALONE.** A patient with a very low count and no bleeding may need no immediate treatment; the count is not the target.
> **Options: corticosteroids, intravenous immunoglobulin (which works faster and is used where rapid rise is needed), and second-line agents.**
> **PLATELET TRANSFUSION IS GENERALLY INEFFECTIVE in ITP** (the transfused platelets are destroyed too) and is reserved for life-threatening bleeding.
...
> **Causes:**
> **· MARROW FAILURE — APLASTIC ANAEMIA, myelodysplasia, acute leukaemia.**
> **· MARROW INFILTRATION (myelophthisis) — metastatic carcinoma, lymphoma, myeloma, myelofibrosis. A LEUCOERYTHROBLASTIC film (nucleated red cells and immature white cells) suggests it.**
> **· MEGALOBLASTIC ANAEMIA — SEVERE B12 OR FOLATE DEFICIENCY CAUSES PANCYTOPENIA, AND IT IS COMPLETELY REVERSIBLE.** **Check B12 and folate in every pancytopenia before proceeding to a marrow biopsy** — it is cheap, it is common, and correcting it resolves the picture.
> **· HYPERSPLENISM — cirrhosis, portal hypertension, lymphoproliferative disease.**
> **· AUTOIMMUNE — systemic lupus erythematosus.**
> **· INFECTION — HIV, disseminated TB, viral, leishmaniasis, severe sepsis.**
> **· DRUGS AND TOXINS — chemotherapy, many others, alcohol, benzene, radiation.**
> **· Paroxysmal nocturnal haemoglobinuria and haemophagocytic lymphohistiocytosis.**

> [!warning] When to phone the haematologist rather than send a referral
> **· BLASTS on the film.**
> **· A very high white cell count with symptoms of LEUCOSTASIS — breathlessness, confusion, visual change — which is a hyperviscosity emergency.**
> **· Pancytopenia with systemic illness.**
...
## 0.1 Recognising Haemolysis

> [!tip] The laboratory signature — four tests together
> **· RETICULOCYTES — RAISED (the marrow is responding).**
...
> **Causes: autoimmune haemolytic anaemia · hereditary spherocytosis · hypersplenism.**

> [!danger] The blood film tells you the mechanism
> **· SPHEROCYTES → autoimmune haemolytic anaemia OR hereditary spherocytosis. THE DAT DISTINGUISHES THEM.**
> **· SCHISTOCYTES (fragments) → MICROANGIOPATHIC haemolysis — TTP, HUS, DIC, HELLP, malignant hypertension, mechanical valve. THIS IS THE URGENT ONE.**
> **· BITE CELLS and BLISTER CELLS, with Heinz bodies on supravital stain → OXIDATIVE haemolysis, i.e. G6PD deficiency.**
...
> **· Blister/nucleated red cells with a leucoerythroblastic picture → marrow infiltration.**

> [!warning] The DAT is the branch point, and chronic haemolysis has predictable complications
> **DIRECT ANTIGLOBULIN TEST (Coombs): POSITIVE means IMMUNE-mediated; NEGATIVE means NON-immune.** That single result splits the differential in two.
...
## 0.2 Inherited Haemolytic Anaemias

> [!tip] Hereditary spherocytosis
> **A red cell membrane cytoskeleton defect (spectrin, ankyrin, band 3), usually autosomal dominant, causing spherical cells that are trapped and destroyed in the spleen.**
> **Features: anaemia, JAUNDICE, SPLENOMEGALY, and PIGMENT GALLSTONES — often presenting in childhood, sometimes with neonatal jaundice.**
...
> **G6PD maintains the NADPH needed to protect the cell against oxidative stress. Under an oxidative load, haemoglobin denatures into HEINZ BODIES, which the spleen removes by "biting" pieces out of the cell — producing BITE CELLS and BLISTER CELLS.**
> **THE TRIGGERS:**
...
## 0.3 Autoimmune Haemolytic Anaemia

> [!tip] Warm versus cold — the difference changes the treatment
> | | **WARM AIHA** | **COLD AGGLUTININ DISEASE** |
> |---|---|---|
> | Antibody | **IgG** | **IgM** |
> | Optimal temperature | 37°C | Cold (peripheries) |
> | Site of destruction | **Extravascular (spleen)** | Complement-mediated, **intravascular** |
> | Film | **Spherocytes** | **AGGLUTINATION** |
> | Symptoms | Anaemia, jaundice, splenomegaly | **ACROCYANOSIS, worse in the cold** |
> | Causes | Idiopathic · **LYMPHOPROLIFERATIVE (CLL, lymphoma)** · SLE and autoimmune disease · drugs (methyldopa, penicillins, cephalosporins, **checkpoint inhibitors**) | ***MYCOPLASMA*** · **EBV** · lymphoproliferative disease |
> | First-line treatment | **CORTICOSTEROIDS** | **KEEP THE PATIENT WARM** — steroids are much less effective |
> **Warm AIHA: steroids first, then rituximab or splenectomy, and treat the underlying cause — which means looking for a lymphoproliferative disorder or connective tissue disease in a new presentation.**
> **Cold agglutinin disease: warming is the primary intervention — a warm room, warm clothing, warming intravenous fluids, and WARMING ANY TRANSFUSED BLOOD, which is a practical point that gets missed.** Treat the underlying infection or lymphoproliferative disorder; rituximab for persistent disease.
> **PAROXYSMAL COLD HAEMOGLOBINURIA — a Donath-Landsteiner biphasic antibody, classically in children after a viral illness, causing acute intravascular haemolysis on cold exposure.**

> [!warning] Transfusion in autoimmune haemolysis is complicated — but do not withhold it
> **The autoantibody reacts with essentially all donor cells, making crossmatching difficult and slow, and it can MASK an underlying alloantibody.**
> **Involve the transfusion laboratory EARLY and give them time.**
> **But: in life-threatening anaemia, the "least incompatible" unit is given rather than allowing the patient to die waiting for a perfect match.** **Do not withhold necessary transfusion because the crossmatch is difficult** — that decision belongs with a haematologist, made urgently, not with a junior doctor deferring.
> **EVANS SYNDROME — autoimmune haemolytic anaemia combined with immune thrombocytopenia** (and sometimes neutropenia), which warrants investigation for an underlying lymphoproliferative or autoimmune disorder.

---

## 0.4 Microangiopathic and Mechanical Haemolysis
...
> [!tip] Paroxysmal nocturnal haemoglobinuria — haemolysis with thrombosis
> **An acquired clonal defect in GPI-anchored complement regulatory proteins (CD55 and CD59), leaving red cells vulnerable to complement-mediated intravascular lysis.**
...
## 0.5 Sickle Cell Disease

**A/P:** **A single amino acid substitution — valine for glutamic acid at position 6 of the beta globin chain — produces haemoglobin S, which POLYMERISES when DEOXYGENATED.** The polymer distorts the cell into a rigid sickle shape, causing **VASO-OCCLUSION** (the source of the acute pain and organ damage) and **CHRONIC HAEMOLYSIS**.
**Sickle cell TRAIT is largely asymptomatic and is PROTECTIVE AGAINST FALCIPARUM MALARIA** — the reason the gene persists. **But trait is not entirely benign: it causes renal papillary necrosis and haematuria, and sickling can occur under extreme hypoxia, dehydration or at altitude.**

> [!danger] Vaso-occlusive crisis — and the systematic under-treatment of pain
> **Precipitants: INFECTION · DEHYDRATION · COLD · HYPOXIA · acidosis · physical or emotional STRESS · alcohol · and often nothing identifiable.**
> **THE PAIN IS SEVERE — frequently described by patients as worse than childbirth or a fracture — and it requires PROMPT and ADEQUATE ANALGESIA, usually including strong opioids, given rapidly on presentation.**
> **PATIENTS WITH SICKLE CELL DISEASE ARE SYSTEMATICALLY UNDER-TREATED FOR PAIN.** They wait longer in emergency departments, receive less analgesia, and are labelled as drug-seeking — a pattern that is well documented, that disproportionately affects patients of African ancestry, and that constitutes a genuine equity failure in healthcare.
> **These patients know their own crises and their own effective doses. Believe them.** **A patient who asks for a specific opioid at a specific dose is usually describing what has worked before, not manipulating you.**
> **Alongside analgesia: hydration, oxygen if hypoxic, warmth, treatment of any infective trigger, thromboprophylaxis, and INCENTIVE SPIROMETRY.**

> [!danger] Acute chest syndrome — and adequate analgesia prevents it
> **A new pulmonary infiltrate with fever, chest pain, cough, hypoxia or respiratory signs, in a patient with sickle cell disease.**
> **IT IS THE LEADING CAUSE OF DEATH in sickle cell disease.**
> **THE MECHANISM CONNECTS IT TO ANALGESIA: severe chest or back pain → the patient SPLINTS and breathes shallowly → atelectasis → hypoxia → local sickling → infiltrate.**
> **SO UNDER-TREATING PAIN CAUSES ACUTE CHEST SYNDROME, and adequate analgesia plus INCENTIVE SPIROMETRY prevents it.** **This is the strongest argument for treating the pain properly, and it should be made to anyone reluctant to give opioids.**
> **Management: antibiotics (covering atypicals), oxygen, adequate analgesia, bronchodilators, and TRANSFUSION or EXCHANGE TRANSFUSION for severe or deteriorating disease.** **Escalate early — it can deteriorate rapidly.**

> [!warning] The other acute complications
...
> **· Proliferative retinopathy · sickle nephropathy and chronic kidney disease · PULMONARY HYPERTENSION · chronic LEG ULCERS · pigment gallstones · delayed growth and puberty · and iron overload in those regularly transfused.**
> **Management: HYDROXYCARBAMIDE (hydroxyurea), which raises fetal haemoglobin and reduces crises, acute chest syndrome and mortality — the single most important disease-modifying therapy · FOLATE · vaccination and penicillin prophylaxis · transcranial Doppler screening in children · transfusion programmes · newer targeted agents · and stem cell transplantation or gene therapy in selected patients.** `UNVERIFIED — all agents, doses and eligibility.`
> **AUSTRALIAN CONTEXT: sickle cell disease is relatively uncommon here but is increasing with migration, and it is therefore under-recognised.** **A patient of African, Middle Eastern, Mediterranean, Indian or Caribbean ancestry presenting with severe unexplained pain should prompt the thought**, and their disease may be less familiar to the treating team than it should be.

---

## 0.6 Thalassaemia

**A/P:** **Reduced or absent synthesis of alpha or beta globin chains → an IMBALANCE of chains → the excess unpaired chains precipitate → INEFFECTIVE ERYTHROPOIESIS in the marrow plus peripheral HAEMOLYSIS.**
...
> [!warning] Alpha thalassaemia — four genes, four phenotypes
> **There are four alpha globin genes, and severity depends on how many are lost:**
> **· ONE deleted — silent carrier, normal.**
> **· TWO deleted — alpha thalassaemia trait, with microcytosis and a NORMAL haemoglobin electrophoresis. This is why alpha thalassaemia trait requires GENETIC testing to diagnose, and why a normal electrophoresis does not exclude thalassaemia.**
> **· THREE deleted — HbH DISEASE, with moderate to severe haemolytic anaemia.**
> **· FOUR deleted — Hb BARTS HYDROPS FETALIS, which is incompatible with life and carries significant risk to the MOTHER (severe pre-eclampsia and obstetric complications).**
> **The last point is why ANTENATAL SCREENING AND PARTNER TESTING matter**, particularly in couples of Southeast Asian, Chinese and Mediterranean ancestry.

> [!danger] Iron overload is what kills transfusion-dependent patients
> **Each unit of transfused blood delivers iron, and the body has no mechanism to excrete it. Ineffective erythropoiesis also increases gut absorption.**
> **The consequences, in order of what causes death:**
...
> [!danger] Do not give iron to a thalassaemia patient
> **They are anaemic and microcytic, so iron gets prescribed reflexively — and it adds to an iron burden that is already the thing most likely to kill them.**
> **Only give iron if deficiency has been PROVEN**, recognising that thalassaemia and iron deficiency can genuinely coexist.
> **Other management: FOLATE · vaccination and, where splenectomised, prophylaxis · monitoring for the endocrine complications · osteoporosis screening · and stem cell transplantation in selected patients.**
> **GENETIC COUNSELLING AND ANTENATAL SCREENING are central**, and identifying a carrier obliges an offer of partner testing and counselling.

**Ix:** **FBC, BLOOD FILM and RETICULOCYTE count** (*why:* the film identifies the mechanism and the reticulocytes confirm marrow response; *what:* spherocytes, schistocytes, bite cells, sickle cells, target cells, agglutination). **LDH, bilirubin (split) and HAPTOGLOBIN** (*why:* the haemolysis screen — and haptoglobin is an acute phase reactant so interpret with the CRP; *what:* the haemolytic pattern). **DIRECT ANTIGLOBULIN TEST** (*why:* the branch point between immune and non-immune haemolysis; *what:* IgG or complement coating). **G6PD assay — REPEATED AFTER RECOVERY if taken during a crisis** (*why:* it is falsely normal acutely because the deficient cells have already lysed; *what:* enzyme activity). **Haemoglobin ELECTROPHORESIS or HPLC — with GENETIC testing for alpha thalassaemia, which has a normal electrophoresis** (*why:* diagnoses the haemoglobinopathy and has genetic counselling implications; *what:* HbS, raised HbA2, HbH). **Thick and thin films for MALARIA in any febrile haemolysis with travel history** (*why:* it kills fastest and is treatable; *what:* parasites and species). **Flow cytometry for PNH** where unexplained intravascular haemolysis, unusual-site thrombosis, or cytopenias (*why:* it is diagnosable and treatable, and thrombosis is what kills; *what:* CD55/CD59-deficient clone). **Coagulation profile in a microangiopathic picture** (*why:* NORMAL clotting favours TTP; deranged favours DIC — a genuinely useful discriminator; *what:* PT, APTT, fibrinogen, D-dimer). **Parvovirus B19 serology or PCR in a chronic haemolytic patient with a falling haemoglobin and LOW reticulocytes** (*why:* aplastic crisis; *what:* acute infection). **Cardiac and hepatic MRI T2\* in transfusion-dependent patients** (*why:* measures tissue iron directly, and cardiac iron is what kills, while ferritin correlates imperfectly; *what:* iron loading). Echocardiography (*why:* pulmonary hypertension in sickle cell disease, and iron cardiomyopathy in thalassaemia; *what:* pressures, function).
...
> [!warning] Sourcing
> Written from model knowledge, not retrieved from source. Mechanism, interpretation and clinical reasoning are reliable at intern level. **Every dose, score, threshold and treatment duration carries an `UNVERIFIED` marker naming what to check, or has been omitted with the omission stated in place.** Verify against **eTG**, the **Australian Medicines Handbook**, and Thrombosis and Haemostasis Society of Australia and New Zealand guidance.
>
> **Anticoagulant reversal and massive haemorrhage are built in [[A9]] 0.3–0.4**, **HIT and TTP in [[J1]] 0.6**, and **pulmonary embolism as a shock state in [[F0.3]] 0.4** — cross-referenced rather than repeated.
...
> **Von Willebrand factor does two things: it mediates PLATELET ADHESION to damaged endothelium, and it is the CARRIER PROTEIN FOR FACTOR VIII** — which is why severe deficiency also lowers factor VIII and prolongs the APTT.
> **THE BLEEDING PATTERN IS MUCOCUTANEOUS: epistaxis · easy bruising · gum bleeding · HEAVY MENSTRUAL BLEEDING SINCE MENARCHE · bleeding after dental extraction and surgery · and POSTPARTUM HAEMORRHAGE.**
> **This contrasts with haemophilia, where bleeding is DEEP — into joints and muscles.** **Mucocutaneous versus deep is the discriminating pattern.**
> **Types: 1 (partial quantitative deficiency — the commonest and mildest) · 2 (qualitative defects, with subtypes) · 3 (near-complete deficiency, severe).**

> [!danger] A single normal von Willebrand level does not exclude the diagnosis
> **vWF levels are highly variable and RISE with: stress, exercise, acute illness and INFLAMMATION, PREGNANCY, and OESTROGEN (including the combined pill).**
> **And they vary with BLOOD GROUP — people with blood group O have physiologically LOWER vWF levels**, which affects interpretation of the reference range.
> **So testing a stressed, inflamed, pregnant or oestrogen-exposed patient can produce a falsely normal result.** **REPEAT TESTING on a separate occasion is often required, and a strong bleeding history should not be dismissed on one normal set.**
> **Treatment: DESMOPRESSIN — which releases stored vWF from endothelium and works in TYPE 1, does NOT work in TYPE 3 (there is nothing to release), and can WORSEN TYPE 2B (by causing platelet clumping and thrombocytopenia).** **A trial of desmopressin establishes whether an individual responds.**
> **Also: von Willebrand factor concentrate · and TRANEXAMIC ACID, which is cheap, effective and under-used for mucosal bleeding and heavy menstrual bleeding.** Cross-refer [[O4]] 0.2.

> [!tip] Haemophilia A and B
> **X-linked deficiency of FACTOR VIII (haemophilia A) or FACTOR IX (haemophilia B), with severity graded by residual factor level.**
> **The bleeding pattern is DEEP: HAEMARTHROSIS (recurrent joint bleeding leading to chronic arthropathy) and MUSCLE bleeds — including iliopsoas bleeds, which present as hip flexion, groin pain and a femoral nerve palsy and can cause substantial concealed blood loss.**
> **Practical rules for the ward:**
> **· TREAT FIRST, INVESTIGATE SECOND. "When in doubt, treat" — factor replacement is given at the first suspicion of a bleed, not after imaging confirms it.**
> **· HEAD INJURY IN A HAEMOPHILIC PATIENT: GIVE FACTOR BEFORE THE CT SCAN.** Intracranial haemorrhage is the leading cause of death, and waiting for imaging wastes the window.
> **· NO INTRAMUSCULAR INJECTIONS.** **This includes vaccinations, which should be given subcutaneously or with factor cover.**
> **· AVOID ASPIRIN AND NSAIDs.**
> **· Involve the patient's HAEMOPHILIA CENTRE early — they know the patient's regimen, inhibitor status and product.** **These patients know their disease better than you do.**
> **INHIBITORS — alloantibodies against the replaced factor — are the major treatment complication, rendering standard replacement ineffective and requiring bypassing agents.**
> **Female carriers can be symptomatic**, with low factor levels causing bleeding, and are frequently overlooked.

> [!info] The rarer inherited causes
> **· FACTOR XIII DEFICIENCY — a NORMAL PT AND APTT, with DELAYED bleeding after initial haemostasis, poor wound healing, and classically UMBILICAL STUMP BLEEDING in a neonate.** **It is missed because the screen is normal.**
> **· Other rare factor deficiencies, and inherited platelet function disorders (Glanzmann thrombasthenia, Bernard-Soulier syndrome).**
> **· CONNECTIVE TISSUE AND VASCULAR: Ehlers-Danlos syndrome · and HEREDITARY HAEMORRHAGIC TELANGIECTASIA (Osler-Weber-Rendu) — with recurrent epistaxis, mucocutaneous telangiectasia, iron deficiency, and ARTERIOVENOUS MALFORMATIONS in lung, liver and brain, which have their own consequences including paradoxical embolism and cerebral abscess.**

---

## 0.3 Acquired Bleeding Disorders

> [!danger] The INR does not predict bleeding risk in liver disease
> **Liver disease reduces BOTH procoagulant factors AND the natural anticoagulants (protein C, protein S, antithrombin) — producing a "REBALANCED" but fragile haemostatic state.**
> **THEREFORE: A RAISED INR IN CIRRHOSIS IS NOT A RELIABLE MARKER OF BLEEDING RISK, and these patients ARE STILL AT RISK OF THROMBOSIS — including portal vein thrombosis and venous thromboembolism.**
> **Two practical consequences that are commonly got wrong:**
> **1. Do NOT transfuse plasma to "correct" the INR before a procedure in a cirrhotic patient purely on the basis of the number — it is largely ineffective, causes volume overload and raises portal pressure.**
> **2. Do NOT withhold VTE prophylaxis in a cirrhotic patient simply because the INR is raised.** Cross-refer [[C3]] 0.5.

> [!warning] The acquired causes
> **· VITAMIN K DEFICIENCY — malabsorption, biliary obstruction (no bile, no fat-soluble vitamin absorption), prolonged antibiotics, malnutrition, and the newborn.** Cross-refer [[M3]] 0.3. **Corrected with vitamin K, which takes hours — so acute reversal needs factor concentrate.**
> **· DIC — cross-refer [[A9]] 0.3.**
> **· RENAL FAILURE — uraemia causes PLATELET DYSFUNCTION with a normal platelet count and normal clotting screen. DESMOPRESSIN is the specific short-term treatment**, alongside dialysis and correcting anaemia.
> **· DRUGS — antiplatelets, anticoagulants, and the contributors people forget: SSRIs (which impair platelet serotonin uptake, particularly combined with NSAIDs or anticoagulants) and NSAIDs.** Cross-refer [[N4]] 0.3.
> **· MASSIVE TRANSFUSION and dilutional coagulopathy.**

> [!danger] Two acquired disorders worth recognising by pattern
> **1. ACQUIRED HAEMOPHILIA — an autoantibody against factor VIII.**
> **The pattern: NEW, SEVERE, often SPONTANEOUS bleeding — typically extensive bruising, muscle and soft tissue bleeds rather than haemarthroses — in an OLDER person with NO prior bleeding history, with an ISOLATED PROLONGED APTT THAT DOES NOT CORRECT ON MIXING.**
> **Associated with malignancy, autoimmune disease, pregnancy and the postpartum period, and drugs — but often idiopathic.**
> **It carries significant mortality and requires urgent haematology involvement: bypassing agents for the bleeding, and immunosuppression to eradicate the inhibitor.**
> **It is missed because a new bleeding disorder in an elderly patient is not expected.**
> **2. ACQUIRED VON WILLEBRAND SYNDROME — and HEYDE SYNDROME specifically.**
> **HEYDE SYNDROME: severe AORTIC STENOSIS + gastrointestinal bleeding from ANGIODYSPLASIA + ACQUIRED von Willebrand disease.** **The mechanism: high shear stress across the stenotic valve unfolds and degrades the large vWF multimers, impairing platelet adhesion at exactly the sites (angiodysplastic lesions) most likely to bleed.**
> **The point that makes it examinable and clinically important: IT RESOLVES WITH AORTIC VALVE REPLACEMENT.** **Recurrent obscure GI bleeding in a patient with aortic stenosis should prompt this thought rather than endless endoscopy.** Cross-refer [[B5]] 0.2 and [[C4]] 0.3.
> **Acquired vWD also occurs with myeloproliferative neoplasms, monoclonal gammopathy, and ventricular assist devices.**

---

## 0.4 Venous Thromboembolism — Diagnosis

> [!danger] Clinical probability FIRST, then the test — the order is not optional
> **The D-dimer is only useful in patients with LOW or INTERMEDIATE clinical probability, where a NEGATIVE result RULES OUT venous thromboembolism.**
> **IN HIGH PROBABILITY, THE D-DIMER IS USELESS — a negative result does not exclude the diagnosis and a positive result adds nothing. GO STRAIGHT TO IMAGING.**
> **Sending a D-dimer first, and then being reassured by a negative result in a patient with a swollen leg and a recent long-haul flight, is a recognised diagnostic error.**
> **D-dimer is raised by: infection · MALIGNANCY · PREGNANCY · recent surgery or trauma · inflammation of any kind · liver disease · and INCREASING AGE — which is why AGE-ADJUSTED D-dimer thresholds improve specificity in older patients without losing sensitivity.** `UNVERIFIED — the Wells scores, PERC rule, and age-adjusted D-dimer formula.`

> [!warning] Investigating DVT and PE
> **DVT: COMPRESSION ULTRASOUND.** **A negative scan in a patient with high clinical suspicion warrants a REPEAT SCAN after a few days**, because a distal thrombus may propagate and become detectable.
> **PE: CT PULMONARY ANGIOGRAPHY is the standard.**
> **V/Q or V/Q SPECT where CTPA is contraindicated — contrast allergy, significant renal impairment, or PREGNANCY (where the radiation dose to breast tissue from CTPA is a consideration and the choice should be discussed with the woman).** Cross-refer [[O2]].
> **The supporting tests, and what they actually contribute:**
> **· ECG — SINUS TACHYCARDIA is the commonest finding. The classic S1Q3T3 is UNCOMMON and its absence means nothing. Right heart strain (right axis deviation, RBBB, T inversion in V1–V4) suggests a larger clot burden.**
> **· CHEST RADIOGRAPH — usually normal or non-specific; its role is excluding alternatives.**
> **· ABG — non-specific, and a NORMAL A-a gradient does NOT exclude PE.**
> **· TROPONIN and BNP — prognostic rather than diagnostic; elevation indicates right ventricular strain and worse outcome.**
> **· ECHOCARDIOGRAPHY — for right ventricular strain in the unstable patient, where it may support immediate thrombolysis without CT.** Cross-refer [[F0.3]] 0.4.

> [!danger] Do not wait for imaging to anticoagulate
> **In a patient with HIGH clinical probability of VTE and no contraindication to anticoagulation, START TREATMENT while awaiting imaging.**
> **Delays occur routinely — the scan is overnight, the radiologist is busy, the patient is nil by mouth — and untreated pulmonary embolism kills during those hours.**
> **The corollary: massive PE with haemodynamic instability is a resuscitation problem requiring immediate senior involvement and consideration of THROMBOLYSIS, not a diagnostic problem.** Cross-refer [[F0.3]] 0.4.

---

## 0.5 Management and Anticoagulant Choice

> [!tip] DOACs are first-line for most — and the exceptions are what get tested
> **Direct oral anticoagulants are the default for most venous thromboembolism and for non-valvular atrial fibrillation: no monitoring, fewer interactions, at least equivalent efficacy, and less intracranial bleeding.**
> **THE SITUATIONS WHERE A DOAC IS NOT APPROPRIATE:**
> **· MECHANICAL HEART VALVES — DOACs are CONTRAINDICATED; warfarin is required. This was demonstrated in a trial stopped early for harm.**
> **· MODERATE TO SEVERE MITRAL STENOSIS.**
> **· ANTIPHOSPHOLIPID SYNDROME, particularly triple-antibody-positive or arterial thrombosis — warfarin is preferred, as DOACs performed worse.**
> **· SEVERE RENAL IMPAIRMENT — dose reduction or avoidance depending on the agent and the creatinine clearance.**
> **· PREGNANCY AND BREASTFEEDING — LMWH is used; DOACs and warfarin are not.**
> **· Extremes of body weight, significant drug interactions (enzyme inducers), and adherence concerns where monitored therapy may be safer.**
> `UNVERIFIED — agents, doses, renal thresholds and PBS criteria.`

> [!warning] Warfarin practicalities
> **· It takes DAYS to work, and it is transiently PROCOAGULANT at initiation because protein C (short half-life) falls before the procoagulant factors — hence the need for heparin cover at the start, and the risk of warfarin-induced skin necrosis.**
> **· INTERACTIONS are numerous — antibiotics (particularly metronidazole, macrolides and co-trimoxazole), amiodarone, antifungals, and enzyme inducers.** **Check the interaction whenever prescribing anything to a warfarinised patient.**
> **· DIET: the message is CONSISTENCY, not avoidance.** **Patients are frequently told to avoid green vegetables entirely, which is wrong and unhelpful — a steady intake is what matters.**
> **· Reversal — cross-refer [[A9]] 0.4.**

> [!tip] Duration of anticoagulation — the framework
> **The question is whether the thrombosis was PROVOKED, and by what:**
> **· Provoked by a MAJOR TRANSIENT risk factor (surgery, trauma, immobilisation, pregnancy) → a defined SHORTER course, because the risk factor has resolved and recurrence risk is low.**
> **· UNPROVOKED → a LONGER or EXTENDED course, because recurrence risk after stopping is substantial — weighed against bleeding risk and patient preference, and reviewed periodically rather than decided once.**
> **· CANCER-ASSOCIATED → anticoagulation while the cancer is active or being treated.**
> **· RECURRENT unprovoked VTE → indefinite.**
> **· Isolated DISTAL (calf) DVT → may be managed with surveillance ultrasound rather than anticoagulation in selected low-risk patients.**
> `UNVERIFIED — the specific durations.`
> **Reduced-dose extended anticoagulation is an option for extended prevention** in some patients.

> [!warning] Three management points that are commonly got wrong
> **1. AFTER AN UNPROVOKED VTE, DO ONLY AGE-APPROPRIATE CANCER SCREENING.** **Extensive occult malignancy screening — whole-body CT and tumour markers — does NOT improve outcomes and generates incidental findings, anxiety and cost.** **A thorough history and examination, basic bloods, and ensuring the patient is up to date with bowel, breast and cervical screening is what is indicated.**
> **2. GRADUATED COMPRESSION STOCKINGS ARE NO LONGER ROUTINELY RECOMMENDED for preventing post-thrombotic syndrome** after DVT, following trials that failed to show benefit — though they may help symptomatically. `UNVERIFIED — current guidance.`
> **3. IVC FILTERS have NARROW indications** — essentially an ABSOLUTE contraindication to anticoagulation in the presence of acute VTE. **They are over-used, they carry their own thrombotic and mechanical complications, and RETRIEVABLE FILTERS ARE FREQUENTLY NEVER RETRIEVED.** **If one is inserted, the retrieval plan must be documented and followed up.**

> [!danger] Two long-term complications worth anticipating
> **· POST-THROMBOTIC SYNDROME — chronic leg pain, swelling, heaviness, skin changes and ulceration after DVT, affecting a substantial proportion of patients.** Cross-refer [[B6]] 0.4.
> **· CHRONIC THROMBOEMBOLIC PULMONARY HYPERTENSION — persistent or progressive BREATHLESSNESS months after a pulmonary embolism.** **It is treatable, potentially curable with pulmonary endarterectomy, and REPEATEDLY MISSED because post-PE breathlessness is attributed to deconditioning or anxiety.**
> **A patient who remains breathless three to six months after a PE needs assessment — echocardiography and specialist referral — not reassurance.**

---

## 0.6 Thrombophilia and Special Situations

> [!danger] Mostly, do not test for thrombophilia
> **Thrombophilia testing is over-requested and RARELY CHANGES MANAGEMENT.**
> **The reasons:**
> **· The decision about anticoagulation duration is driven by whether the event was PROVOKED and by bleeding risk — not by a heritable thrombophilia.**
> **· A positive result causes lasting anxiety, insurance and employment implications, and unnecessary testing of relatives.**
> **· Results are UNRELIABLE at the time they are usually taken — see the timing box below.**
> **Testing may be justified where it will genuinely change management: suspected ANTIPHOSPHOLIPID SYNDROME · thrombosis at an unusual site · a strong family history in specific contexts · and some pregnancy-related decisions — ideally after specialist discussion rather than as a reflex panel.**

> [!warning] If you do test, the timing determines whether the result means anything
> **· NOT DURING THE ACUTE THROMBOSIS — antithrombin, protein C and protein S are consumed and falsely low.**
> **· NOT ON WARFARIN — it lowers protein C and protein S (both vitamin K dependent), producing false positives.**
> **· NOT ON A DOAC — DOACs INTERFERE WITH LUPUS ANTICOAGULANT assays, producing false positives.**
> **· NOT DURING PREGNANCY or on oestrogen — protein S falls physiologically.**
> **The practical result: the time to test is weeks after stopping anticoagulation, well away from the acute event — which is another reason the test rarely changes acute management.**

> [!danger] Antiphospholipid syndrome
> **Requires BOTH a clinical criterion AND persistent antibodies.**
> **· CLINICAL: vascular thrombosis (venous, ARTERIAL — including stroke in a young person — or small vessel) OR pregnancy morbidity (recurrent early miscarriage, fetal death, or severe pre-eclampsia and placental insufficiency).**
> **· LABORATORY: LUPUS ANTICOAGULANT, anticardiolipin antibodies, or anti-beta-2-glycoprotein I antibodies — POSITIVE ON TWO OCCASIONS AT LEAST 12 WEEKS APART.** **A single positive result does not make the diagnosis; transient positives are common with infection.**
> **The clues: an unexplained prolonged APTT (that does not correct on mixing) · arterial thrombosis in a young person · thrombosis with thrombocytopenia · recurrent pregnancy loss · livedo reticularis · and coexisting SLE.**
> **Management: WARFARIN rather than a DOAC in triple-positive disease and arterial events · and in pregnancy, ASPIRIN PLUS LOW MOLECULAR WEIGHT HEPARIN, which substantially improves live birth rates.** Cross-refer [[L2]] 0.4 and [[O2]].
> **CATASTROPHIC antiphospholipid syndrome — multi-organ thrombosis over days, with high mortality, requiring urgent immunosuppression and anticoagulation.**

> [!warning] Thrombosis at an unusual site changes the workup
> **Splanchnic (portal, mesenteric, hepatic), cerebral venous sinus, or upper limb thrombosis without a catheter — these warrant a different differential:**
> **· MYELOPROLIFERATIVE NEOPLASM — check a JAK2 mutation, and note that the blood count may be NORMAL in splanchnic thrombosis because of hypersplenism masking the counts.**
> **· PAROXYSMAL NOCTURNAL HAEMOGLOBINURIA — cross-refer [[J2]] 0.4.**
> **· MALIGNANCY, local compression or invasion.**
> **· BEHÇET DISEASE, inflammatory bowel disease, and intra-abdominal sepsis or pancreatitis for splanchnic events.**
> **· Antiphospholipid syndrome.**
> **· In cerebral venous sinus thrombosis: dehydration, oral contraception, pregnancy and the puerperium, local infection, and — historically important — vaccine-induced immune thrombotic thrombocytopenia.** Cross-refer [[D1]] 0.2.

> [!tip] The other situations
> **· CANCER-ASSOCIATED THROMBOSIS — higher recurrence AND higher bleeding risk.** **Anticoagulant choice considers the tumour: DOACs carry more gastrointestinal bleeding, so LMWH may be preferred with luminal GI or genitourinary tumours.** Cross-refer [[J5]].
> **· PREGNANCY AND THE PUERPERIUM — a hypercoagulable state, with VTE a leading cause of maternal death.** **LMWH is the anticoagulant; warfarin is teratogenic and DOACs are not used.** Cross-refer [[O2]].
> **· SUPERFICIAL VENOUS THROMBOSIS — not always benign. Extensive thrombus, or thrombus close to the SAPHENOFEMORAL JUNCTION, can propagate into the deep system and warrants imaging and anticoagulation.**
> **· TRAVEL-RELATED VTE — the risk relates to duration and to underlying risk factors rather than to flying itself.**
> **· HOSPITAL VTE PROPHYLAXIS — every admitted patient should have a documented VTE risk assessment, with mechanical and pharmacological prophylaxis as indicated, and EXTENDED prophylaxis after major cancer and orthopaedic surgery.** **Hospital-acquired VTE is common, largely preventable, and a recognised quality measure.** Cross-refer [[AN1]] 0.5.

**Ix:** **A structured BLEEDING HISTORY** (*why:* more informative than the coagulation screen, which is normal in platelet disorders, von Willebrand disease and factor XIII deficiency; *what:* the pattern and severity). **FBC, film, PT/INR, APTT, FIBRINOGEN** (*why:* the baseline, and the pattern narrows the differential; *what:* per the table above). **MIXING STUDY on a prolonged APTT** (*why:* distinguishes factor deficiency from an inhibitor, which is the entire question in acquired haemophilia and antiphospholipid syndrome; *what:* correction or not). **Von Willebrand screen — vWF antigen, vWF activity, factor VIII — REPEATED if normal with a strong history** (*why:* levels are labile and vary with stress, oestrogen, inflammation and blood group; *what:* deficiency or dysfunction). **Clinical probability score BEFORE ordering a D-dimer** (*why:* the D-dimer is only interpretable at low or intermediate probability; *what:* the pre-test probability). **Compression ultrasound or CTPA per the algorithm** (*why:* diagnosis; *what:* thrombus). **Renal function and weight before dosing any anticoagulant** (*why:* DOAC and LMWH dosing are renal- and weight-dependent, and this is a common prescribing error; *what:* creatinine clearance, weight). **Antiphospholipid antibodies, repeated at 12 weeks** (*why:* transient positives are common and a single result does not diagnose the syndrome; *what:* persistent positivity). **JAK2 mutation testing in splanchnic or unusual-site thrombosis** (*why:* an occult myeloproliferative neoplasm, which may have normal blood counts in this setting; *what:* the mutation). **Age-appropriate cancer screening after unprovoked VTE — and NOT an extensive occult malignancy search** (*why:* extensive screening does not improve outcomes; *what:* up-to-date routine screening).
...
<!-- ===== SOURCE: NEW_Investigations_Haematology.md ===== -->
