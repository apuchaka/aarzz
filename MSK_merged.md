...
aliases:
  ...
  - "L7"
  - "L8"
  - "11_01_Ortho_-_Orthopaedic_Emergencies"
  - "11_02_Ortho_-_Upper_Limb__Shoulder__Elbow__Distal_Radius_Fractures_"
  - "11_03_Ortho_-_Hand_and_Foot"
  - "11_04_Ortho_-_Hip"
  - "11_05_Ortho_-_Knee_and_Ankle"
  - "11_06_Ortho_-_Spinal_Orthopaedics"
  - "11_07a_Ortho_-_Dermatomes_and_Myotomes_Reference"
  - "11_07b_Ortho_-_Osteomyelitis__Osteochondritis_Dissecans__Fat_Embolism__Charcot_Joint__Osteomalacia"
  - "11_08a_Ortho_-_Joint_Replacements"
  - "11_08b_Ortho_-_Paget_s_Disease_and_Osteoporosis"
  - "11_08c_Ortho_-_Fracture_Types_and_Pathological_Fractures"
  - "11_09a_Ortho_-_Orthopaedic_and_Bone_Malignancies"
  - "11_09b_Ortho_-_Trauma"
  - "11_10_Ortho_-_Paediatric_Orthopaedics"
  - "12_01_Rheum_-_Rheumatoid_Arthritis__Osteoarthritis__Psoriatic_Arthritis"
  - "12_02_Rheum_-_Ankylosing_Spondylitis__Gout__Pseudogout__Reactive_Arthritis__Fibromyalgia__PMR__CFS"
  - "12_03_Rheum_-_Connective_Tissue_Diseases__SLE__Systemic_Sclerosis__Dermatomyositis__Polymyositis__Sjogren_"
  - "12_04_Rheum_-_Vasculitis"
  - "L1_Hot_and_Swollen_Joint"
  - "L2_Polyarthralgia_and_Inflammatory_Arthritis"
  - "L3_Muscle_Symptoms_and_Widespread_Pain"
  - "L4_Back_and_Neck_Pain"
  - "L5_Regional_Limb_Pain"
  - "L6_Soft_Tissue_Injury_and_Mobility"
  - "L7_Fractures_and_Eponyms"
  - "L8_Facial__Head_and_Torso_Trauma"
  - "NEW_Drugs_19_Rheumatological"
  - "NEW_Investigations_Orthopaedics_Neurology_and_Other"
...
### 0.1.1 Septic arthritis of a replaced joint
...
- **D:** refers to any symptoms/signs below AND radiological confirmation of compression. Most commonly caused by central disc prolapse at L4/L5 or L5/S1.
  - **A second full entry exists at [[04_Neurology]] Cauda Equina Syndrome** — the two agree (whole-spine MRI, decompression within 24–48h, LMN pattern) and that one adds the anatomy (L2–S5 roots below the conus at ~L1/L2) and the saddle-anaesthesia questions to ask directly. Linked by the pairs audit (2026-08-29); the headers differ only in letter case, which is why the duplicate check never paired them.
...
### 0.4.2 Back pain red flags → urgent MRI
...
### 0.5.1 Management of closed fractures
...
## 0.6 Infective myositis (pyomyositis)
...
## 0.7 Tendon sheath infection (hand)
...
> **A FIFTH account is in THIS file, 45 lines below: `NEW_Investigations_Rheumatology §0.1 Autoimmune / ANA Panel` through `§0.5 Myositis Profile`** — the marker-by-marker reference the block above summarises. It was not named here until 2026-09-02. **All kept; none reconciled.**
...
> [!note] Gap-filled from CSV ("Ruptured Biceps Brachii Head," Medium yield) — genuinely absent despite the closely related rotator cuff and shoulder pathology throughout this file; placed under Shoulder given the large majority of ruptures involve the proximal tendon, though the distal presentation (at the elbow) is covered here too given the two share the same underlying muscle and are naturally taught together.

- **D:** rupture of one of the biceps brachii's tendons — the **proximal long head accounts for ~96% of ruptures**, the distal tendon ~3%, and the proximal short head ~1%, making "biceps rupture" essentially synonymous with the long head proximal presentation in the great majority of cases, though the distal variant is disproportionately important clinically given it's the one that generally needs surgery.
- **R:** middle-aged men most typically; tendinopathy, anabolic steroid use, or a pre-existing rotator cuff tear predispose (given a proximal rupture often occurs on a background of pre-existing tendon degeneration rather than in a previously healthy tendon) — when associated with tendinopathy, only minimal additional force may be needed to complete the rupture. Mechanisms include heavy lifting and traumatic falls.
- **A/P:** when a biceps tendon ruptures, the muscle belly — no longer held under tension at both its attachments — retracts toward its remaining intact attachment, producing the visible/palpable deformity below.

> [!tip] Proximal vs distal — genuinely different presentations, exam findings, and management, not two versions of the same injury:

**Proximal (long head) rupture — the common presentation:**
- **S/Smx:** acute pain, swelling, and bruising in the upper arm/shoulder; patients often describe an audible or felt "pop"; the classic **"Popeye sign"** — the muscle belly balls up and retracts distally toward the elbow, producing a visible bulge in the lower arm (may not be obvious in obese patients, or if scarring elsewhere limits retraction). Acute elbow flexion strength loss of roughly 30% has been described, but **there is usually little to no appreciable chronic weakness** — the brachialis and other elbow flexors substantially compensate over time, which is part of why proximal rupture is often managed conservatively (see Mx below).
- Given the strong association with rotator cuff pathology, **specifically examine for concurrent rotator cuff tear and shoulder impingement** — a proximal biceps rupture should prompt a full shoulder assessment, not just confirmation of the biceps finding in isolation.
- **Mx:** generally **conservative** in most patients, particularly older/lower-demand individuals, given the good functional compensation described above; surgical repair (tenodesis) reserved for younger, higher-demand patients or those bothered by the cosmetic deformity or persistent cramping/fatigue.

**Distal rupture — less common but disproportionately important, given surgical urgency:**
- **S/Smx:** bruising and swelling specifically in the antecubital fossa (front of the elbow); painful popping sound/sensation at the time of injury; **reverse Popeye sign** — the muscle belly retracts proximally (up toward the shoulder) rather than distally, the opposite direction to a proximal rupture, given the distal (not proximal) attachment has failed; weakness of elbow flexion and, more specifically and diagnostically, **weakness of forearm supination** (reported reductions of up to ~40% flexion and ~50% supination strength) — supination weakness is a genuinely useful distinguishing clinical clue given the biceps is the primary forearm supinator.
- **The hook test** — the standard, most sensitive and specific bedside test for distal rupture: with the elbow flexed to 90° and the forearm supinated, the examiner attempts to hook a finger from lateral to medial around the biceps tendon in the antecubital fossa — an intact tendon can be hooked; its absence (an "empty" hook, no palpable cord to catch) supports a complete distal rupture. Comparing with the uninjured contralateral side improves confidence in an equivocal exam.
- **Mx:** **distal ruptures are generally treated surgically**, given non-operative management results in a disproportionate loss of supination and flexion strength compared to the proximal presentation — this is the key practical distinction from proximal rupture, where conservative management is usually adequate. **Early referral matters** given surgical repair is time-sensitive — ideally within about 2 weeks of injury, since the retracted tendon becomes progressively harder to mobilise and repair back to its anatomical insertion the longer repair is delayed.

**Ix:** primarily a clinical diagnosis for a straightforward, complete rupture with a clear Popeye/reverse-Popeye deformity — imaging (ultrasound or MRI) is useful where the diagnosis is unclear, a partial rather than complete tear is suspected, or for surgical planning in a distal rupture being referred for repair.

### Adhesive capsulitis (frozen shoulder)

- **D:** chronic fibrosing condition causing slowly progressing restriction of the shoulder's range of movement.
- **R:** age 40–70, diabetes, prior history of adhesive capsulitis, previous shoulder surgery, conditions that predispose to shoulder immobility.
- **S/Smx:** external rotation affected more than internal rotation or abduction; both active and passive movement affected; 3 phases — freezing, adhesive, recovery; bilateral in 20%; episode typically lasts 6–24 months.
- **Dx:** clinical ± imaging (e.g. MRI).
- **Mx:** NSAIDs, physiotherapy, oral corticosteroids and intra-articular steroids.

### Rotator cuff injury

- **D:** spectrum of injuries including tendinopathy, partial and full tears — subacromial impingement, calcific tendonitis, rotator cuff tears, rotator cuff arthropathy.
- **R:** >60 years old.
- **A:** acute trauma, or repetitive ± vigorous overhead activity, or age-related degeneration.
- **P:** trauma + poor blood supply (and therefore lack of healing) → chronic injury.
- **S/Smx:** shoulder pain worse on abduction; painful arc of abduction (typically 60° to 120°); pain over the anterior acromion.
- **Ix:** XR, US/MRI.
- **Mx:** surgical if significant impact on ADLs and fit for surgery. Others: conservative (NSAIDs, physiotherapy), arthroscopic debridement.

### Acromioclavicular joint injury

> [!note] Gap-filled — this entry had the grading but lacked S/Smx and Ix, both genuinely important given the classification depends on distinguishing exam and imaging findings, not the mechanism alone.

- **A:** trauma, usually due to a fall directly onto the shoulder (adducted arm) or a fall on an outstretched hand; common in contact/collision sports.
- **S/Smx:** pain and tenderness localised over the AC joint (the point where the clavicle meets the acromion, palpable at the top-outer shoulder); pain worse with overhead movement or moving the arm across the body; **a "step deformity"** (a visible/palpable bump where the distal clavicle sits proud relative to the acromion) may be present and becomes more pronounced with more severe injury — examine with the patient standing or sitting, since gravity on the arm accentuates the deformity.
- **Ix:** plain X-ray (AP view) is generally adequate for diagnosis and to exclude other traumatic shoulder pathology, though milder AC injuries aren't always clearly visible on standard views; comparison with the contralateral shoulder view can help assess the coracoclavicular (CC) interspace, which is what the Rockwood grades are actually measured against; ultrasound or MRI reserved for continued diagnostic uncertainty.
- **Graded I to VI** (Rockwood classification) — genuinely worth knowing the grading isn't a simple linear severity scale despite the numbering, since it's based on which structures are torn (AC ligament, CC ligament, deltotrapezial fascia) and the degree/direction of clavicular displacement, not injury severity alone:
  - **I:** AC ligament sprain only, CC ligament intact, no radiographic displacement.
  - **II:** AC ligament torn, CC ligament sprained, mild displacement.
  - **III:** both AC and CC ligaments torn, clavicle displaced above the acromion's superior border.
  - **IV:** as III, with posterior displacement of the clavicle into or through the trapezius.
  - **V:** as III, with much greater (>100%) displacement and detachment of the deltotrapezial fascia.
  - **VI:** rare — inferior dislocation of the clavicle to a subacromial or subcoracoid position.
- **Mx:** Grade I–III — conservative, sling, analgesia, early physiotherapy. Grade IV–VI — surgical fixation, given the degree of instability and soft tissue disruption involved.

### Shoulder dislocation

- **D:** dislocation of the humeral head from the glenoid cavity of the scapula (accounts for 50% of all major joint dislocations).
- **Anterior (>95% of cases):** arm is usually abducted and externally rotated + prominent acromion.
- **Posterior (2–4%):** arm is in adduction and internal rotation + patient cannot rotate externally.
- **S/Smx:** as above; check for neurovascular compromise (e.g. axillary nerve injury); rule out associated fractures.
- **Mx:** reduction ± sedation. Can generally be done in the ED, with some contraindications (e.g. humeral fracture, arterial injury, etc).

### Humeral fractures

- **Proximal humeral fractures:** usually seen in older patients with osteoporosis after a fall on an outstretched hand; associated with axillary nerve injury.
- **Mid-shaft fractures:** associated with radial nerve injury (both due to the injury itself and secondary to surgical manipulation) — 85–90% improve over 3 months of observation. Radial nerve injury presents as wrist drop.

### Supracondylar fracture of the humerus

> [!note] Gap-filled from CSV ("Supracondylar Fracture of humerus," High yield) — genuinely absent from the source material despite being one of the most classically-taught, genuinely dangerous fractures in orthopaedics, particularly in children.

- **D:** a fracture of the distal humerus just above the condyles — the most common elbow fracture in children (typically age 5–7), though it occurs in adults too.
- **A/P:** classically a fall onto an outstretched hand with the elbow hyperextended (extension-type, ~95% of paediatric cases) — the distal fragment displaces posteriorly; flexion-type (rarer) results from a direct fall onto a flexed elbow, with anterior displacement.
- **S/Smx:** elbow pain and swelling following a fall, reluctance to move the elbow, visible deformity if significantly displaced.
- **Ix:** XR (AP and lateral elbow) (*why:* confirms the fracture and its displacement pattern, directly informing the Gartland classification and Mx below; *what:* the fracture line above the condyles ± an abnormal "fat pad sign" — a posterior fat pad visible on the lateral view is abnormal and suggests an occult fracture even when the fracture line itself isn't clearly visible, given elevated intra-articular pressure from a haemarthrosis displaces the fat pad; an anterior "sail sign" can be a similar subtle clue). **Neurovascular assessment is genuinely the most important part of the initial evaluation, not an afterthought** — assess and document the radial pulse and capillary refill, and specifically test the three main nerves at risk: **median nerve** (anterior interosseous branch specifically — test by asking the patient to make an "OK sign"/pinch the thumb and index finger tip-to-tip, given this tests the specific muscles the AIN supplies), **radial nerve** (wrist/finger extension), and **ulnar nerve** (finger abduction/adduction) — the specific nerve at risk varies with fracture displacement direction, but all three should be assessed and clearly documented given the medicolegal and clinical importance of a baseline exam before any reduction attempt.

> [!info] Gartland classification (extension-type, the more common pattern)
> - **Type I:** undisplaced.
> - **Type II:** displaced with intact posterior cortex (hinged).
> - **Type III:** completely displaced, no cortical contact.

> [!danger] The genuinely dangerous complication to actively watch for is **compartment syndrome of the forearm, and specifically brachial artery injury/compromise** — a significantly displaced supracondylar fracture can kink or injure the brachial artery, given its close anatomical proximity, risking **Volkmann's ischaemic contracture** (a permanent, severely disabling flexion contracture of the forearm/hand from muscle ischaemia and subsequent fibrosis) if not recognised and treated promptly — this is exactly the same "6 Ps" compartment syndrome vigilance principle from [[11_01_Ortho_-_Orthopaedic_Emergencies]] Compartment syndrome, not repeated here, but specifically relevant and actively screened for in this fracture given how commonly the brachial artery is affected.
- **Mx:** **Type I:** immobilisation in a cast/splint, typically without surgery. **Type II and III (displaced):** closed reduction and percutaneous pinning (CRPP) under general anaesthesia is the standard treatment for displaced fractures, given the need for accurate reduction to avoid the neurovascular complications above and to prevent malunion (cubitus varus — the classic "gunstock deformity" — is a recognised late complication of inadequately reduced fractures). **Any evidence of vascular compromise (absent/diminished pulse, poor capillary refill) after closed reduction warrants urgent vascular surgical review and possible exploration** — a genuinely time-critical escalation given the ischaemic contracture risk above, not something to observe and reassess later.

### Biceps (tendon) rupture

- **D:** separation of the long or short tendon of the biceps from its attachment site, or a full-width tear of one of these tendons.
- **R:** M>F (3:1), increasing age.
- **A:** heavy overhead activities, shoulder overuse, smoking, corticosteroids.
- **S/Smx:** sudden pop or tear at the shoulder → pain, bruising, swelling; weakness in the shoulder; "Popeye" deformity — bulge of muscle in the middle of the upper arm.
- **Ix:** exam + MRI.
- **Mx:** RICE + NSAIDs; conservative, especially if elderly; surgery.

### Shoulder labral tear (including SLAP lesion)

> [!note] Gap-filled from CSV ("Labrum at shoulder INJURY," High yield) — genuinely absent despite the hip labral tear equivalent being covered in [[11_04_Ortho_-_Hip]] Acetabular labral tear (hip labral tear), and despite this injury's direct anatomical relationship to the biceps tendon pathology immediately above (the long head of biceps anchors directly onto the superior labrum, which is exactly why the two conditions are so often discussed together and can coexist).

- **D:** a tear of the glenoid labrum (the fibrocartilaginous rim deepening the shoulder socket) — **SLAP lesion** (Superior Labrum, Anterior to Posterior) specifically refers to a tear involving the superior labrum at the site of the long head of biceps tendon anchor, the most commonly discussed labral tear pattern given its direct link to the biceps pathology above; other labral tear patterns (e.g. a Bankart lesion — anteroinferior labral tear associated with anterior shoulder dislocation, see Shoulder dislocation above) occur at different sites with different mechanisms.
- **A/P:** repetitive overhead activity (throwing athletes — a classically over-represented group given the repetitive biceps traction on the superior labrum), acute traumatic injury (a fall onto an outstretched arm, or a sudden traction/pull on the arm), or as part of the same continuum as anterior shoulder instability/dislocation for non-SLAP labral tears.
- **S/Smx:** deep, poorly-localised shoulder pain — often vague and hard for the patient to pinpoint, unlike the more clearly localised pain of rotator cuff pathology above, which is itself a useful (if imperfect) distinguishing clue; mechanical symptoms (catching, popping, or a sensation of instability/the shoulder "giving way") during overhead or rotational movement; pain classically worse with overhead activity; may coexist with biceps tendon symptoms given the shared anatomical attachment above.
- **Ix:** clinical examination — several provocative tests exist (e.g. O'Brien's active compression test, Speed's test) though **no single clinical test has both high sensitivity and specificity for labral tears**, meaning a negative test doesn't reliably exclude the diagnosis and clinical suspicion should still prompt imaging if the history is compatible; MRI, ideally **MR arthrography** (contrast injected into the joint before MRI) given this significantly improves sensitivity for labral tears over standard MRI alone, which can under-detect subtle tears — the imaging modality choice matters more here than for many other shoulder pathologies given plain MRI's comparatively limited sensitivity for this specific structure.
- **Mx:** conservative management first-line for many cases — activity modification, physiotherapy (strengthening the surrounding rotator cuff and scapular stabilisers to reduce mechanical load on the labrum), NSAIDs; arthroscopic surgical repair is considered for persistent symptomatic tears not responding to an adequate conservative trial, particularly in younger, high-demand athletes where mechanical symptoms significantly limit function — the specific surgical technique and rehabilitation timeline depends on tear pattern and biceps tendon involvement, given the direct anatomical relationship to the biceps pathology above.

## Elbow

### Cubital tunnel syndrome

- **D:** compression of the ulnar nerve (C8 & T1) as it passes through the cubital tunnel.
- **S/Smx:** numbness, tingling ± pain of the 4th and 5th finger — intermittent then constant; ± weakness and muscle wasting; pain worse when leaning on the elbow; ± history of OA or trauma to the area.
- **Ix:** clinical diagnosis ± nerve conduction studies.
- **Mx:** avoid aggravating motions; physiotherapy, steroid injections, surgery.

### Radial tunnel syndrome

- **D:** compressive neuropathy of the posterior interosseous nerve (PIN) at the level of the proximal forearm.
- **S/Smx:** pain 4–5cm distal to the lateral epicondyle, ± worse on extending the elbow and pronating the forearm.
- **Ix:** primarily a clinical diagnosis — a genuinely important, commonly-tested point is that this condition **frequently mimics or coexists with lateral epicondylitis** (tennis elbow, below), with the key distinguishing feature being the point of maximal tenderness (further distal, over the radial tunnel itself, rather than directly at the lateral epicondyle) — this overlap means radial tunnel syndrome is often under-recognised or misdiagnosed as refractory tennis elbow. Nerve conduction studies can support the diagnosis in ambiguous cases, though they're often normal even in genuine radial tunnel syndrome given the compression is often intermittent/positional rather than a fixed lesion.
- **Mx:** conservative measures first-line — activity modification, splinting, physiotherapy, NSAIDs; corticosteroid injection may be trialled; surgical decompression of the radial tunnel is considered for refractory cases, particularly given how easily this is misdiagnosed as treatment-resistant tennis elbow, making an accurate diagnosis (rather than repeated tennis-elbow-directed treatment) the genuinely important step before considering surgery.

### Medial epicondylitis (golfer's elbow)

- **D:** chronic tendinosis of the wrist flexors and pronators that attach to the medial epicondyle.
- **S/Smx:** pain at the medial epicondyle, worse on wrist flexion and pronation ("door knock" movement); ± numbness, tingling in the 4th and 5th finger due to ulnar nerve involvement.
- **Ix:** clinical diagnosis, based on the characteristic pain location and provocation pattern above — imaging (US or MRI) is reserved for atypical presentations or where the diagnosis is unclear, given it's not typically needed to confirm a straightforward case.
- **Mx:** the same general conservative-first approach as lateral epicondylitis below (rest, ice, physiotherapy, NSAIDs) — not repeated in full here given the identical underlying principle (tendinosis, not true inflammation, responding best to load management and time rather than aggressive anti-inflammatory treatment alone); corticosteroid injection can be considered for persistent symptoms, though evidence for durable benefit is mixed and it doesn't address the underlying tendinosis; surgical release is reserved for genuinely refractory cases after an adequate trial of conservative management (typically 6–12 months).

### Lateral epicondylitis (tennis elbow)

- **D:** tendinosis of the common extensor tendons.
...
- **S/Smx:** associated with pain, warmth, redness.
- **Ix:** primarily clinical, but **the key diagnostic task is distinguishing simple/aseptic bursitis from septic bursitis**, given the management differs substantially — aspiration of bursal fluid for microscopy, Gram stain, and culture is indicated if there's any suspicion of infection (marked warmth/erythema extending beyond the bursa itself, fever, or a break in the overlying skin) — see [[11_01_Ortho_-_Orthopaedic_Emergencies]] Septic arthritis for the general principle of joint/periarticular sepsis assessment this parallels, not repeated here (though septic bursitis is a distinct entity from septic arthritis itself, given the bursa doesn't communicate with the joint space).
- **Mx:** **aseptic bursitis:** conservative — rest, ice, avoiding pressure/repeated trauma to the area (e.g. elbow padding), NSAIDs; aspiration can be therapeutic for large, symptomatic effusions even when aseptic, though recurrence is common without addressing the underlying repetitive trauma. **Septic bursitis:** antibiotics covering the likely organism (commonly *S. aureus*, similar to the septic arthritis aetiology in [[11_01_Ortho_-_Orthopaedic_Emergencies]]) ± aspiration/drainage, with the same general "don't delay treatment for a hot, swollen periarticular structure" urgency principle as septic arthritis, though the specific anatomical distinction (bursa vs joint) matters for both prognosis and the extent of intervention needed.

### Pulled elbow

- **D:** subluxation of the radial head. Most common in children <6 years old.
- **S/Smx:** elbow pain, limited supination and extension of the elbow.
- **Mx:** analgesia + passive supination of the elbow joint while the elbow is flexed to 90°.

## Distal radius / forearm fractures

### Colles' fracture

- Classically follows a fall onto an outstretched hand (FOOSH).
- Distal radius fracture with dorsal displacement of fragments.
- **Classical features:** transverse fracture of the radius, 1 inch proximal to the radiocarpal joint, dorsal displacement and angulation.
- **Ix:** XR (AP and lateral wrist) (*why:* confirms the fracture and its displacement/angulation, directly guiding the reduction-vs-surgery decision below; *what:* the classic dorsally-displaced/angulated distal radius fracture pattern described above, sometimes described as a "dinner fork" deformity clinically before imaging). Assess and document neurovascular status specifically (*why:* median nerve injury is a recognised early complication, per the box below, so a baseline exam matters both for immediate management and for medicolegal documentation if a deficit is found later, particularly after any reduction attempt; *what:* screens for the acute carpal tunnel syndrome pattern noted below).
- **Mx:** closed reduction under appropriate analgesia/anaesthesia (e.g. haematoma block, Bier's block, or procedural sedation) for displaced fractures, followed by immobilisation in a below-elbow backslab/cast; surgical fixation (e.g. ORIF, or K-wires) for fractures that are unstable, significantly comminuted, intra-articular, or that fail to hold reduction — see [[11_01_Ortho_-_Orthopaedic_Emergencies]] Management of closed fractures for the general closed-fracture principles (immobilise proximal and distal joints, monitor neurovascular status) this fits into, not repeated here.
...
> [!note] Late complications: osteoarthritis; complex regional pain syndrome.

### Smith's fracture

- **Mechanism:** falling on the dorsal (back) side of the hand when the wrist is flexed — the hand is "inward".
...
- **Mechanism:** fall onto an extended and pronated wrist.
- **Ix:** XR (AP and lateral wrist), specifically looking for the intra-articular fracture line extending to involve the radiocarpal joint with associated subluxation/dislocation — the defining feature distinguishing this from an isolated Colles'/Smith's fracture.
- **Mx:** **inherently unstable given the intra-articular and dislocation component** — almost always requires surgical fixation (ORIF) rather than closed reduction/casting alone, unlike many isolated Colles' fractures which can be managed conservatively.

### Monteggia's fracture

- Ulna fracture and dislocation of the proximal radio-ulnar joint.
- **Mechanism:** FOOSH + forced pronation.
- **Ix:** XR of the full forearm including both wrist and elbow joints (*why:* the radial head dislocation can be easily missed if imaging is limited to just the obvious ulna fracture site — a genuinely important pitfall, given the combination injury is the whole point of this fracture pattern; *what:* ulna shaft fracture with radial head dislocation, best assessed by ensuring a line drawn through the radial shaft/head passes through the capitellum on all views).
- **Mx:** surgical fixation (ORIF) of the ulna fracture is typically required in adults, with the radial head dislocation usually reducing once the ulna is anatomically fixed, given the two injuries are mechanically linked; closed reduction and casting may be sufficient in children given their greater healing/remodelling potential.

### Galeazzi fracture

- Radial shaft fracture and dislocation of the distal radio-ulnar joint.
- **Mechanism:** fall on the hand with rotational force.
- **Ix:** XR of the full forearm including both wrist and elbow joints, for the same "don't miss the dislocation" reason as Monteggia's fracture above — sometimes taught as the mirror-image counterpart to Monteggia's (radial shaft fracture + distal dislocation, vs Monteggia's ulna shaft fracture + proximal dislocation).
- **Mx:** surgical fixation (ORIF) of the radial shaft fracture is typically required in adults, again with the distal radio-ulnar joint dislocation usually reducing once the radius is anatomically fixed; closed management may be considered in children.

> [!tip] Monteggia's and Galeazzi's fractures are commonly taught as a mirror-image pair — Monteggia's = ulna shaft fracture + **proximal** radio-ulnar dislocation; Galeazzi's = radial shaft fracture + **distal** radio-ulnar dislocation — a useful memory anchor given how similar the names and injury patterns are.


<!-- ===== SOURCE: 11_03_Ortho_-_Hand_and_Foot.md ===== -->


## 0.1 Hand

### 0.1.1 Carpal tunnel syndrome
...
### 0.1.2 De Quervain's tenosynovitis
...
### 0.2.1 Club foot (talipes equinovarus)
...
<!-- ===== SOURCE: 11_04_Ortho_-_Hip.md ===== -->


## Hip / neck of femur (NOF) fractures

- **R:** osteoporosis, osteopenia, ↑age, falls, ↓BMI, F>M, high energy trauma.
- **S/Smx:** pain ± rhabdomyolysis/AKI; shortened, externally rotated leg; if the fracture is not too severe, the patient may still be able to weight bear.

> [!info] Classification by location
> - **Intracapsular (subcapital):** from the edge of the femoral head to the insertion of the capsule of the hip joint.
> - **Extracapsular:** trochanteric or subtrochanteric — the lesser trochanter is the dividing line.

> [!info] Garden system classification
...
>
> Blood supply disruption occurs in Types III and IV.

### Management

- **Suspected NOF fracture:** primary survey + determine nature of injury; request AP pelvis and lateral view XR; pain score + appropriate analgesia; IV access + bloods (including G&S). If NOF fracture confirmed or still suspected — MRI (gold standard) or CT (if MRI contraindicated or not available within 24h).
- **Undisplaced intracapsular fractures:** internal fixation, or hemiarthroplasty if unfit.
- **Displaced intracapsular fractures:** arthroplasty (THR or hemiarthroplasty). THR favoured if the patient is able to walk independently out of doors with only a stick, has no cognitive impairment, and is medically fit for anaesthesia and the operation.
- **Extracapsular fractures:** stable intertrochanteric fractures — dynamic hip screw. Reverse oblique, transverse, or subtrochanteric fractures — intramedullary device.
- Also: pain management, rehabilitation, falls risk reduction, medication review.

> [!danger] Complications: VTE, avascular necrosis, non-union.
> **P:** 30% mortality at 1 year; up to 75% may not regain pre-morbidity level of function.

## Hip dislocation

- **Posterior dislocation (90%):** shortened, adducted, internally rotated.
- **Anterior dislocation:** abducted and externally rotated. No leg shortening.
- **Mx:** ABCDE + analgesia; reduction under general anaesthesia within 4h to reduce risk of avascular necrosis; long-term physiotherapy.
- **Complications:** sciatic or femoral nerve injury; avascular necrosis; OA (especially in older patients); recurrent dislocation due to ligament damage.
- **P:** 2–3 months for healing; best prognosis when reduced <12h post-injury, with less damage to the joint.

## Avascular necrosis of the hip

- **D:** loss of blood supply resulting in death of bone tissue.
- **A:** long-term steroid use, chemotherapy, alcohol excess, trauma.
- **S/Smx:** initially asymptomatic; pain in the affected joint.
- **Ix:** XR may be normal at first — later shows osteopenia, microfractures. Crescent sign when there is collapse of the articular surface. MRI is the imaging of choice.
- **Mx:** joint replacement.

## Acetabular labral tear (hip labral tear)

- **A:** trauma, degeneration, etc.
- **S/Smx:** hip/groin pain; snapping sensation around the hip ± sensation of locking.
- **Ix:** XR ± MRI.
- **Mx:** conservative (rest, NSAIDs, physiotherapy) ± steroid injection.

## Meralgia paraesthetica

- **D:** entrapment neuropathy of the lateral femoral cutaneous nerve.
- **R:** age 30–40, M>F, diabetes, obesity, tense ascites, trauma. Can also be caused iatrogenically (e.g. laparoscopic hernia repair).
- **S/Smx:** burning sensation over the anterolateral aspect of the thigh; also numbness, deep muscle ache, coldness, shooting pain. Symptoms worse on standing, relieved by sitting.

> [!tip] Symptoms reproducible by deep palpation over the ASIS (pelvic compression test is highly sensitive) and extension of the hip.

- **Ix:** clinical ± nerve conduction studies.
- **Mx:** injection of the nerve with local anaesthetic will abolish pain (also confirms the diagnosis) — ultrasound-guided injection.

## Pubic symphysis dysfunction (pelvic girdle pain)

- **D:** syndrome arising from pubic symphysis ligament laxity, most commonly in pregnancy due to hormonal changes.
- **S/Smx:** pain over the pubic symphysis with radiation to the groins and medial aspect of the thighs; ± waddling gait.
- **Mx:** usually resolves on giving birth. Analgesia, physiotherapy (e.g. pelvic floor physical therapy).

## Idiopathic transient osteoporosis of the hip

- **D:** temporary loss of bone in the femoral head and neck.
- **R:** M>F (3:1), men aged 40–55, women in the 3rd trimester of pregnancy.
- **S/Smx:** absence of trauma in history; progressive hip and groin pain over several weeks; may not be able to bear weight; local tenderness + usually normal hip range of movement.
- **Ix:** XR, MRI.
- **Mx:** avoid weight bearing to avoid stress fractures; resolves spontaneously in 6–8 months.

## Greater trochanteric pain syndrome (trochanteric bursitis)

- **A:** repetitive activity, mechanical overload.
- **P:** repeated movement of the fibroelastic iliotibial band.
- **S/Smx:** pain on the lateral side of the hip or thigh + tenderness on palpation of the greater trochanter.
- **Ix:** XR to rule out other pathology.
- **Mx:** activity modification, physiotherapy, weight loss, steroid injection, NSAIDs.


<!-- ===== SOURCE: 11_05_Ortho_-_Knee_and_Ankle.md ===== -->
...
## 0.2 Bursitis & cysts of the knee
...
## 0.1 Soft Tissue Injury and Healing

**A/P:** Injury to **tendon (muscle to bone), ligament (bone to bone), muscle, fascia, bursa or cartilage**, healing through three overlapping phases:
**1. INFLAMMATORY — the first days.** Haematoma, cytokine release, cellular recruitment.
**2. PROLIFERATIVE / REPAIR — days to weeks.** Fibroblast activity laying down disorganised type III collagen.
**3. REMODELLING — months to a year or more.** Collagen reorganises along lines of stress and matures into type I.

> [!danger] Load is the stimulus for healing, not the enemy of it
> **Connective tissue adapts to the load placed on it. Complete rest causes atrophy, disorganised collagen, stiffness and weakness; appropriate progressive load drives organised remodelling and restores strength.**
> **This inverts the intuitive approach** — patients (and clinicians) reach for rest, immobilisation and avoidance, which produce a weaker tissue and a longer recovery.
> **The clinical task is finding the level of load that stimulates without re-injuring**, and progressing it. That is what physiotherapy actually does.

> [!warning] Set the timeframe honestly at the first consultation
> **Tendon and ligament have poor blood supply and remodel slowly. Full remodelling takes MONTHS TO A YEAR.**
> **Patients who are told "six weeks" and are still symptomatic at three months conclude something is wrong, seek imaging, and enter the investigation cycle.** **Telling them the real timeframe at the outset prevents that**, and is one of the more valuable things said in the consultation.

> [!tip] What impairs healing
> **Age · DIABETES · smoking · corticosteroids (systemic and injected) · FLUOROQUINOLONE antibiotics · poor nutrition and low protein intake · peripheral vascular disease · obesity · and prolonged immobilisation.**
> **Diabetes and metabolic syndrome are genuinely associated with tendinopathy and with poorer healing**, which is worth knowing when a tendinopathy is not responding as expected.

---

## 0.2 Acute Soft Tissue Injury Management

> [!danger] RICE has been superseded — the current framework is PEACE and LOVE
> **PEACE — in the first days after injury:**
> **· PROTECT** — unload and restrict movement briefly, **for days rather than weeks.**
> **· ELEVATE.**
> **· AVOID ANTI-INFLAMMATORIES** — see the caveat below.
> **· COMPRESS.**
> **· EDUCATE** — set expectations, and steer away from passive treatments and unnecessary imaging.
> **LOVE — after the first days:**
> **· LOAD** — progressive mechanical loading as symptoms allow.
> **· OPTIMISM** — **patient expectations independently predict outcome**, and this is not a soft add-on. Catastrophising and fear-avoidance measurably prolong recovery.
> **· VASCULARISATION** — early pain-free cardiovascular activity.
> **· EXERCISE** — restoring mobility, strength and proprioception.

> [!warning] The NSAID and ice question is genuinely contested
> **The rationale for avoiding early NSAIDs and prolonged ice is that inflammation is a necessary part of tissue repair, and there is evidence that NSAIDs may impair tendon, ligament, muscle and bone healing.**
> **But this is not settled**, and **adequate analgesia matters** — a patient in severe pain will not mobilise, and immobility causes its own harm.
> **A pragmatic position: prefer paracetamol and topical agents first, use oral NSAIDs at the lowest effective dose for the shortest period where analgesia genuinely requires it, and do not use them routinely for weeks. Avoid opioids.**
> `UNVERIFIED — this is an area of active debate; check current sports medicine guidance rather than treating either position as settled.`

> [!danger] Prolonged immobilisation causes harm
> **For most soft tissue injuries, early controlled movement produces better outcomes than immobilisation** — less stiffness, less muscle loss, faster return to function.
> **Prolonged use of slings, boots, casts and collars beyond what the injury requires produces joint stiffness, muscle atrophy and, in the shoulder, adhesive capsulitis.**
> **Where immobilisation is genuinely required — a fracture, a complete tendon rupture — it should be for a defined period with a plan for what follows.**

> [!tip] When to image, and when to refer
> **Image for: a decision rule indicating fracture risk, suspicion of complete rupture, inability to weight bear, significant deformity, neurovascular deficit, or failure to progress as expected.**
> **Refer for: complete tendon or ligament rupture, joint instability, neurovascular compromise, open injury, suspected compartment syndrome, and failure of appropriate conservative management.**
> **Do NOT image a straightforward sprain that is following the expected course.**

**Ix:** Radiographs per decision rules (*why:* excludes fracture where indicated; *what:* fracture). Ultrasound (*why:* dynamic assessment of tendon and muscle integrity, accessible and without radiation; *what:* tear, gap, tendinopathy). MRI (*why:* ligamentous, cartilage and deeper structures where the diagnosis will change management; *what:* the structural injury).

---

## 0.3 Tendinopathy

> [!danger] It is a degenerative process, not an inflammatory one — the name matters
> **Histology of chronic tendinopathy shows COLLAGEN DISORGANISATION, increased ground substance, NEOVASCULARISATION and cellular changes — with FEW OR NO INFLAMMATORY CELLS.**
> **This is why anti-inflammatory approaches disappoint, why "tendinitis" is the wrong word, and why the treatment is mechanical rather than pharmacological.**
> A useful model describes a **continuum: reactive tendinopathy (acute overload, reversible) → tendon disrepair → degenerative tendinopathy (structural change, less reversible)** — with the practical implication that **early recognition and load management can reverse it, while established degenerative change cannot be undone but can be worked around.**

**S/Smx:** **Load-related pain** with a characteristic pattern — **pain at the start of activity that "warms up" and eases, then returns worse in the hours afterwards and the next morning.** Localised tenderness at the tendon, pain on resisted contraction, and sometimes thickening.

> [!tip] Load is the treatment
> **Progressive loading is the best-evidenced management, and it works across sites.**
> A typical progression: **ISOMETRIC loading first (which is often analgesic in the reactive phase) → heavy slow resistance / isotonic loading → energy-storage and sport-specific loading.**
> **It takes months and adherence is the main determinant of success** — which is why explaining the rationale matters. A patient who believes rest is the treatment will not do the exercises.
> **Alongside: load management (reducing the aggravating volume without stopping entirely), footwear and ergonomic modification, and addressing metabolic contributors.**
...
> [!danger] Fluoroquinolone-associated tendinopathy and rupture
...
> [!tip] Strains and the sites that matter
> Graded by the extent of fibre disruption and the presence of a palpable defect. `UNVERIFIED — the grading system.`
> **· HAMSTRING** — the commonest sporting muscle injury, and it has a **high recurrence rate** because athletes return before rehabilitation is complete. **Return should be criteria-based, not time-based** — see 0.5.
> **· Medial gastrocnemius ("tennis leg")** — sudden calf pain on push-off, with bruising tracking to the ankle over days. **Must be distinguished from DVT and from Achilles rupture** — do the calf squeeze test and consider imaging, because the three coexist in the differential and a calf that is swollen and painful after an injury can still have a DVT.
> **· Quadriceps and adductor strains.**

> [!warning] Myositis ossificans
> **Heterotopic bone formation within a muscle after significant blunt contusion — classically the quadriceps after a direct knee to the thigh.**
> Presents as **persistent pain, a hard palpable mass and restricted range weeks after the injury**, and it can be mistaken radiologically for a sarcoma.
> **Aggressive early massage, forceful stretching and heat are thought to increase the risk** — so a large thigh contusion is managed with gentle early range of motion in flexion, not vigorous physiotherapy.

> [!tip] Delayed onset muscle soreness versus injury
> **DOMS: bilateral or diffuse, appears 24–48 hours after unaccustomed eccentric exercise, peaks at 48–72 hours, and improves with gentle activity.** It is normal.
> **Injury: immediate onset, focal, with a specific mechanism, and worse with activity.**
...
## 0.5 Rehabilitation and Return to Activity

> [!tip] The sequence
> **1. Restore RANGE of motion and reduce pain and swelling.**
> **2. Restore STRENGTH — progressively, including eccentric loading.**
> **3. Restore PROPRIOCEPTION and neuromuscular control** — **this is the step most often skipped, and it is what prevents re-injury**, particularly after ankle sprain and ACL injury.
> **4. Sport- or task-SPECIFIC training** — replicating the demands the tissue will face.
> **5. Return, with ongoing maintenance.**

> [!danger] Return should be criteria-based, not time-based
> **"Six weeks" is not a criterion. The questions are: is the range full? is strength symmetrical? can they perform the specific tasks required? is there pain during or after?**
> **Time-based return is the main reason hamstring and ankle injuries recur.**
> **Psychological readiness matters too** — after ACL reconstruction, fear of re-injury is a significant and measurable predictor of failure to return to sport, independent of physical recovery.

> [!warning] Rapid increases in load cause overuse injury
> **The commonest cause of overuse injury is a sudden increase in training volume, intensity, frequency or surface — a new running program, a return after a break, a change of footwear, or a competition block.**
> **Ask about what changed in the weeks before the symptoms started** — it is usually there, and modifying it is the treatment.
> **Graded progression, and avoidance of large week-to-week jumps in load, is the preventive principle.**
...
## 0.6 Immobility, Mobility Aids and Functional Assessment
...
> **2. HEIGHT — the handle should be at the level of the WRIST CREASE (or the ulnar styloid) when the person stands upright with the arm relaxed at their side**, giving about 15–20 degrees of elbow flexion.
> **3. TECHNIQUE — the stick and the affected leg move TOGETHER**, then the good leg steps through.
> **A stick that is too tall or too short, or held in the wrong hand, increases falls risk rather than reducing it — an incorrectly fitted aid is worse than none.**
> `UNVERIFIED — the precise fitting measurements.`

> [!tip] The other aids
> **· Axillary crutches — weight must go through the HANDS, not the axilla.** **Weight-bearing through the axilla causes crutch palsy — a radial nerve injury with wrist drop.** There should be a two-finger gap between the axilla and the crutch top.
> **· Forearm (elbow) crutches** — better for longer-term use and for those with adequate upper limb strength.
> **· Pick-up frame** — provides most stability but must be lifted, so it requires upper limb strength and interrupts gait rhythm.
> **· Wheeled frame or four-wheel walker** — better for those who cannot lift a frame, allows continuous gait, and a seat allows rest. **Requires adequate cognition and braking ability** — a four-wheel walker given to someone who cannot manage the brakes is a hazard.
> **Aids should be prescribed and fitted by a physiotherapist where possible**, and reviewed as function changes.

> [!info] Weight-bearing status — know the terms
> **· NWB — non-weight-bearing:** no contact with the ground at all.
> **· TTWB / TDWB — touch or toe-touch weight-bearing:** the foot rests on the ground for balance only, taking minimal load.
> **· PWB — partial weight-bearing:** a specified proportion of body weight.
> **· WBAT — weight-bearing as tolerated.**
> **· FWB — full weight-bearing.**
> **Getting this right matters: an order for non-weight-bearing in an older patient often means they cannot mobilise at all**, with all the consequences above — so it should be specified deliberately by the surgical team and questioned if it seems inconsistent with the injury.

> [!tip] Functional assessment — the measures that are quick and predictive
...
**Ix:** **Physiotherapy and occupational therapy assessment** (*why:* they determine aid prescription, home safety and rehabilitation potential more accurately than a medical assessment does; *what:* mobility, transfers, ADL performance, equipment needs). **Home visit or home assessment** (*why:* function in a corridor bears little relation to function at home with stairs, thresholds, bathrooms and no handrails; *what:* hazards, feasibility). Timed Up and Go and gait speed (*why:* objective baseline and falls risk; *what:* the values). Cognitive assessment (*why:* determines the safety of certain aids and the capacity for rehabilitation; *what:* impairment).

### 0.6.1 Mx – Immediate
Mobilise. Remove unnecessary tethers — catheters, lines, telemetry. Analgesia adequate to permit movement.
...
**A/P:** **Secondary (indirect) healing — the usual route with cast or relative stability — proceeds through haematoma → inflammation → soft callus → hard callus → remodelling.** **Primary (direct) healing occurs only with rigid anatomical fixation and produces NO visible callus** — which is why an absence of callus after plating is expected rather than concerning.

> [!tip] What impairs union
> **· Poor blood supply and soft tissue stripping · inadequate stability · infection · a gap between fragments · SMOKING, which substantially impairs union and is worth addressing explicitly · diabetes · corticosteroids · malnutrition and low vitamin D · NSAIDs (debated) · and older age.**
> **Smoking cessation is a legitimate and evidence-based part of fracture management**, particularly before elective fusion or reconstruction.
...
> **· Venous thromboembolism** — high risk with lower limb fracture and immobilisation; prophylaxis required.

> [!danger] Late complications, and the AVN sites worth memorising
> **· MALUNION and NON-UNION** — atrophic (poor biology, no callus) versus hypertrophic (poor stability, abundant callus).
> **· AVASCULAR NECROSIS — the sites where blood supply is retrograde or precarious:**
> **— SCAPHOID (proximal pole) · FEMORAL HEAD (intracapsular neck of femur fracture) · TALUS (neck) · LUNATE (Kienböck) · humeral head.**
...
> **Pain and other features DISPROPORTIONATE to the inciting injury, persisting beyond the expected course**, typically after a distal limb fracture, crush or surgery.
> **Features: burning pain, ALLODYNIA (pain from light touch) and hyperalgesia · oedema · asymmetry of skin colour and TEMPERATURE · sweating changes · and later trophic changes in skin, nails and hair, with stiffness and contracture.**
> **Diagnosed clinically using the Budapest criteria; there is no confirmatory test.** `UNVERIFIED — the criteria.`
> **Management: early mobilisation, physiotherapy and desensitisation, adequate analgesia including neuropathic agents, and referral to a pain service.** **Prolonged immobilisation makes it worse**, and reassurance that the limb is safe to use is part of treatment.
> **Prevention matters: avoid tight casts, mobilise early, and treat pain adequately after distal limb injury.**

**Ix:** Radiographs at intervals (*why:* assesses union and alignment; *what:* callus, alignment, hardware position). CT (*why:* assesses union where radiographs are equivocal, and intra-articular step-off; *what:* bridging bone, articular congruity). **Vitamin D, calcium and bone profile in delayed union or fragility fracture** (*why:* correctable metabolic contributors; *what:* deficiency). Inflammatory markers and imaging where infection is suspected (*why:* osteomyelitis and infected non-union; *what:* infection).

---

## 0.3 Upper Limb Fractures and Eponyms

> [!info] Distal radius — the four names
> **· COLLES — extra-articular distal radius with DORSAL displacement and angulation.** The **"dinner fork" deformity.** **FOOSH in an older, often osteoporotic patient — and it is a FRAGILITY FRACTURE that should trigger osteoporosis assessment.** **Check MEDIAN nerve function before and after reduction.**
> **· SMITH — distal radius with VOLAR displacement.** The "reverse Colles", from a fall onto a flexed wrist. More often unstable and requiring fixation.
> **· BARTON — an intra-articular distal radius fracture with SUBLUXATION of the carpus**, dorsal or volar. Unstable.
> **· CHAUFFEUR'S (Hutchinson) — radial styloid fracture.**

> [!danger] Monteggia and Galeazzi — the fracture is obvious, the dislocation is missed
> **· MONTEGGIA — fracture of the ULNAR shaft with dislocation of the RADIAL HEAD.**
> **· GALEAZZI — fracture of the RADIAL shaft with dislocation of the DISTAL RADIOULNAR JOINT.**
> **Mnemonic: GRUM — Galeazzi = Radius; Ulna = Monteggia.**
> **These are the archetypal reason to image the joint above and below.** A forearm shaft fracture with an unexamined and unimaged elbow or wrist is how the dislocation is missed, and **a missed radial head dislocation leads to permanent loss of forearm rotation.**
> **Check the radiocapitellar line on every paediatric and adult elbow film** — a line through the radial neck should pass through the capitellum on every view.

> [!warning] The nerve at risk depends on where the humerus breaks
> **· SURGICAL NECK of humerus → AXILLARY nerve.** Test **regimental badge sensation and deltoid contraction.** Also at risk in anterior shoulder dislocation.
> **· HUMERAL SHAFT (spiral groove) → RADIAL nerve → WRIST DROP.** **Usually a neurapraxia that recovers over weeks to months**, but it must be documented before and after any manipulation, and the wrist splinted in the interim.
> **· SUPRACONDYLAR humerus → median nerve and its ANTERIOR INTEROSSEOUS branch, radial nerve, and the BRACHIAL ARTERY.** See 0.5.
...
## 0.4 Lower Limb Fractures and Eponyms

> [!danger] Neck of femur — the intracapsular/extracapsular distinction determines the operation
> **The femoral head's blood supply runs RETROGRADE up the femoral neck.**
> **· INTRACAPSULAR (subcapital, transcervical) fractures disrupt that supply → high risk of AVN and non-union → the head is REPLACED (hemiarthroplasty, or total hip replacement in more active patients).**
...
> **Normal distal pulses DO NOT exclude an intimal injury that will thrombose over the following hours.**
> **Measure the ankle-brachial index, and obtain CT angiography if it is abnormal or if there is any clinical concern.** **A missed popliteal injury results in amputation.**
...
## 0.5 Paediatric Fractures

> [!tip] Children's bones behave differently
> **· Thicker, more active PERIOSTEUM** — greater stability and faster healing.
> **· GROWTH PLATES (physes)** — a zone of weakness, so ligaments often survive while the physis fails. **A "sprain" in a skeletally immature child is more likely a physeal injury.**
> **· REMODELLING POTENTIAL** — considerable, especially near a growth plate, in the plane of joint movement, and in younger children. **Angulation that would be unacceptable in an adult may be accepted.** **Rotation does NOT remodel.**
> **· More porous bone** → **greenstick (incomplete, one cortex) and buckle/torus (compression of one cortex) patterns.**

> [!info] Salter-Harris classification — SALTR
> **I — Straight across the physis** (may be radiographically normal — diagnosed clinically by physeal tenderness).
> **II — Above: through the physis and up into the METAPHYSIS.** **The commonest.**
> **III — beLow: through the physis and down into the EPIPHYSIS. INTRA-ARTICULAR.**
> **IV — Through: crossing metaphysis, physis and epiphysis. INTRA-ARTICULAR.**
> **V — cRush: compression of the physis. Worst prognosis, frequently missed initially, and often diagnosed retrospectively when growth arrest appears.**
> **Types III and IV are intra-articular and require anatomical reduction. Types IV and V carry the highest risk of GROWTH ARREST**, producing limb length discrepancy or angular deformity — **so physeal injuries need follow-up, and the family should be told why.**

> [!danger] Supracondylar humeral fracture — the paediatric fracture with the most to lose
> **The commonest paediatric elbow fracture, usually from a FOOSH with hyperextension.** Graded by the **Gartland** classification. `UNVERIFIED — the classification.`
> **Neurovascular assessment is critical and must be documented:**
> **· ANTERIOR INTEROSSEOUS NERVE — test the "OK sign" (flexion of the thumb IP and index DIP joints). It is a PURELY MOTOR nerve, so there is no sensory loss and the injury is missed unless specifically tested.**
> **· Median, radial and ulnar nerves.**
> **· BRACHIAL ARTERY — a pulseless, poorly perfused hand requires URGENT reduction and vascular assessment.**
> **· COMPARTMENT SYNDROME → VOLKMANN ISCHAEMIC CONTRACTURE**, a devastating permanent flexion deformity of the forearm and hand.
> **Increasing pain, pain on passive finger extension, and a child requiring escalating analgesia after a supracondylar fracture is compartment syndrome until proven otherwise.**

> [!danger] Non-accidental injury — the features that must trigger action
> **· A history that is INCONSISTENT with the injury, CHANGES between tellings, or is inconsistent between carers.**
> **· A DELAY in presentation without adequate explanation.**
> **· An injury inconsistent with the child's DEVELOPMENTAL STAGE** — **"if they can't cruise, they shouldn't bruise": a femoral or long bone fracture in a NON-AMBULANT infant is highly suspicious.**
...
## 0.7 Open Fractures and Orthopaedic Emergencies

> [!danger] Open fracture management — the sequence
> **1. A–E, with control of haemorrhage.**
> **2. Assess and DOCUMENT neurovascular status.**
> **3. PHOTOGRAPH the wound once** — so that repeated exposure is unnecessary.
...
> **Name the specific nerves and their function** — "radial nerve: wrist extension intact, first web space sensation intact" — rather than "NV intact".
> **A deficit found later, with no baseline documentation, cannot be attributed and is a medicolegal problem as well as a clinical one.**

**Ix:** **Radiographs — two orthogonal views including the joint above and below** (*why:* the fundamental requirement, and it catches associated dislocation; *what:* fracture, alignment, dislocation). CT (*why:* intra-articular fractures, complex anatomy (pelvis, calcaneus, spine), and pre-operative planning; *what:* articular step-off, comminution). MRI (*why:* radiographically occult fractures — scaphoid, hip, stress fractures — and associated soft tissue injury; *what:* marrow oedema, fracture line). **Ankle-brachial index and CT angiography where vascular injury is possible** (*why:* normal pulses do not exclude intimal injury in knee dislocation and penetrating trauma; *what:* arterial injury). FBC, group and hold or crossmatch, coagulation, UEC (*why:* blood loss, and preparation for surgery; *what:* baseline). **Calcium, vitamin D and bone profile in fragility fracture** (*why:* the fracture is the diagnosis of osteoporosis; *what:* deficiency and secondary causes). **Skeletal survey and metabolic bone workup where non-accidental injury is a concern** (*why:* identifies occult fractures of different ages and excludes metabolic bone disease; *what:* multiple fractures, healing at different stages).
...
## 0.1 The Primary Survey and Trauma Principles

> [!tip] <C>ABCDE — catastrophic haemorrhage comes first where it applies
> **In penetrating trauma, blast injury and traumatic amputation, exsanguinating external haemorrhage is addressed BEFORE the airway** — direct pressure, a tourniquet, or a haemostatic dressing. A perfect airway in an exsanguinated patient achieves nothing.
> **In blunt trauma without catastrophic external bleeding, the conventional ABCDE sequence applies.**
...
> **Practically: keep the patient warm from the outset — remove wet clothing, use warmed fluids and blood, forced-air warming, and a warm resuscitation room.** **Exposure for examination must be brief and followed by re-covering.**
> **This is why "damage control" surgery exists — arrest the bleeding and contamination, then correct physiology in ICU, and return for definitive repair later.**

> [!tip] The secondary and tertiary surveys
> **Secondary survey — a head-to-toe examination once the primary survey is complete and the patient is not deteriorating**, including a log roll with inspection and palpation of the back, and a **rectal and perineal examination where indicated.** **AMPLE history: Allergies, Medications, Past history, Last meal, Events.**
> **TERTIARY SURVEY — a repeat full examination at around 24 hours, when the patient is awake and communicative.**
> **Missed injuries are common in major trauma** — small bone fractures, tendon injuries, ligamentous injuries and peripheral nerve deficits are routinely overlooked during the initial resuscitation because the patient is intubated, distracted by a major injury, or intoxicated.
> **The tertiary survey is what finds them, and it is frequently omitted.**

**Ix:** **Adjuncts to the primary survey: chest radiograph, pelvic radiograph, eFAST, VBG or ABG with lactate, bedside glucose, ECG** (*why:* each addresses a specific life threat in real time; *what:* pneumothorax, haemothorax, pelvic disruption, free fluid, pericardial fluid, hypoperfusion). **FBC, group and hold or crossmatch, coagulation profile, UEC, LFT, lipase, troponin as indicated, and a pregnancy test in any woman of reproductive age** (*why:* baseline, transfusion preparation, and pregnancy changes the whole management; *what:* baseline and pregnancy status). **Whole-body CT ("pan-scan") in the stable major trauma patient** (*why:* identifies injuries that clinical examination misses, particularly in the intubated or distracted patient; *what:* the injury burden — **but the unstable patient goes to theatre, not the scanner**). **Repeat lactate and base deficit** (*why:* trends reflect the adequacy of resuscitation better than blood pressure does; *what:* clearance or persistence).
...
> **· Le Fort II — pyramidal, extending through the nasal bridge and infraorbital rims.** The maxilla and nose move together.
> **· Le Fort III — craniofacial DISJUNCTION**, separating the entire facial skeleton from the skull base. The whole face moves.
> **Tested by holding the forehead and gently rocking the upper alveolus** — the level at which movement occurs indicates the pattern. **All are high-energy injuries; look for associated head, cervical spine and ocular injury, and for CSF leak.**

> [!danger] Orbital blowout — and the paediatric "white-eyed" variant
> **A blow to the globe raises intraorbital pressure and fractures the thin ORBITAL FLOOR**, herniating orbital contents into the maxillary sinus.
> **Features: DIPLOPIA, particularly on UPGAZE · restricted upward eye movement · ENOPHTHALMOS · INFRAORBITAL NERVE NUMBNESS over the cheek, lateral nose and upper lip and gum · surgical emphysema, and epistaxis.**
> **Advise against nose blowing** — it forces air into the orbit and can cause dramatic swelling and, rarely, orbital compartment syndrome.
> **THE PAEDIATRIC "WHITE-EYED BLOWOUT" IS A SURGICAL EMERGENCY.** Children's bones are more elastic, so the floor springs back as a **trapdoor, entrapping muscle**. **The eye looks white and quiet with minimal bruising or swelling — so the injury looks trivial — while the inferior rectus is strangulated.**
> **The clue is the OCULOCARDIAC REFLEX: bradycardia, nausea and vomiting, sometimes syncope, on attempted upgaze.**
> **A child with a periorbital injury who is vomiting and bradycardic with restricted upgaze needs urgent CT and urgent ophthalmic or maxillofacial surgery — muscle ischaemia and permanent diplopia follow delay.** **The vomiting is easily attributed to head injury, which is how this is missed.**

> [!danger] Examine inside the nose — septal haematoma
> **A boggy, bluish swelling of the nasal septum after nasal trauma.**
> **It is missed because nobody looks inside the nose with a light and a speculum.**
> **Untreated, pressure causes septal cartilage necrosis within days, producing septal perforation and a permanent SADDLE-NOSE deformity.**
> **It requires urgent incision and drainage, not observation.** **Examine the septum in every nasal injury**, including in children.
...
**Ix:** **CT facial bones with fine cuts and reconstructions** (*why:* plain radiographs are inadequate for facial fractures; *what:* fracture pattern, orbital contents, sinus opacification). **CT brain and cervical spine** (*why:* high-energy facial trauma is associated with head and cervical injury; *what:* intracranial and spinal injury). **Visual acuity and pupil examination — documented, before swelling closes the eye** (*why:* it becomes impossible to assess later, and a relative afferent pupillary defect is the key sign of optic nerve compromise; *what:* acuity, RAPD). Examination of the nasal septum (*why:* septal haematoma; *what:* boggy septal swelling). Assessment of occlusion and facial nerve function (*why:* mandibular and facial nerve injury; *what:* malocclusion, nerve deficit).

---

## 0.3 Chest Trauma

> [!danger] Flail chest — the problem is the lung underneath, not the paradox
> **Three or more contiguous ribs fractured in two or more places, producing a segment that moves paradoxically.**
> **The paradoxical movement looks dramatic but is not the main threat — the underlying PULMONARY CONTUSION is**, and it evolves over the first 24–48 hours, so the initial chest radiograph may underestimate it.
> **Management: excellent ANALGESIA (regional techniques — intercostal, serratus anterior or paravertebral blocks, or epidural — rather than escalating opioids), respiratory physiotherapy, judicious fluid (over-resuscitation worsens contusion), oxygen, and non-invasive or invasive ventilation where required.** Surgical rib fixation is used in selected cases.

> [!warning] Rib fractures in the elderly are far more dangerous than they look
> **Mortality and pneumonia risk rise steeply with the number of rib fractures and with age.**
> **An older patient with three or more rib fractures needs ADMISSION, aggressive multimodal analgesia including regional blocks, respiratory physiotherapy and incentive spirometry — not discharge with oral analgesia.**
> **The mechanism of death is simple and preventable: pain → splinting → poor cough → atelectasis → pneumonia → respiratory failure.**
> **Analgesia is the treatment.**

> [!tip] Rib fracture location tells you what else to look for
> **· FIRST or SECOND rib fracture → very high energy. Look for aortic, brachial plexus, subclavian vessel and major airway injury.**
> **· Ribs 9–12 → INTRA-ABDOMINAL injury. LEFT-sided → SPLEEN. RIGHT-sided → LIVER.**
> **· Sternal fracture → blunt cardiac injury; get an ECG and consider troponin.**
> **· Scapular fracture → high energy.**

> [!danger] The potentially life-threatening injuries found after the primary survey
> **· PULMONARY CONTUSION — evolves over 24–48 hours; the initial film underestimates it.**
> **· BLUNT AORTIC INJURY — a rapid deceleration mechanism (high-speed collision, fall from height). Chest radiograph clues: a WIDENED MEDIASTINUM, loss of the aortic knuckle, left apical cap, depressed left main bronchus, deviated nasogastric tube. CT ANGIOGRAPHY is the investigation, and the injury is lethal if missed.**
> **· TRACHEOBRONCHIAL INJURY — persistent large air leak, massive surgical emphysema, a pneumothorax that will not re-expand despite a functioning drain.**
> **· BLUNT CARDIAC INJURY — arrhythmia, ECG changes, raised troponin; monitor.**
> **· DIAPHRAGMATIC RUPTURE — more often LEFT-sided (the liver protects the right). Bowel or the nasogastric tube seen in the chest is diagnostic. It may present LATE, months or years afterwards, with obstruction or strangulation.**
> **· OESOPHAGEAL INJURY — rare in blunt trauma, with mediastinal air and effusion.**

> [!tip] Chest drain insertion
> **Inserted in the "safe triangle" — bordered by the lateral border of pectoralis major, the anterior border of latissimus dorsi, a line at the level of the nipple, and the apex below the axilla.**
> **Blunt dissection over the TOP of the rib below**, avoiding the neurovascular bundle running beneath each rib.
> **Complications: injury to lung, heart, liver, spleen and diaphragm; malposition; and infection.**
> **A massive haemothorax with a large immediate drain output, or high ongoing output, is an indication for thoracotomy** — `UNVERIFIED — the volume thresholds.`

**Ix:** **Chest radiograph** (*why:* the primary survey adjunct — pneumothorax, haemothorax, mediastinal width, diaphragm; *what:* the findings above). **eFAST** (*why:* detects pericardial fluid and pneumothorax rapidly at the bedside; *what:* tamponade, pneumothorax). **CT chest with contrast / CT angiography** (*why:* the definitive assessment, and the only way to exclude aortic injury; *what:* aortic injury, contusion, occult pneumothorax, rib fractures). ECG and troponin (*why:* blunt cardiac injury, particularly with sternal fracture; *what:* arrhythmia, ischaemic change). ABG (*why:* oxygenation and ventilation; *what:* hypoxia, hypercapnia).

---

## 0.4 Abdominal Trauma

> [!tip] eFAST — know what it can and cannot do
> **It detects FREE FLUID. It does NOT reliably detect solid organ injury, hollow viscus injury or retroperitoneal injury.**
> **A NEGATIVE FAST DOES NOT EXCLUDE SIGNIFICANT ABDOMINAL INJURY** — this is the most important limitation and the source of most errors in its use.
> **Its value is in the UNSTABLE patient: a positive FAST in a hypotensive patient means the abdomen is the source and the patient goes to theatre, not to CT.**
> **In the STABLE patient, CT with intravenous contrast is the standard** and is far more informative.

> [!warning] The organs and their patterns
> **· SPLEEN — the commonest solid organ injured in blunt trauma.** Associated with **LEFT lower rib fractures** and with **KEHR SIGN — left shoulder tip pain from diaphragmatic irritation by blood**, classically worse when supine. **DELAYED splenic rupture occurs days to weeks later** — so a patient managed non-operatively needs clear advice about what to return for.
> **· LIVER — right upper quadrant, right lower rib fractures.**
> **· HOLLOW VISCUS and MESENTERY — the ones that are missed.** They may cause few early signs and present hours to days later with peritonitis. **FREE FLUID ON CT WITHOUT AN IDENTIFIED SOLID ORGAN INJURY SHOULD RAISE HOLLOW VISCUS OR MESENTERIC INJURY** and warrants observation, serial examination and repeat imaging rather than discharge.
> **· RETROPERITONEAL — duodenum, pancreas and kidneys.** **Pancreatic and duodenal injury from a handlebar or seatbelt, particularly in children, is subtle and frequently delayed in diagnosis.** Serial lipase and repeat imaging.

> [!danger] The seat belt sign
> **A band of bruising across the abdomen or chest from the restraint indicates significant transmitted energy.**
> **It is associated with: HOLLOW VISCUS injury (small bowel and mesentery) · and CHANCE FRACTURES of the lumbar spine — a flexion-distraction injury through the vertebral body and posterior elements.**
> **So a seat belt sign mandates careful abdominal assessment AND imaging of the lumbar spine**, and the spinal injury is missed if only the abdomen is scanned.

> [!tip] Non-operative management, and when it is not an option
> **Haemodynamically stable patients with solid organ injury are now routinely managed NON-OPERATIVELY**, with observation, serial examination and haemoglobin, and angioembolisation where there is a contrast blush.
> **Indications for laparotomy: haemodynamic instability with a positive FAST · peritonitis · evisceration · a retained impaling object · free intraperitoneal air · diaphragmatic rupture · and gunshot wounds traversing the peritoneum.**
> **Penetrating trauma: gunshot wounds crossing the peritoneum generally require laparotomy; stab wounds may be selectively managed** with local wound exploration, serial examination or CT depending on the trajectory and the institution.

**Ix:** **eFAST** (*why:* rapid identification of free fluid in the unstable patient; *what:* free fluid — with the limitations above). **CT abdomen and pelvis with intravenous contrast** (*why:* the standard in the stable patient, grading solid organ injury and identifying retroperitoneal and vascular injury; *what:* organ injury grade, contrast blush, free air, free fluid). Serial FBC and haemoglobin (*why:* ongoing bleeding in non-operative management; *what:* falling haemoglobin). **Serial abdominal examination by the same clinician where possible** (*why:* a changing examination is the most sensitive indicator of missed hollow viscus injury, and continuity makes the change detectable; *what:* developing peritonism). Lipase (*why:* pancreatic injury, particularly with a handlebar mechanism; *what:* rising lipase). **Urinalysis** (*why:* haematuria indicates renal tract injury and prompts dedicated imaging; *what:* blood). Lumbar spine imaging where a seat belt sign is present (*why:* Chance fracture; *what:* flexion-distraction injury).

---

## 0.5 Pelvic Trauma

> [!danger] Do NOT "spring" the pelvis
> **Repeated compression or distraction of the pelvis to test for instability is unreliable, painful, and — critically — can DISLODGE FORMED CLOT and precipitate further haemorrhage.**
> **The examination is not recommended.** If pelvic injury is suspected from the mechanism, **apply a binder and image.**

> [!danger] Apply the binder at the level of the GREATER TROCHANTERS
> **The commonest error is placing it too high, over the iliac crests, where it does nothing to reduce pelvic volume.**
> **The binder works by reducing an "open book" injury and reducing the pelvic volume, tamponading the venous plexus and cancellous bone bleeding.**
> **Position it over the greater trochanters, apply it before or during transfer, and do not remove it for imaging or examination without a plan.**

> [!tip] The mechanisms
> **· LATERAL COMPRESSION — the commonest.** Internal rotation of the hemipelvis; associated with head and abdominal injury.
> **· ANTEROPOSTERIOR COMPRESSION ("open book")** — external rotation, increasing pelvic volume, with **the highest haemorrhage risk** and the pattern the binder most helps.
> **· VERTICAL SHEAR** — fall from height; highly unstable.
> **The bleeding in pelvic fracture is predominantly VENOUS and from cancellous bone, with a minority arterial** — which is why mechanical stabilisation (binder, external fixator, packing) is as important as angioembolisation.
> Management depends on the institution: **binder and resuscitation → angioembolisation, preperitoneal packing, or external fixation**, in an order determined by local resources and the pattern of injury.

> [!danger] The associated injuries that determine management
> **· URETHRAL INJURY — blood at the urethral meatus, perineal or scrotal bruising, and a high-riding prostate.** **DO NOT ATTEMPT URETHRAL CATHETERISATION** — it can convert a partial tear into a complete disruption. **A retrograde urethrogram is performed first, and a suprapubic catheter may be needed.** **This is examinable and it is a genuine harm.**
> **· BLADDER RUPTURE** — intraperitoneal (usually from a full bladder and blunt force, requiring repair) or extraperitoneal (usually managed with catheter drainage).
> **· RECTAL OR VAGINAL INJURY — this makes the pelvic fracture an OPEN fracture**, with a much higher infection and mortality risk. **A rectal and vaginal examination is part of the assessment**, and any breach mandates urgent surgical involvement and antibiotics.
> **· Lumbosacral plexus and nerve root injury.**

**Ix:** **Pelvic radiograph as a primary survey adjunct** (*why:* identifies the disruption in the unstable patient without moving them to CT; *what:* symphyseal widening, sacroiliac disruption, fractures). **CT with contrast** (*why:* defines the fracture pattern and identifies arterial contrast extravasation directing embolisation; *what:* fracture, blush). **Retrograde urethrogram before catheterisation where urethral injury is suspected** (*why:* prevents converting a partial to a complete injury; *what:* extravasation). CT cystogram (*why:* bladder rupture and whether it is intra- or extraperitoneal; *what:* contrast extravasation pattern). **Rectal and vaginal examination** (*why:* identifies an open pelvic fracture, which changes prognosis and management entirely; *what:* mucosal breach, bleeding).

---

## 0.6 Trauma in Special Populations

> [!danger] The elderly — normal vital signs are falsely reassuring
...
> [!warning] Children
> **· Greater physiological reserve, then ABRUPT decompensation. HYPOTENSION IS A LATE AND PRE-TERMINAL SIGN** — tachycardia, poor perfusion, and altered conscious state come first and must be acted on.
> **· A larger head-to-body ratio** — more head injury, and a different flexion point in the cervical spine.
...
> **The best treatment for the fetus is effective maternal resuscitation. Do not divert attention from the mother to fetal monitoring.**
> **· AORTOCAVAL COMPRESSION after about 20 weeks: the gravid uterus compresses the inferior vena cava when supine, reducing venous return by a large fraction.** **Apply MANUAL LEFT UTERINE DISPLACEMENT, or tilt the patient (or the spinal board) to the left.** **This alone can restore a blood pressure.**
...
- **Blood, not crystalloid**, is the resuscitation fluid in haemorrhagic shock — see [[10_08_Haemonc_-_Blood_Products_and_Transfusion]] Massive Transfusion Protocol (MTP) and `[[Emergency and Crit Care_merged]] 01_Cardiovascular §0.20 Shock`, §0.20.2 Hypovolaemic shock, for the physiology and the classification by blood loss, not repeated here.
