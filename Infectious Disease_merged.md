...
## 0.1 Fever — Mechanism and the Approach

**D:** A **regulated** elevation of body temperature, produced by a rise in the hypothalamic thermoregulatory set point.

**A/P:** Exogenous pyrogens (microbial products) and tissue injury stimulate release of **endogenous pyrogens — interleukin-1, interleukin-6, tumour necrosis factor and interferons** → these act on the organum vasculosum of the lamina terminalis → **prostaglandin E2** production → the hypothalamic set point rises → the body then **defends the new higher temperature** by vasoconstricting, shivering and seeking warmth.
...
> [!tip] Not all fever is infection
> **· Malignancy** — lymphoma, leukaemia, renal cell carcinoma, hepatocellular carcinoma, atrial myxoma.
> **· Inflammatory** — connective tissue disease, vasculitis, **giant cell arteritis and polymyalgia rheumatica**, adult-onset Still disease, sarcoidosis, inflammatory bowel disease.
> **· Thromboembolic** — deep vein thrombosis and pulmonary embolism cause low-grade fever.
> **· Drug fever** — see 0.6.
...
## 0.2 Acute Undifferentiated Fever

> [!tip] The systematic source search — head to toe, because the source is usually findable
> **History:** onset and pattern · localising symptoms in every system · **exposures — travel (see 0.4), animals, occupational, sick contacts, food and water, recreational water, sexual history, injecting drug use** · immunisation status · recent hospitalisation, surgery or procedures · **indwelling devices** · antibiotics in the preceding weeks · immunosuppression · known colonisation with resistant organisms.
> **Examination — and these are the ones that get skipped:**
> **· Skin, in full** — rashes, wounds, **IV cannula sites**, pressure areas, perianal region, feet and between the toes.
...
> **· Calves** — DVT.
> **· Every line, drain, catheter and device.**

> [!danger] The commonly missed sources
> **Dental and sinus infection · prostatitis · epidural abscess and discitis · infective endocarditis · intra-abdominal or pelvic collection · perianal abscess · line and device infection · septic arthritis · pressure injury with underlying osteomyelitis · *Clostridioides difficile* · venous thromboembolism · and drug fever.**
> Several of these produce few localising signs and are found only because they were specifically looked for.

> [!warning] Do not reflexively start antibiotics in a stable patient with no source
> **In a haemodynamically stable, non-neutropenic patient without an identified source, obtaining cultures and observing is often better than empirical antibiotics.**
...
### 0.2.2 Mx – Definitive
Source control and targeted antimicrobials.

### 0.2.3 Mx – Chronic/long-term
De-escalate on cultures and review duration daily.
...
> **1. Infection** — the largest single group. **Tuberculosis, particularly extrapulmonary and miliary** · **infective endocarditis** (especially culture-negative, or partially treated) · occult abscess — hepatic, subphrenic, pelvic, perinephric, dental · osteomyelitis and discitis · EBV and CMV · **Q fever, which is genuinely relevant in Australia — abattoir workers, farmers, veterinarians and those with livestock or kangaroo exposure, and there is a vaccine** · brucellosis · HIV.
> **2. Malignancy** — **lymphoma above all**, leukaemia, renal cell carcinoma, hepatocellular carcinoma, atrial myxoma, and metastatic disease.
> **3. Non-infectious inflammatory disease** — **giant cell arteritis and polymyalgia rheumatica, which are a leading cause in the over-50s and are treatable** · adult-onset Still disease (quotidian fever, evanescent salmon-pink rash, arthralgia, very high ferritin) · vasculitis · SLE · sarcoidosis · inflammatory bowel disease.
> **4. Miscellaneous** — **drug fever** · thromboembolism · thyroiditis · familial Mediterranean fever and other periodic fever syndromes · factitious fever.

> [!danger] The most productive step is to repeat the history and examination, not to order more tests
> **In a substantial proportion of cases the diagnosis is in a detail missed on the first pass** — an exposure not asked about, a rash that has come and gone, a drug started three weeks ago, a travel history that was taken as "no recent travel" when the patient meant no travel this month.
> **Take the history again, from the beginning, and examine the patient again, fully, including the skin, mouth, temporal arteries, spine and genitalia.** Repeat this as the illness evolves — new signs appear.
> **Also: stop every non-essential medication**, because drug fever is common, entirely reversible, and diagnosed only by cessation.
...
> **PET-CT has become genuinely useful in FUO**, identifying occult infection, inflammation and malignancy and directing biopsy — it is one of the few "broad" investigations that earns its place. `UNVERIFIED — availability, funding and indications in Australia.`
> **Biopsy anything accessible and abnormal** — a lymph node, a skin lesion, a temporal artery, the bone marrow, or a liver lesion. **Histology diagnoses FUO more often than serology does.**

**Ix:** As per 0.2, plus: **repeated blood cultures, including prolonged incubation and specific request for fastidious organisms** (*why:* culture-negative endocarditis organisms — *Coxiella*, *Bartonella*, *Brucella*, HACEK — require specific culture conditions or serology and are missed on routine sets; *what:* fastidious organism). **Tuberculosis investigation — sputum, interferon-gamma release assay, imaging, and tissue where accessible** (*why:* extrapulmonary and miliary TB is a leading FUO cause and is missed because it does not present with a cough; *what:* AFB, granulomas, IGRA). **ESR, CRP, and temporal artery ultrasound or biopsy in the over-50s** (*why:* giant cell arteritis is common, treatable and sight-threatening; *what:* raised markers, arteritis). **Autoimmune serology — ANA, ENA, ANCA, rheumatoid factor, complement** (*why:* connective tissue disease and vasculitis; *what:* positive serology, interpreted in clinical context). **Ferritin** (*why:* a very high ferritin supports adult-onset Still disease and haemophagocytic lymphohistiocytosis; *what:* marked elevation). LDH and blood film (*why:* lymphoma and haematological malignancy; *what:* raised LDH, abnormal cells). Serology for **Q fever, *Bartonella*, *Brucella*, EBV, CMV, HIV, syphilis and hepatitis** (*why:* the treatable infective causes of prolonged fever; *what:* positive serology). **CT chest, abdomen and pelvis** (*why:* occult abscess, lymphadenopathy, malignancy; *what:* collection, nodes, mass). Echocardiography including transoesophageal (*why:* endocarditis; *what:* vegetation). **PET-CT** where the above is negative (*why:* localises occult inflammation and directs biopsy; *what:* focal uptake). **Bone marrow aspirate and trephine** (*why:* diagnoses haematological malignancy, disseminated infection including TB, and haemophagocytic syndromes; *what:* histology, culture). **Full medication review with cessation of non-essential drugs** (*why:* drug fever is diagnosed by resolution on stopping; *what:* defervescence within days).

### 0.3.1 Mx – Immediate
Rarely required unless the patient becomes unstable.

### 0.3.2 Mx – Definitive
Diagnosis-directed. **Infectious diseases involvement early**, rather than after months of undirected testing.

### 0.3.3 Mx – Chronic/long-term
A proportion of FUO resolves spontaneously without a diagnosis ever being made, and that is an acceptable outcome once serious causes have been excluded — **but it should be a considered conclusion with planned follow-up, not an abandonment.**

---

## 0.4 Fever in the Returning Traveller

> [!danger] Malaria until proven otherwise
> **Any fever in a person who has been in a malaria-endemic area — at any point in the preceding months, and regardless of prophylaxis — is malaria until excluded.**
> ***Plasmodium falciparum* can progress from first symptom to death within days**, and it is the diagnosis that must be made today, not tomorrow.
> **Exclusion requires repeated blood films — thick and thin — and/or a rapid diagnostic test.** A single negative film does not exclude malaria, because parasitaemia fluctuates; **three negative sets over consecutive days are conventionally required.** `UNVERIFIED — the number and timing of films, and the role of rapid diagnostic tests and PCR, from current Australian guidance.`
> **Prophylaxis does not exclude it** — adherence is imperfect and no regimen is fully protective.
> **Severe malaria** — impaired consciousness, seizures, acidosis, hypoglycaemia, renal failure, ARDS, high parasitaemia, jaundice, bleeding — is a medical emergency requiring parenteral treatment and ICU-level care.

> [!tip] Incubation period narrows the differential fast
> **· Short, under about 10 days** — **dengue, rickettsial infection, typhoid (early), influenza and other respiratory viruses, bacterial gastroenteritis, leptospirosis, meningococcal disease, malaria.**
> **· Intermediate, roughly 10–21 days** — **malaria, typhoid, leptospirosis, Q fever, brucellosis, viral haemorrhagic fevers.**
> **· Long, beyond 21 days** — **malaria (particularly *P. vivax* and *P. ovale*, which relapse from dormant liver hypnozoites months later), tuberculosis, viral hepatitis, amoebic liver abscess, leishmaniasis, HIV, schistosomiasis, filariasis.**
> **Take the exact itinerary with dates**, not just "Asia" — the countries, rural versus urban, and the activities.

> [!tip] The specific diagnoses worth knowing
> **· Dengue** — fever, severe myalgia and headache, retro-orbital pain, rash, **leucopenia and thrombocytopenia.** **Warning signs of severe dengue: abdominal pain, persistent vomiting, mucosal bleeding, lethargy, hepatomegaly and a rising haematocrit with a falling platelet count**, signalling plasma leakage. **Avoid NSAIDs and aspirin** because of bleeding risk. Management is supportive with careful fluid balance.
> **· Typhoid (enteric fever)** — insidious fever, headache, abdominal pain, **relative bradycardia**, rose spots, constipation more often than diarrhoea early. **Blood cultures are the key test.** Complications: intestinal perforation and haemorrhage in the third week.
> **· Rickettsial infections — scrub typhus, spotted fevers, murine typhus** — fever, headache, myalgia, rash, and **an ESCHAR at the bite site.** **Look for the eschar — in the axilla, groin, under the breast, behind the knee, in the scalp** — because it is easily missed and it makes the diagnosis. **Doxycycline is the treatment and is given empirically on suspicion**, since serology is retrospective.
> **· Leptospirosis** — freshwater exposure, flooding, rodents. Fever, myalgia (classically calf), **conjunctival suffusion**, and in severe (Weil) disease jaundice with renal failure and bleeding.
> **· Chikungunya and Zika** — with chikungunya causing prominent and prolonged arthralgia, and Zika carrying congenital risk.
> **· Amoebic liver abscess** — right upper quadrant pain and fever weeks to months after travel, often without diarrhoea.
> **· Schistosomiasis (Katayama fever)** — fever, urticaria and eosinophilia weeks after freshwater exposure.
> **· Acute HIV seroconversion** — fever, rash, pharyngitis, lymphadenopathy, mouth ulcers. **Test for it; the antibody test may be negative early so an antigen/antibody assay or viral load is needed.**
...
> **· Leptospirosis** — in farm and flood exposure.

**Ix:** **Thick and thin blood films, repeated, plus a rapid diagnostic test** (*why:* malaria is the diagnosis that kills fastest and a single negative film does not exclude it; *what:* parasites, species, parasitaemia percentage). FBC with film (*why:* **thrombocytopenia is near-universal in malaria and dengue and is a useful early clue; eosinophilia suggests helminth infection**; *what:* platelets, eosinophils, atypical lymphocytes). **Blood cultures** (*why:* typhoid, melioidosis, bacteraemia; *what:* organism). LFT, UEC, glucose, lactate, coagulation (*why:* severity assessment in malaria, dengue and leptospirosis, and **hypoglycaemia is a feature of severe malaria**; *what:* organ dysfunction). **Dengue NS1 antigen, IgM and PCR** (*why:* stage-dependent — NS1 and PCR early, serology later; *what:* positive result). Serology and PCR for **rickettsia, leptospirosis, Q fever, arboviruses** (*why:* often retrospective, so treatment is empirical; *what:* seroconversion). **HIV antigen/antibody test** (*why:* seroconversion illness, and a treatable diagnosis; *what:* positive). Stool microscopy, culture and parasite examination (*why:* enteric pathogens and parasites; *what:* organism, ova and cysts). CXR and targeted imaging (*why:* pneumonia, melioidosis, abscess; *what:* consolidation, collection). **Notification to public health where required** (*why:* legal obligation and outbreak control; *what:* the notifiable list — `UNVERIFIED — check the SA Health notifiable conditions list`).

### 0.4.1 Mx – Immediate
**Exclude malaria urgently.** Isolate where a high-consequence pathogen is possible. Treat severe malaria as an emergency with parenteral therapy. Empirical doxycycline where rickettsial infection is suspected. Supportive care with careful fluid management in dengue.

### 0.4.2 Mx – Definitive
Pathogen-specific therapy with infectious diseases involvement. **Radical cure with primaquine for *P. vivax* and *P. ovale* to eradicate liver hypnozoites — requiring G6PD testing first**, because primaquine causes haemolysis in G6PD deficiency.

### 0.4.3 Mx – Chronic/long-term
**Pre-travel advice for future trips** — vaccination, malaria prophylaxis, bite avoidance, food and water precautions. Notification and contact tracing where required.

---

## 0.5 Fever in the Immunocompromised, and Febrile Neutropenia
...
> A neutropenic patient with pneumonia may have a normal chest radiograph. One with a perianal abscess may have only pain. **The absence of findings is not reassurance; it is expected.**
> **Examine carefully but gently — mouth, skin, perianal region, all line sites, and the chest.** **Avoid digital rectal examination and rectal thermometers in neutropenic patients**, because of the risk of translocation and bacteraemia.

> [!tip] Risk stratification and escalation
> The **MASCC score** identifies a low-risk group who may be suitable for oral therapy and early discharge — but this is a decision made with haematology or oncology, not independently. `UNVERIFIED — the score and its threshold.`
> **Escalation to add cover for resistant Gram-positive organisms** (line infection, skin or soft tissue infection, haemodynamic instability, known colonisation) and **empirical antifungal therapy for persistent fever despite broad-spectrum antibacterials** are standard steps. **Persistent fever after several days on appropriate antibacterials should raise invasive fungal infection**, particularly with prolonged neutropenia.

> [!warning] Other forms of immunocompromise, and what each predisposes to
> **· Corticosteroids and other immunosuppressants** — bacterial infection, **Pneumocystis jirovecii pneumonia** (with prophylaxis indicated above certain steroid doses and durations), reactivation of latent TB and herpesviruses, and **fungal infection.**
...
> As immune function recovers — after starting antiretroviral therapy, after neutrophil recovery, or after withdrawing immunosuppression — **a previously subclinical infection can become inflamed and appear to worsen dramatically.**
> **This can be mistaken for treatment failure**, and the management is different: continue treating the infection, and manage the inflammation, sometimes with steroids.

**Ix:** **Blood cultures from a peripheral vein AND from each lumen of any central line** (*why:* paired cultures with differential time to positivity identify a line as the source, which determines whether the line must be removed; *what:* organism, time to positivity). **FBC with differential urgently** (*why:* establishes neutropenia and its depth; *what:* absolute neutrophil count). UEC, LFT, CRP, lactate (*why:* organ dysfunction and severity; *what:* derangement). **CXR — recognising that it may be normal in neutropenia** (*why:* consolidation requires neutrophils to form; *what:* infiltrate if present). **CT chest with high-resolution sequences where fever persists** (*why:* far more sensitive than radiography for invasive fungal disease and early pneumonia in neutropenia; *what:* nodules, halo sign, infiltrates). Urine, stool, sputum and site-directed cultures (*why:* source identification; *what:* organism). **Fungal markers — galactomannan, beta-D-glucan — where invasive fungal infection is suspected** (*why:* supports diagnosis before culture; *what:* positive marker). Viral PCR — CMV, respiratory viruses, EBV (*why:* reactivation and community viruses in the immunosuppressed; *what:* viral load). **HIV testing** (*why:* changes the entire differential; *what:* positive). CD4 count and viral load in known HIV (*why:* stratifies the opportunistic infection differential; *what:* CD4 level). Careful examination of mouth, skin, perineum and line sites (*why:* the source is often visible and there is little else to find; *what:* mucositis, cellulitis, exit site infection).

### 0.5.1 Mx – Immediate
**Cultures then immediate empirical broad-spectrum antibiotics.** Resuscitate. Involve haematology, oncology or infectious diseases. **In asplenia, the same urgency applies to any fever.**
...
> **· Resolving haematoma and tissue necrosis.**
> **· Alcohol or benzodiazepine withdrawal.**
> **· Thyroid storm and adrenal crisis.**
> **· Gout and pseudogout**, which can produce a strikingly high fever with a raised white cell count and be mistaken for sepsis.
> **· Pancreatitis, myocardial infarction, and post-seizure.**

**Ix:** Systematic re-examination including **wound, drains, lines, calves and perineum** (*why:* most post-operative sources are visible or palpable and are found by looking; *what:* wound infection, line site, collection, DVT). Blood cultures, urine culture, wound swab where clinically infected, sputum culture (*why:* organism identification; *what:* growth). **CT of the operative region where a collection or leak is suspected** (*why:* the definitive investigation, and clinical signs are unreliable in the post-operative abdomen; *what:* collection, free gas, extraluminal contrast). CXR (*why:* pneumonia, aspiration, effusion; *what:* consolidation). ***C. difficile* testing where diarrhoea and recent antibiotics** (*why:* common and requires isolation; *what:* toxin, PCR). Doppler ultrasound or CTPA where thromboembolism is suspected (*why:* fever from VTE is easily attributed to infection; *what:* thrombus). **FBC with differential** (*why:* eosinophilia suggests drug fever or DRESS; *what:* eosinophils). **Full medication chart review with a timeline** (*why:* drug fever is diagnosed only by considering it and stopping the drug; *what:* temporal relationship).

### 0.6.1 Mx – Immediate
Assess for sepsis. Cultures. Examine the wound and every device. Treat identified infection.

### 0.6.2 Mx – Definitive
Source control — drainage, line removal, return to theatre for a leak. Cessation of the suspected drug.

### 0.6.3 Mx – Chronic/long-term
**Document a drug fever clearly as an adverse reaction** so the agent is not re-prescribed. Antimicrobial stewardship review.
...
> [!warning] Sourcing
> Written from model knowledge, not retrieved from guidelines. Clinical reasoning, mechanism and discriminators are reliable at intern level. **Every dose, duration, score and threshold carries an `UNVERIFIED` marker naming what to check, or has been omitted with the omission stated in place.**
> **All antimicrobial regimens are omitted** — obtain them from **eTG Antibiotic**, since choice depends on local resistance patterns, and **community-acquired MRSA prevalence differs substantially between regions of Australia.** Scabies, Buruli ulcer and Australian bat lyssavirus management should be confirmed against **SA Health / state health department guidance** and, for bat exposure, the Australian Immunisation Handbook.

---

## 0.1 Cellulitis and Erysipelas

**D:** **Cellulitis** is acute bacterial infection of the deep dermis and subcutaneous tissue. **Erysipelas** involves the superficial dermis and lymphatics, and is **more sharply demarcated with a raised, palpable border**, more often affecting the face.

**A/P:** A breach in the skin barrier permits bacterial entry → spreading infection through subcutaneous tissue → local inflammation with erythema, warmth, swelling and pain, plus lymphatic involvement and systemic features. **Organisms are usually *Streptococcus pyogenes* in non-purulent cellulitis, and *Staphylococcus aureus* where there is purulence, an abscess or a penetrating injury** — which is the basis for the antibiotic choice.

> [!tip] Find and treat the portal of entry — it is what prevents recurrence
> **Tinea pedis with maceration between the toes is a very common and very treatable portal of entry for lower limb cellulitis.**
> **Look between the toes in every patient with leg cellulitis, and treat the tinea.** Patients get recurrent cellulitis for years because nobody looked at their feet.
> Other portals: **venous or arterial ulcers, eczema, insect bites, cracked heels, lymphoedema-related skin changes, injecting sites, and toenail disease.**

> [!warning] Mark the border and write the time on the skin
> A dated, timed pen line around the erythema converts a subjective impression into an objective measurement of progression or response. **It costs seconds and it settles the question of whether the patient is improving overnight**, which is otherwise contested between shifts.
...
> **· Contact or irritant dermatitis** — itchy rather than painful, with a sharp geometric border matching the contactant.
> **· Superficial thrombophlebitis** — a tender cord along a vein.
> **· Lymphoedema** with inflammatory change.
> **· Erythema nodosum and panniculitis.**
> **· Drug reactions.**
> **· Calciphylaxis** — in dialysis patients, with exquisitely painful necrotic plaques.
> **· Necrotising fasciitis** — the mimic that matters most.
> **If it is not improving on appropriate antibiotics, the commonest reason is that it was never cellulitis.**

> [!warning] Cellulitis is a clinical diagnosis — most investigations add little
> **Blood cultures have low yield in uncomplicated cellulitis** and are not routinely indicated. Take them if the patient is systemically unwell, immunocompromised, has lymphoedema, or if an unusual exposure is suspected.
> **Skin swabs of intact skin are useless.** Swab only if there is a wound, ulcer or discharge.
> **Imaging is for suspected abscess, retained foreign body, osteomyelitis or necrotising infection**, not for routine cellulitis.

**S/Smx:** Erythema, warmth, swelling, tenderness and a poorly demarcated border (sharply demarcated in erysipelas), with fever, rigors, malaise and regional lymphadenopathy. Lymphangitic streaking may be present.

**Ix:** FBC and CRP (*why:* baseline and to track response; *what:* leucocytosis, raised CRP). Blood cultures **where systemically unwell, immunocompromised or atypical** (*why:* yield is low in uncomplicated disease but matters when bacteraemia is plausible; *what:* organism). Wound swab where there is a breach or discharge (*why:* identifies the organism and detects MRSA; *what:* growth and sensitivities). **Glucose and HbA1c** (*why:* undiagnosed or poorly controlled diabetes predisposes to and complicates soft tissue infection; *what:* hyperglycaemia). Doppler ultrasound where DVT is a consideration (*why:* it mimics and coexists; *what:* thrombus). Ultrasound of the affected area (*why:* identifies a drainable collection, which changes management from antibiotics to drainage; *what:* abscess, foreign body). Plain radiography or MRI where osteomyelitis is suspected — particularly in the diabetic foot and over pressure areas (*why:* bone involvement changes duration and may require surgery; *what:* bone destruction, marrow oedema). **Examination of the feet and toe web spaces** (*why:* finds the portal of entry that prevents recurrence; *what:* tinea, fissures, ulcer).

### 0.1.1 Mx – Immediate
Antibiotics, **elevation of the affected limb** — genuinely effective and consistently under-emphasised — analgesia, and marking of the border. `UNVERIFIED — oral versus intravenous criteria, agents and duration from eTG Antibiotic.`
...
**Antibiotic prophylaxis is considered for recurrent cellulitis**, though it works only while it is being taken, so the underlying factors must be addressed too. `UNVERIFIED — prophylaxis regimens and the recurrence threshold.`

---

## 0.2 Necrotising Soft Tissue Infection

**D:** Rapidly progressive infection causing necrosis of fascia, subcutaneous tissue and sometimes muscle. **A surgical emergency with high mortality, in which delay to operation is the strongest modifiable determinant of death.**

> [!danger] The skin looks better than the patient — that discordance IS the diagnosis
> **Pain out of proportion to the visible findings** is the cardinal early feature, in a patient who is **systemically far more unwell than the appearance of the skin explains** — tachycardic, febrile, delirious, with a rising lactate over an area that looks like modest cellulitis.
> **The skin changes are LATE**, because the necrosis begins in the fascial plane and works outward. By the time you see **dusky or purple discolouration, haemorrhagic bullae, crepitus, or frank necrosis**, the disease is advanced.
> **Anaesthesia over the affected area** — from destruction of cutaneous nerves — is a useful and specific late sign: an area that should be exquisitely painful but is numb.
> **Rapid progression over hours, extending beyond a marked border**, is the other key feature.

> [!tip] The types, and who gets them
> **· Type I — polymicrobial**, mixed aerobes and anaerobes. **Diabetics, the elderly, post-operative patients, and the perineum.** **Fournier gangrene** is the perineal form, and it progresses with terrifying speed.
> **· Type II — monomicrobial, usually group A *Streptococcus*** with or without *S. aureus*. **Often in previously healthy younger people, after minor trauma, a bruise, an injection, or varicella in children.** Frequently accompanied by **streptococcal toxic shock syndrome.**
> **· Type III — *Vibrio vulnificus*** after seawater exposure or raw shellfish, particularly in those with **chronic liver disease, haemochromatosis or immunocompromise** — a genuine consideration in coastal Australia. **Clostridial myonecrosis (gas gangrene)** after contaminated traumatic wounds or injecting drug use.

> [!danger] Imaging must not delay surgery, and a scoring system must not exclude the diagnosis
> **The definitive diagnostic test is surgical exploration** — the finding of grey, dishwater-coloured, non-bleeding fascia that separates easily on blunt dissection.
> **CT may show fascial thickening, fluid tracking or gas, and supports the diagnosis — but a normal CT does NOT exclude it**, and sending an unstable patient to the scanner rather than to theatre costs lives.
> **The LRINEC score** combines laboratory parameters to stratify risk. **It has poor sensitivity and must never be used to rule out necrotising infection.** A low score in a patient with pain out of proportion and systemic toxicity means the score is wrong, not the clinician. `UNVERIFIED — the score components and thresholds.`
> **If you are seriously considering the diagnosis, call the surgeon now.**

**S/Smx:** Severe pain disproportionate to findings, rapid progression, systemic toxicity, fever, tachycardia, hypotension, altered mental state, and — late — skin discolouration, bullae, crepitus, anaesthesia and necrosis.

**Ix:** **Urgent surgical review — the investigation is the operation** (*why:* direct inspection of the fascia is diagnostic and the debridement is the treatment; *what:* necrotic fascia). VBG with **lactate** (*why:* systemic toxicity and hypoperfusion out of proportion to a modest-looking skin lesion is a key clue; *what:* raised lactate, acidosis). FBC, UEC, CRP, CK, coagulation, glucose (*why:* the LRINEC parameters and evidence of muscle involvement and organ dysfunction; *what:* leucocytosis, hyponatraemia, renal impairment, raised CK, coagulopathy). **Blood cultures and intra-operative tissue for culture and Gram stain** (*why:* directs antimicrobial therapy, and tissue is far more informative than a surface swab; *what:* organism). CT **only if it does not delay theatre** (*why:* may show gas and fascial fluid and helps define extent; *what:* fascial gas, fluid — with a normal scan not excluding). Plain radiograph (*why:* may show soft tissue gas, though its absence means nothing; *what:* subcutaneous gas).

### 0.2.1 Mx – Immediate
**Resuscitate, take cultures, give broad-spectrum antibiotics including an agent that suppresses toxin production, and get the patient to theatre.** ICU involvement. `UNVERIFIED — all regimens, and the role of intravenous immunoglobulin in streptococcal toxic shock, which remains debated.`

### 0.2.2 Mx – Definitive
**Radical surgical debridement, repeated as required** — a single operation is rarely sufficient, and planned relook procedures are the norm. Amputation where limb-threatening. Reconstruction later.

### 0.2.3 Mx – Chronic/long-term
Prolonged rehabilitation, wound and reconstructive management, and psychological support — these patients survive a catastrophic illness with major disfigurement. **Contact tracing and chemoprophylaxis are considered for close contacts in invasive group A streptococcal disease.** `UNVERIFIED — the indications and regimen.`

---

## 0.3 Abscess, Boils and Deep Space Infection

> [!danger] Incision and drainage is the treatment — antibiotics alone will not cure an abscess
> **An abscess is a closed collection of pus with no blood supply to the interior. Antibiotics cannot reach the centre.**
> **Antibiotics are an adjunct**, indicated where there are systemic features, significant surrounding cellulitis, immunocompromise, a high-risk site (face, hand, perineum), or a large or multiple abscesses. **They are not a substitute for drainage, and "let's try antibiotics first" is a recurring error that delays the definitive treatment.**

> [!tip] Recurrent boils — think beyond the individual lesion
> **Recurrent furunculosis suggests *S. aureus* colonisation** — nasal, axillary, perineal — and **decolonisation of the patient and sometimes household contacts** is what breaks the cycle.
> Consider **community-acquired MRSA**, including **Panton-Valentine leukocidin-producing strains**, which cause recurrent aggressive skin abscesses in otherwise healthy people and cluster in households and close-contact settings.
> **Community-acquired MRSA prevalence varies substantially across Australia and is notably higher in remote communities and in northern Australia**, which affects empirical choice. `UNVERIFIED — local prevalence and empirical recommendations from eTG and local antibiograms.`
> **Screen for diabetes.**
...
### 0.3.1 Mx – Immediate
**Drain it.** Analgesia and local or general anaesthesia as appropriate. Antibiotics as an adjunct where indicated. **Urgent hand surgery referral for flexor tenosynovitis.**

### 0.3.2 Mx – Definitive
Adequate drainage with packing or a drain where appropriate, and follow-up to ensure healing.

### 0.3.3 Mx – Chronic/long-term
Decolonisation for recurrent staphylococcal disease, diabetes screening and management, and **recognition and appropriate management of hidradenitis suppurativa rather than repeated courses of antibiotics.**

---

## 0.4 Lymphangitis, Lymphadenitis and the Lymphoedema Cycle

> [!tip] Lymphangitis
> **Tender erythematous streaks extending proximally from a site of infection toward the regional lymph nodes**, usually streptococcal, with regional lymphadenopathy and systemic features. Treated as cellulitis with the same organism assumptions.

> [!warning] Nodular lymphangitis — a distinct pattern with a specific differential
> **A chain of subcutaneous nodules ascending along lymphatic channels**, rather than a diffuse red streak, has a short and specific differential:
> **· Sporotrichosis** — classically after a **rose thorn or plant material injury in a gardener** ("rose gardener's disease").
> **· Atypical mycobacteria — *Mycobacterium marinum*** after **fish tank or aquarium exposure** ("fish tank granuloma").
> **· *Nocardia*** after soil exposure.
> **· Leishmaniasis** and **tularaemia** in relevant geography.
> **These do not respond to standard cellulitis antibiotics**, which is why recognising the pattern matters — the "cellulitis" that will not settle in a gardener or an aquarium owner is the classic presentation.
...
### 0.4.2 Mx – Definitive
Organism-specific, often prolonged for mycobacterial and fungal causes.

### 0.4.3 Mx – Chronic/long-term
**Lymphoedema management and referral**, skin care, and prophylaxis where recurrent.

---

## 0.5 Bites, Wounds and Australian Exposures
...
> **ABLV is closely related to rabies, is almost universally fatal once symptomatic, and there is no effective treatment — but post-exposure prophylaxis is highly effective.**
> **Wash the wound thoroughly and immediately with soap and water for a prolonged period, apply a virucidal agent, and arrange urgent post-exposure prophylaxis with rabies immunoglobulin and vaccine.** Contact the public health unit.
> **Advise that members of the public should never handle bats** — injured bats should be reported to wildlife services, and only vaccinated handlers should touch them. `UNVERIFIED — the washing duration, the PEP schedule and immunoglobulin indications, from the Australian Immunisation Handbook and state health guidance.`
> This is genuinely Australian, genuinely examinable, and genuinely lethal if mismanaged.

> [!warning] *Mycobacterium ulcerans* — Buruli / Bairnsdale ulcer
> **An increasing problem in coastal Victoria, with expanding geographic distribution.**
> Presents as a **painless nodule or papule** that progresses over weeks to months to an **ulcer with characteristically undermined edges and a necrotic base**, typically on exposed limbs. **The painlessness is the striking feature** and is why it is often present for a long time before presentation.
> **It is repeatedly misdiagnosed as an insect bite, a spider bite, or ordinary cellulitis, and treated with courses of standard antibiotics that do nothing.**
> **Diagnosis is by PCR on a swab or biopsy of the ulcer edge**, and treatment is **prolonged specific antimycobacterial therapy**, sometimes with surgery. **Ask about travel to or residence in endemic coastal areas.** `UNVERIFIED — the current endemic areas, diagnostic method and treatment regimen from Victorian and national guidance.`
...
### 0.5.2 Mx – Definitive
Organism-specific therapy, surgical exploration where deep structures are involved, and prolonged therapy for mycobacterial disease.

### 0.5.3 Mx – Chronic/long-term
Occupational review and vaccination where relevant — **Q fever vaccination for at-risk occupations**, and rabies pre-exposure vaccination for bat handlers. Wound and scar management.
...
> [!tip] Scabies
> ***Sarcoptes scabiei* var. *hominis*** burrows in the stratum corneum. **The intense itch is a delayed hypersensitivity response to the mite and its products, which is why it takes weeks to develop on a first infestation but hours on re-infestation.**
> **Characteristic features: intense itch, markedly worse at night · burrows in the finger web spaces, wrists, axillae, periumbilical skin, genitals and, in infants, the palms, soles and scalp · and OTHER HOUSEHOLD MEMBERS ITCHING.** That last point is often the most useful part of the history.
> **Treatment principles that determine whether it works:**
> **· Treat ALL household and close contacts SIMULTANEOUSLY, whether or not they are symptomatic** — otherwise reinfestation is guaranteed. This is the commonest reason treatment fails.
> **· Apply topical treatment to the WHOLE body from the neck down** (and including the head in infants and the elderly), including under the nails, and leave for the specified duration.
> **· Repeat the treatment after an interval** to catch newly hatched mites.
> **· Wash bedding, clothing and towels in hot water, or seal them for a period.**
> **· Warn that the ITCH PERSISTS FOR WEEKS after successful treatment** — this is post-scabetic eczema, not treatment failure, and patients otherwise return convinced the treatment did not work and are re-treated unnecessarily.
> `UNVERIFIED — agents, application instructions, repeat intervals and age restrictions.`

> [!danger] Crusted (Norwegian) scabies — and its Australian public health significance
> **A hyperinfestation with an enormous mite burden — thousands to millions — occurring in the immunocompromised, the elderly, those with cognitive or physical impairment, and those unable to scratch or respond to the itch.**
...
**Ix:** **Skin scraping or dermoscopy for scabies** (*why:* visualising mites, eggs or faecal pellets confirms the diagnosis, and dermoscopy of a burrow shows the characteristic "delta wing" appearance — but **treatment is frequently and reasonably empirical on the clinical picture plus itchy contacts**; *what:* mites, ova). **Examination of household contacts** (*why:* finding itch in other household members is diagnostically powerful and determines who needs treatment; *what:* symptomatic contacts). Bacterial swab where impetiginised (*why:* secondary infection is common and may require systemic treatment; *what:* organism). **STI screen for pubic lice** (*why:* it is a sexual contact marker; *what:* concurrent infection). Screening for immunosuppression in crusted scabies (*why:* it occurs in the immunocompromised, including HTLV-1 which has particular relevance in central Australia; *what:* HIV, HTLV-1, other causes).

### 0.6.1 Mx – Immediate
Treat, and **treat contacts simultaneously.** Isolate and involve infection control for crusted scabies.

### 0.6.2 Mx – Definitive
Complete the treatment course with the repeat application, and manage environmental decontamination.

### 0.6.3 Mx – Chronic/long-term
**Explain the persistent post-treatment itch** to prevent unnecessary re-treatment. Address overcrowding, access to washing facilities and community-level control where relevant — **these are the determinants that drive recurrence, and in the Australian remote community context they are the actual problem.**
...
> [!note] Gap-filled — "Notifiable disease" appears as a bare flag on at least 7 separate conditions scattered throughout this project (measles, mumps, pertussis, diphtheria, and others), and **a second account of the system is in this file at `08_01-03 ## Notifiable Diseases (Australia)` (L1719), where the pair is already flagged as retained and not merged.** (This note previously said the system was explained nowhere; that was written against the pre-merge corpus.) ("Notifiable diseases & public health reporting" is explicitly a High-yield CSV item, filed under a not-yet-uploaded Public Health category — but the concept is already load-bearing content throughout this project's existing disease entries, exactly analogous to how MMSE/MoCA needed explaining despite being filed under a separate Geriatrics category, addressed elsewhere in this project.) Verified against SA Health's notifiable disease reporting requirements and the Australian CDC's National Notifiable Diseases Surveillance System (NNDSS) overview, Aug 2026.
...
> [!warning] Sourcing
> Written from model knowledge, not retrieved from guidelines. Principles, mechanism and clinical reasoning are reliable at intern level. **Every transmission risk figure, time window, dose, regimen and CD4 threshold carries an `UNVERIFIED` marker naming what to check, or has been omitted with the omission stated in place.**
> **All PEP, PrEP, tuberculosis and antiretroviral regimens are omitted.** Obtain them from **eTG Antibiotic**, the **Australian STI Management Guidelines (ASHM)**, the **Australian Immunisation Handbook**, and your state's public health unit — **PEP protocols differ between health services and must be taken from the local pathway, which is usually a form or a phone line rather than a memory exercise.**

---

## 0.1 Occupational and Bloodborne Virus Exposure

**D:** Potential exposure to blood or body fluids capable of transmitting **hepatitis B, hepatitis C or HIV** — most commonly a percutaneous needlestick or sharps injury, or a mucous membrane or non-intact skin splash.

> [!danger] Immediate first aid — and what NOT to do
> **· Percutaneous: wash the wound with soap and running water.**
> **· DO NOT squeeze, scrub, or suck the wound**, and **do not apply bleach, alcohol or antiseptic into the wound** — these damage tissue and there is no evidence they reduce transmission.
> **· Mucous membrane or eye: irrigate copiously with water or saline**, with contact lenses removed and then also irrigated.
> **· Then report immediately** — to the supervisor and to occupational health or the emergency department, because **the PEP window is measured in hours.**

> [!tip] Risk assessment — three variables
> **1. The exposure type.** **Percutaneous > mucous membrane > non-intact skin. Intact skin is NOT an exposure.**
> Higher risk percutaneous features: **a hollow-bore needle, visible blood on the device, a deep injury, and a needle that had been in the source's artery or vein.**
> **2. The source.** Known status, viral load, and treatment. **Testing the source requires their consent** — it cannot be done covertly.
> **3. The recipient.** **Hepatitis B vaccination status and documented immunity** is the single most important recipient variable, because hepatitis B is both the most transmissible and the most preventable of the three.

> [!warning] The transmission risk hierarchy
> **Hepatitis B ≫ hepatitis C > HIV.**
> This surprises people, who worry most about HIV. **Hepatitis B is by far the most transmissible via percutaneous exposure — and it is the one for which the recipient can already be fully protected by vaccination.**
> `UNVERIFIED — the per-exposure transmission risk figures for each virus.`

> [!tip] What each virus requires
> **· Hepatitis B** — management depends on **the recipient's vaccination and anti-HBs status** and the source's status. Options are **hepatitis B immunoglobulin, vaccination, or both, or neither if the recipient is documented immune.** Highly effective when given promptly.
> **· Hepatitis C** — **there is NO post-exposure prophylaxis.** Management is **surveillance with HCV RNA PCR and serology**, with the important point that **hepatitis C is now curable with direct-acting antivirals**, so early detection leads to treatment and cure rather than chronic infection. This is a major change from historical practice.
> **· HIV** — **post-exposure prophylaxis, started as soon as possible and ideally within hours.** There is a defined outer window beyond which it is not recommended, and **the shorter the delay the better it works.** A course of combination antiretroviral therapy is taken for a defined period, with baseline and follow-up testing.
> `UNVERIFIED — the HBIG and vaccine indications by anti-HBs level, the HIV PEP window, regimen and duration, and the follow-up serology schedule.`

> [!warning] The counselling and follow-up that goes with it
> **Until seroconversion is excluded**: safe sex, **no blood, tissue or organ donation**, no sharing of razors or toothbrushes, and — for a breastfeeding woman — a discussion about feeding.
> **Follow-up serology at defined intervals**, and PEP adherence support, since the side effects cause many people to stop early.
> **These events are genuinely distressing** for healthcare workers and students, and the anxiety is frequently disproportionate to the actual risk. **Give the numbers, because they are reassuring**, and offer support.
> **Report through the incident system** — this is both an individual and a workplace safety matter, and pattern data drives prevention.

**Ix:** **Source testing with consent — HIV, hepatitis B surface antigen, hepatitis C antibody and PCR** (*why:* a negative source result usually ends the process and avoids unnecessary PEP; *what:* status and, where positive, viral load). **Recipient baseline serology — HIV, hepatitis B surface antibody and antigen, hepatitis C** (*why:* establishes pre-exposure status, which is essential medicolegally and for interpreting later results; *what:* baseline status). **Recipient hepatitis B vaccination history and anti-HBs level** (*why:* determines whether immunoglobulin is needed at all; *what:* documented immunity). Follow-up serology at the specified intervals (*why:* detects seroconversion; *what:* conversion). Pregnancy test where PEP is being considered (*why:* affects regimen choice; *what:* positive). UEC and LFT (*why:* baseline before antiretroviral PEP; *what:* renal and hepatic function).

### 0.1.1 Mx – Immediate
First aid, report, risk assess, **and start HIV PEP without waiting for source results if the risk assessment warrants it — it can be stopped if the source tests negative.** Hepatitis B immunoglobulin and vaccine as indicated.

### 0.1.2 Mx – Definitive
Complete PEP, follow-up serology, and treat any seroconversion — **with the important point that acute hepatitis C is curable.**

### 0.1.3 Mx – Chronic/long-term
**Ensure the healthcare worker is hepatitis B vaccinated and their immunity documented** — this is the single most effective preventive measure and there is no excuse for a clinician not knowing their own anti-HBs status. Safe sharps practice, **never recap needles**, and appropriate PPE.

---

## 0.2 Non-Occupational Exposure, PEP and PrEP

> [!tip] Non-occupational post-exposure prophylaxis (NPEP)
> The same principles and the same time window apply to **sexual exposure, sharing of injecting equipment, and community needlestick injuries.**
> **Risk is stratified by the type of exposure and the likelihood the source is HIV positive with a detectable viral load** — receptive anal intercourse carries the highest per-act risk, and a source on effective treatment with an undetectable viral load carries essentially none.
> **Community needlestick injuries from discarded needles carry very low HIV risk** — the virus does not survive well outside the body — but hepatitis B remains a consideration and the anxiety is often high.
> `UNVERIFIED — NPEP eligibility criteria, risk categories and regimens from ASHM guidelines.`
...
> **· Immediate safety and psychological support**, with the person's control over the process respected at every step.
> **· Forensic examination — but ONLY with informed consent, ideally by a specialist service**, and it must not be a prerequisite for medical care. There is a time window for evidence collection, but **a person who declines forensic examination still receives all medical care.**
> **· Emergency contraception and pregnancy testing.**
> **· STI testing and presumptive treatment**, with a plan for repeat testing outside the window period.
...
### 0.2.1 Mx – Immediate
Risk assess, offer PEP within the window, provide emergency contraception and STI prophylaxis where indicated, and address safety and support first.

### 0.2.2 Mx – Definitive
Complete prophylaxis, arrange follow-up testing, and refer to sexual health or a specialist service.

### 0.2.3 Mx – Chronic/long-term
**Discuss PrEP for those at ongoing risk** — an exposure event is a natural point to raise it. Psychological support and partner notification where relevant.

---

## 0.3 Tuberculosis — Latent Infection, Contacts and Active Disease

> [!tip] Latent versus active — the distinction that governs everything
> **Latent TB infection: the person is infected, has NO symptoms, is NOT infectious, and has a normal chest radiograph.** They have viable organisms contained by the immune system.
> **Active TB disease: symptomatic, and — if pulmonary — potentially infectious.**
> **Lifetime reactivation risk from latent infection is modest in an immunocompetent person, but rises dramatically with immunosuppression** — HIV above all, and also **TNF inhibitors, transplantation, dialysis, silicosis, diabetes, malnutrition, and recent infection.** Young children are also at higher risk of progression and of severe forms.

> [!danger] Screen for latent TB before starting immunosuppression
> **This is the most common way an intern encounters TB, and it is mandatory before TNF inhibitors in particular**, because reactivation on a TNF inhibitor can be rapid, disseminated and fatal.
> **Screening is by tuberculin skin test (Mantoux) or an interferon-gamma release assay (IGRA), plus a chest radiograph and a risk history.**
> **IGRA is not confounded by prior BCG vaccination**, which matters enormously in Australia's overseas-born population where BCG is common — a positive Mantoux in a BCG-vaccinated person is uninterpretable, and this is precisely why IGRA is preferred in that group.
> `UNVERIFIED — which test in which population, cut-offs, and the latent TB treatment regimens.`

> [!warning] Active TB — the presentation, and why it is missed
> **Pulmonary: cough persisting beyond two to three weeks, haemoptysis, fever, drenching night sweats, weight loss and anorexia.** The cough is often attributed to smoking, asthma or recurrent bronchitis for months.
> **Extrapulmonary — and this is where it is genuinely missed**: **lymph node (cervical, "scrofula" — matted, non-tender, may form a sinus) · pleural effusion · miliary (disseminated, with a diffuse micronodular chest radiograph and a very unwell patient) · CNS (tuberculous meningitis — subacute, with cranial nerve palsies and very high CSF protein with low glucose) · spinal (Pott disease, with vertebral destruction and possible cord compression) · genitourinary (sterile pyuria) · abdominal · pericardial.**
> **Extrapulmonary disease is proportionally more common in HIV and in children**, and the chest radiograph may be atypical or normal in advanced HIV.

> [!danger] Isolate first, then investigate
> **Suspected pulmonary TB requires airborne precautions immediately — a negative-pressure room where available, and a fitted P2/N95 respirator for staff — not a surgical mask.**
> **TB is notifiable**, and **contact tracing is conducted by the public health unit**, not by the treating team, but the notification must be made.
> Placing a suspected case in an open ward while awaiting results exposes staff and patients and is a recurring failure.

> [!tip] Diagnosis
> **· Sputum — three specimens, including an early morning sample — for acid-fast bacilli smear and mycobacterial culture.** **Culture is the gold standard but takes weeks.**
> **· Nucleic acid amplification (Xpert MTB/RIF and successors)** — a rapid PCR that detects *M. tuberculosis* **and simultaneously detects rifampicin resistance within hours**, which has transformed early management and is now the key diagnostic advance to know about.
> **· Chest radiograph** — classically **upper lobe infiltrates with cavitation** in reactivation disease, but **atypical, lower-zone or normal in HIV and immunosuppression.**
> **· Tissue** for histology (caseating granulomas) and culture in extrapulmonary disease.

> [!danger] The four first-line drugs and their toxicities — high-yield
> **· Isoniazid — hepatitis, and PERIPHERAL NEUROPATHY, which is why PYRIDOXINE (vitamin B6) is co-prescribed.**
> **· Rifampicin — hepatitis, ORANGE discolouration of urine, tears and sweat (warn the patient, and warn contact lens wearers), and it is a POTENT ENZYME INDUCER.** **The enzyme induction causes ORAL CONTRACEPTIVE FAILURE, and interacts with warfarin, antiretrovirals, corticosteroids, anticonvulsants and many others.** **The contraceptive interaction is a classic exam point and a real cause of unplanned pregnancy.**
> **· Pyrazinamide — hepatitis and hyperuricaemia (may precipitate gout).**
> **· Ethambutol — OPTIC NEURITIS with loss of visual acuity and RED-GREEN COLOUR DISCRIMINATION.** **Baseline and monitoring of visual acuity and colour vision is required, and the patient must be told to report any visual change immediately.**
> **Three of the four are hepatotoxic** — baseline and monitored LFTs, and a clear plan for what to do if they rise.
> `UNVERIFIED — regimens, phases, durations, doses and monitoring schedules from eTG.`

> [!warning] The Australian epidemiology
> **Australia has low TB incidence, and the majority of cases occur in people born overseas**, reflecting reactivation of latent infection acquired elsewhere.
...
### 0.3.2 Mx – Definitive
Multidrug therapy with pyridoxine, adherence support, and specialist infectious diseases or respiratory management. Contact tracing by public health.

### 0.3.3 Mx – Chronic/long-term
Completion of therapy is the priority — **partial treatment generates resistance.** Monitoring for toxicity, and **treatment of latent infection in identified contacts.**

---

## 0.4 HIV and Opportunistic Infection

> [!danger] Offer HIV testing far more widely than feels necessary
> **HIV is a treatable chronic condition with a normal life expectancy on treatment — and it remains diagnosed late in a substantial proportion of Australian cases**, at which point opportunistic infection has already occurred.
> **Late diagnosis happens because testing is reserved for people who "look at risk".** Test on clinical indication — unexplained fever, weight loss, lymphadenopathy, recurrent infection, unusual infection, thrombocytopenia, seborrhoeic dermatitis, shingles in a younger person, tuberculosis, any sexually transmitted infection, and any FUO.
> **Consent is required but the process should be normalised**, not treated as an exceptional event.

> [!tip] Acute seroconversion illness — commonly missed, and highly infectious
> **Fever, rash, pharyngitis, generalised lymphadenopathy, mouth or genital ulcers, myalgia, headache, and sometimes aseptic meningitis**, typically two to four weeks after exposure. It resembles glandular fever or a viral illness and is dismissed as such.
> **Viral load is extremely high during seroconversion, so transmission risk is at its peak** — recognising it matters for the patient and for public health.
> **The antibody test may be negative during this window.** **A fourth-generation antigen/antibody assay detects it earlier, and HIV RNA (viral load) detects it earliest** — so if acute HIV is suspected, request the right test rather than accepting a negative antibody result. `UNVERIFIED — window periods for each assay.`

> [!info] Opportunistic infections stratify by CD4 count
> **The CD4 count predicts which infections are possible, which is the practical value of knowing it.**
> **· Higher CD4** — tuberculosis, bacterial pneumonia, herpes zoster, oral candidiasis, seborrhoeic dermatitis — all can occur at any count.
> **· Below roughly 200** — ***Pneumocystis jirovecii* pneumonia**, oesophageal candidiasis.
> **· Below roughly 100** — **cerebral toxoplasmosis, cryptococcal meningitis.**
> **· Below roughly 50** — **CMV retinitis, disseminated *Mycobacterium avium* complex.**
> `UNVERIFIED — the CD4 thresholds and the prophylaxis regimens and their start and stop points.`

> [!tip] The four to recognise
> **· *Pneumocystis* pneumonia (PJP)** — **subacute dry cough and progressive exertional dyspnoea over weeks, with EXERTIONAL DESATURATION and a chest radiograph that is often normal or shows only bilateral perihilar interstitial change despite marked hypoxia.** Raised LDH. **The discordance between how hypoxic they are and how unremarkable the film looks is the clue.** **Corticosteroids are added to treatment when hypoxia is significant, and they improve survival** — this is a specific and examinable point.
> **· Cerebral toxoplasmosis** — headache, focal deficit, seizures, with **multiple ring-enhancing lesions** on imaging. The main differential is primary CNS lymphoma.
> **· Cryptococcal meningitis** — subacute headache and fever with **markedly raised CSF opening pressure**, and **repeated therapeutic lumbar punctures to control pressure are a key part of management** — pressure control affects survival as much as the antifungal does.
> **· CMV retinitis** — **floaters, visual field loss or blurring, with a characteristic "pizza pie" retinal appearance.** **It is sight-threatening and requires urgent ophthalmology**, and it is missed because visual symptoms are not asked about.

> [!warning] Two points that shape modern management
> **· Antiretroviral therapy is started immediately at diagnosis, regardless of CD4 count** — the older practice of deferring until a threshold was reached is obsolete.
> **· "Undetectable equals untransmittable" (U=U)** — a person on effective treatment with a sustained undetectable viral load **cannot sexually transmit HIV.** This is well established, it is transformative for patients' relationships and self-perception, and **it should be communicated explicitly**, because many people diagnosed today still carry the assumptions of the 1990s.
> **Immune reconstitution inflammatory syndrome (IRIS)** — as immunity recovers on treatment, a subclinical infection can become intensely inflamed and appear to worsen. **It is not treatment failure**, and the management differs.

**Ix:** **Fourth-generation HIV antigen/antibody assay, with HIV RNA where acute infection is suspected** (*why:* the antibody component may be negative in the window; *what:* positive result). **CD4 count and viral load** (*why:* stratifies opportunistic infection risk, determines prophylaxis, and provides the treatment baseline; *what:* CD4, viral load). Baseline screening — **hepatitis B and C, syphilis, latent TB, toxoplasma serology, STI screen, cervical screening, and vaccination status** (*why:* coinfection is common and several require treatment or prophylaxis before or alongside ART; *what:* coinfections). **Chest radiograph with arterial or venous gas and exercise oximetry where PJP is suspected** (*why:* exertional desaturation with an unimpressive film is the clue, and resting saturation may be normal; *what:* desaturation on exertion, interstitial change, raised LDH). Induced sputum or bronchoalveolar lavage for PJP (*why:* diagnostic confirmation; *what:* organism on PCR or stain). CT brain with contrast for focal neurology (*why:* toxoplasmosis versus lymphoma; *what:* ring-enhancing lesions). **Lumbar puncture with OPENING PRESSURE, India ink, cryptococcal antigen and culture** (*why:* opening pressure is both diagnostic and therapeutic in cryptococcal disease and is frequently not measured; *what:* raised pressure, cryptococcal antigen). **Dilated fundoscopy by ophthalmology at low CD4 counts** (*why:* CMV retinitis is sight-threatening and asymptomatic early; *what:* retinitis).

### 0.4.1 Mx – Immediate
Treat the opportunistic infection. **Steroids with PJP treatment where hypoxic.** Therapeutic lumbar punctures for raised pressure in cryptococcal meningitis. Urgent ophthalmology for visual symptoms.

### 0.4.2 Mx – Definitive
**Start antiretroviral therapy** with specialist involvement, with attention to the timing relative to treating an opportunistic infection because of IRIS risk. Prophylaxis by CD4 count.

### 0.4.3 Mx – Chronic/long-term
Adherence support, monitoring, vaccination, cardiovascular and metabolic risk management (**people with HIV now die of the same things as everyone else**), cancer screening, **partner notification and contact tracing**, and mental health support. **Notification is required.**

---

## 0.5 Immunodeficiency and Screening Before Immunosuppression

> [!tip] When to suspect a primary immunodeficiency
> The classic pattern is infections that are **too frequent, too severe, too persistent, too unusual in organism or site, or too poorly responsive to appropriate treatment** — plus **failure to thrive in children** and **a family history.**
> **Common variable immunodeficiency (CVID) is the commonest clinically significant primary immunodeficiency presenting in adults**, and it is **diagnosed after an average delay of many years.** It presents with **recurrent sinopulmonary infections leading to bronchiectasis**, and — counterintuitively — with **autoimmune disease (particularly immune cytopenias), granulomatous disease, gastrointestinal disease and an increased malignancy risk.**
> **An adult with recurrent pneumonia or sinusitis and bronchiectasis should have immunoglobulins checked** — it is a simple test and the diagnosis is transformative, because immunoglobulin replacement prevents the progressive lung damage.

> [!tip] The categories, and the infections each predisposes to
...
> **· Latent tuberculosis** — mandatory before TNF inhibitors. See 0.3.
> **· Hepatitis B — surface antigen AND core antibody.** ***Rituximab and other B-cell depleting agents cause hepatitis B reactivation, which can be fulminant and fatal, INCLUDING in people who are surface antigen negative but core antibody positive (resolved infection).*** **Checking only the surface antigen misses them.** Prophylactic antiviral therapy is given.
> **· Hepatitis C and HIV.**
> **· Varicella zoster immunity** — because primary varicella in an immunosuppressed adult is severe, and **live vaccines must be given BEFORE immunosuppression, not after.**
> **· *Strongyloides* serology in anyone from an endemic area** — **including northern Australia and many migrant populations. Corticosteroids can convert chronic asymptomatic strongyloidiasis into HYPERINFECTION SYNDROME with disseminated larvae and Gram-negative sepsis, which has very high mortality.** **This is a genuinely Australian consideration given migration patterns and endemic areas in the north, and it is missed.**
> **· Vaccination status brought up to date, with live vaccines given beforehand.**
> `UNVERIFIED — the full screening panel, the prophylaxis regimens, and the intervals required between live vaccination and starting immunosuppression.`
...
### 0.5.3 Mx – Chronic/long-term
**Vaccination, antibiotic prophylaxis where indicated, a medical alert and patient education about presenting early with fever**, and surveillance for the autoimmune and malignant complications of primary immunodeficiency.

---

## 0.6 Vector-Borne and Zoonotic Disease in Australia
...
> **· Q fever (*Coxiella burnetii*)** — **abattoir workers, farmers, veterinarians, shearers, and those exposed to livestock birth products or contaminated dust.** Fever, hepatitis, pneumonia; can cause chronic infection with **endocarditis**. **A vaccine exists and is recommended for at-risk occupations, with pre-vaccination screening required** — this is a preventive point worth knowing and a genuinely Australian occupational health issue.
> **· Leptospirosis** — freshwater exposure, flooding, rodents, farm and abattoir work.
...
> **None of these will be diagnosed unless asked about.** In an unexplained febrile or systemic illness, ask specifically about: **occupation, animals (domestic, livestock, wild, bats, birds), soil and water exposure, recreational activities, insect and tick bites, travel including within Australia, and unpasteurised food.**
> **"Have you been anywhere?" is not a travel history. "What do you do, where do you live, and what have you been in contact with?" is.**

**Ix:** **Serology and PCR for the specific organism suspected** (*why:* these organisms are not detected on routine culture and require targeted requests, and many are diagnosed serologically with paired acute and convalescent samples; *what:* seroconversion or PCR positivity). Blood cultures (*why:* bacteraemic zoonoses including melioidosis and brucellosis, with **brucella requiring prolonged incubation and a warning to the laboratory because it is a laboratory hazard**; *what:* organism). FBC with film (*why:* thrombocytopenia and atypical lymphocytes; *what:* the pattern). LFT (*why:* hepatitis in Q fever, leptospirosis and arboviral infection; *what:* transaminitis). **Full body examination for an eschar or an attached tick, including the scalp, behind the ears, axillae and groin** (*why:* both make the diagnosis and, in tick paralysis, removal is the treatment; *what:* eschar, attached tick). Echocardiography where chronic Q fever is suspected (*why:* Q fever endocarditis; *what:* vegetation). **Notification to public health** (*why:* many are notifiable and drive outbreak investigation; *what:* the notifiable list).

### 0.6.1 Mx – Immediate
**Empirical doxycycline where rickettsial infection or Q fever is suspected**, since serology is retrospective. **Find and remove the tick** in suspected tick paralysis. Isolate and consult where a high-consequence pathogen is possible.
...
| **Non-nucleoside reverse transcriptase inhibitors (NNRTI)** | Nevirapine, efavirenz | **Bind reverse transcriptase at a site away from where it does its work, deforming the enzyme so it functions poorly — not incorporated into the DNA chain, which is the whole difference from the **NRTI** row above in this table.** SE: P450 induction, rashes |
...
> **A reaction days later, as a non-urticarial rash, is T-cell mediated — usually benign, but the severe forms (SJS/TEN, DRESS) are also T-cell mediated and are absolute contraindications to re-exposure.**
> **This distinction is the entire basis of drug allergy assessment** — see 0.3.

> [!danger] Sensitisation is not allergy
> **A positive skin prick test or specific IgE demonstrates SENSITISATION — the presence of IgE. It does not demonstrate clinical allergy.**
> **Many people are sensitised to foods they eat without any problem at all.**
> **Allergy = sensitisation PLUS clinical reactivity on exposure.**
> This is the single most important concept in allergy testing, and misunderstanding it is the reason **untargeted allergy panels cause harm**: they generate positives that lead to unnecessary elimination diets, nutritional deficiency, social restriction, anxiety — and, in children, **avoidance of a food actually increases the risk of developing genuine allergy to it.** See 0.4.

**S/Smx:** Determined by the mechanism and the organ involved.

**Ix:** See 0.2.

---

## 0.2 Allergy Assessment and Testing

> [!danger] The history is the diagnostic test. The laboratory tests only support it.
> **Ask, in detail:**
> **· What exactly was the exposure**, and how much?
> **· How long after exposure did symptoms begin?** — the single most discriminating question, per 0.1.
> **· What exactly happened?** Urticaria, angioedema, wheeze, vomiting, hypotension, collapse — versus flushing, nausea, headache, or a rash appearing days later.
> **· How long did it last, and what treatment was needed?**
> **· Has it happened again on re-exposure — and has the person had the food or drug since without problem?** **Tolerating the substance since effectively excludes the allergy.**
> **· Co-factors** — **exercise, alcohol, NSAIDs, intercurrent infection, menstruation** — which lower the reaction threshold and explain why someone reacts on one occasion and not another.

> [!tip] The tests, and what each is for
> **· Skin prick testing** — detects specific IgE, results in about 15 minutes, high negative predictive value. **Antihistamines must be withheld beforehand** or the test is uninterpretable. Not reliable in extensive eczema or dermographism.
> **· Serum specific IgE** — no need to stop antihistamines, and usable when skin testing is not. Similar interpretation.
> **· Component-resolved diagnostics** — measures IgE to individual protein components rather than the whole extract. **This distinguishes genuine allergy from cross-reactive pollen sensitisation** — the classic example being peanut, where sensitisation to the storage protein predicts true systemic allergy while sensitisation to a pollen cross-reactive component predicts mild or no reaction. Useful for resolving equivocal results.
> **· Oral food challenge — the gold standard**, performed in a supervised setting with resuscitation available. **It is the only test that definitively establishes or excludes clinical allergy**, and it is under-used relative to how much unnecessary avoidance it could end.
> **· Patch testing** — for **type IV** contact allergy, read at 48 and 96 hours.
> **· Tryptase** — **an acute level taken within hours of a suspected anaphylactic event, with a baseline taken later**, supports mast cell degranulation retrospectively. **A persistently raised baseline suggests mastocytosis or hereditary alpha tryptasaemia** and warrants investigation.
> `UNVERIFIED — antihistamine withholding periods, tryptase timing and thresholds, and challenge protocols.`

> [!danger] Unvalidated tests cause real harm — and counselling about them is an OSCE-level skill
> **IgG or IgG4 "food intolerance" testing, hair analysis, applied kinesiology, VEGA/electrodermal testing, cytotoxic food testing, and pulse testing have no diagnostic validity.**
> **IgG to food indicates exposure and tolerance, not allergy** — everyone has it to foods they eat regularly.
> **The harm is concrete**: patients undertake extensive unnecessary elimination diets, causing nutritional deficiency, weight loss, disordered eating patterns, social isolation, cost, and — most seriously — **delay in diagnosing the actual problem**, which is often coeliac disease, inflammatory bowel disease or a functional gut disorder.
> **How to handle it well**: do not dismiss the symptoms, which are real. Explain what the test does and does not measure, offer a proper assessment, and give a plan. **Contempt for the test tends to be heard as contempt for the patient**, and they simply go elsewhere.

**Ix:** As above, **selected on the basis of the history rather than ordered as a panel** (*why:* untargeted testing generates clinically meaningless positives that cause avoidance and harm; *what:* targeted confirmation of a clinical suspicion).

---

## 0.3 Drug Allergy and De-labelling

> [!danger] Most people labelled "penicillin allergic" are not
> **The large majority of penicillin allergy labels are incorrect.** Most were applied in childhood, and most represent **a viral exanthem coinciding with an antibiotic course, gastrointestinal upset, or a family member's reaction.** Even among those with genuine IgE-mediated allergy, **sensitivity wanes over time and most lose it after a decade.**
> **The label is not harmless. It causes:**
> **· Use of broader-spectrum, less effective, more toxic alternatives.**
> **· Worse clinical outcomes — higher rates of surgical site infection, MRSA, VRE and *Clostridioides difficile*.**
> **· Longer hospital stays and higher costs.**
> **· Increased antimicrobial resistance at a population level.**
> **De-labelling an incorrect penicillin allergy is one of the highest-value things a junior doctor can do**, and it takes a careful history rather than a test.

> [!tip] The history that sorts it
> **Features suggesting TRUE IgE-mediated allergy:** onset **within an hour** of the dose · **urticaria, angioedema, wheeze, stridor, hypotension, anaphylaxis** · required adrenaline or emergency treatment · reproducible on re-exposure.
> **Features suggesting it is NOT allergy:** **isolated gastrointestinal upset** (nausea, diarrhoea) · headache · **a delayed, non-itchy, non-urticarial rash in a child who also had a viral illness** · a family history only · a reaction the patient cannot describe · an event decades ago with no detail · a vasovagal episode during an injection · candidiasis.
> **The most useful single question: "have you had any penicillin-type antibiotic since?"** — **tolerating amoxicillin, flucloxacillin or a cephalosporin since the index event effectively excludes the allergy**, and this information is frequently already in the record.

> [!danger] The absolute contraindications — never re-expose, never de-label
> **· Stevens-Johnson syndrome and toxic epidermal necrolysis**
> **· DRESS (drug reaction with eosinophilia and systemic symptoms)**
> **· Acute generalised exanthematous pustulosis**
> **· Drug-induced organ injury — hepatitis, interstitial nephritis, pneumonitis**
...
> **Penicillin–cephalosporin cross-reactivity is substantially lower than the historical figures suggest**, and the risk depends on **side chain similarity rather than the shared beta-lactam ring.** Cephalosporins with dissimilar side chains can generally be used even in confirmed penicillin allergy.
> The old blanket rule of avoiding all beta-lactams denies patients the best available antibiotic on the basis of an over-estimate. `UNVERIFIED — the actual cross-reactivity figures and which cephalosporins are considered safe.`

> [!tip] Four specific non-allergy reactions worth knowing
> **· Radiocontrast reactions** — **these are NOT IgE-mediated and are NOT "iodine allergy".** **A shellfish allergy is NOT a contraindication to iodinated contrast**, and this myth persists widely and delays necessary imaging. The relevant allergen in shellfish is tropomyosin, not iodine. A previous contrast reaction is a risk factor for another; shellfish allergy is not.
> **· NSAID hypersensitivity** — usually pharmacological (COX-1 inhibition shunting arachidonic acid to leukotrienes) rather than IgE-mediated, so it is **cross-reactive across all NSAIDs.** **Aspirin-exacerbated respiratory disease** is the triad of **asthma, nasal polyps and NSAID sensitivity.**
> **· Local anaesthetic "allergy"** — **true IgE-mediated allergy to local anaesthetics is very rare.** Most reported events are **vasovagal episodes, palpitations from the adrenaline in the preparation, or anxiety.** Formal assessment usually clears the patient.
> **· Perioperative anaphylaxis** — the likely culprits are **neuromuscular blocking agents, antibiotics (usually given at induction), chlorhexidine and latex.** **It requires an acute tryptase, a baseline tryptase later, and formal specialist investigation to identify the agent** — because without it the patient carries an "anaesthetic allergy" label of unknown content into their next operation, which is genuinely dangerous.

> [!warning] Document what actually happened
> **"Allergy: penicillin" with no further detail is close to useless** and it propagates unchallenged for decades.
> **Record: the drug, the reaction, the time from dose to onset, the treatment required, and the date.** That record is what allows the next clinician to assess it rather than simply accept it.

**Ix:** **A structured allergy history** (*why:* it is the diagnostic test, and it resolves most labels without any investigation; *what:* timing, features, subsequent tolerance). Review of the medical record for subsequent beta-lactam exposure (*why:* documented tolerance since the event excludes the allergy and is often already recorded; *what:* prior administration without reaction). **Skin testing and graded oral challenge by an immunology service** for higher-risk histories (*why:* definitively resolves the label; *what:* reaction or tolerance). **Acute and baseline tryptase after a suspected perioperative or severe reaction** (*why:* confirms mast cell degranulation and supports later investigation; *what:* acute rise falling to baseline).

### 0.3.1 Mx – Immediate
Treat the reaction. **Stop the drug and, for a severe reaction, all non-essential drugs.**

### 0.3.2 Mx – Definitive
De-label where the history is clearly not allergic. Refer for formal assessment where the label matters clinically and the history is unclear.

### 0.3.3 Mx – Chronic/long-term
**Update the record, the discharge summary, the GP and the patient's own understanding** — a de-labelling that is not communicated to the GP will be reversed at the next presentation. Provide the patient with written documentation of what was found.

---

## 0.4 Food Allergy and the Prevention of Allergy

> [!warning] Australia has among the highest rates of childhood food allergy in the world
> The common allergens are **egg, cow's milk, peanut, tree nuts, sesame, soy, wheat, fish and shellfish.** **Sesame is now a declared allergen requiring labelling in Australia.**
> **Natural history differs by food:** milk, egg, soy and wheat allergy are frequently **outgrown** in childhood; **peanut, tree nut, fish and shellfish allergy usually persist for life.**

> [!danger] Early introduction PREVENTS allergy — this reverses the older advice
> **The previous recommendation to delay introduction of allergenic foods has been abandoned and reversed.**
> **Current Australian guidance is to introduce solid foods from around six months (and not before four months), including the common allergens — particularly peanut and egg — in the first year of life, and then to CONTINUE giving them regularly.**
> **Regular ongoing exposure matters as much as the initial introduction** — introducing peanut once and then stopping does not maintain tolerance.
> **This applies to infants with eczema and existing food allergy too, who are at highest risk and stand to benefit most**, though these infants should be discussed with a clinician first.
> `UNVERIFIED — the exact ASCIA infant feeding recommendations, including advice for high-risk infants and the frequency of ongoing exposure.`
> **Parents who were told the opposite ten years ago will need this explained**, and the explanation is worth giving properly.

> [!tip] Co-factors explain "why only sometimes"
> **A patient who eats a food repeatedly without problem and then reacts to it once has usually encountered a co-factor: exercise, alcohol, NSAIDs, intercurrent infection, or menstruation.**
> **Food-dependent exercise-induced anaphylaxis** — the food alone is tolerated, and exercise within a few hours of eating it triggers anaphylaxis. **Wheat (omega-5 gliadin) is the classic culprit.** This is genuinely puzzling to patients and is missed unless the temporal relationship to exercise is asked about.

> [!tip] Pollen-food syndrome (oral allergy syndrome)
> **Itching and mild swelling of the lips, mouth and throat on eating RAW fruits, vegetables or nuts, in someone with pollen allergy** — caused by cross-reactivity between labile plant proteins and pollen allergens.
> **The proteins are destroyed by heat, so the cooked food is tolerated** — which is the diagnostic clue.
> **It is usually mild and rarely causes anaphylaxis**, so it does not generally warrant an adrenaline autoinjector or total avoidance — an important distinction from true food allergy, and one that prevents a lot of unnecessary restriction.

> [!warning] Allergy versus intolerance — a distinction worth being able to explain clearly
> **Food allergy is immune-mediated and reproducible, and small amounts can cause severe reactions.**
...
### 0.4.3 Mx – Chronic/long-term
**ASCIA action plan, adrenaline autoinjector with demonstrated technique, medical alert, and school or childcare management plans.** Re-assessment over time, since many childhood allergies are outgrown and **the label should be revisited rather than carried indefinitely.** Cross-refer 0.7.

---

## 0.5 Allergic Rhinitis and the Atopic March

> [!tip] The atopic march
> A characteristic sequence in atopic individuals: **eczema in infancy → food allergy → allergic rhinitis → asthma.** Not every child follows it, but recognising the pattern predicts risk and prompts earlier assessment.
> **Early aggressive eczema management may reduce progression**, on the basis that allergen sensitisation occurs through a disrupted skin barrier — which is the same logic that underlies early oral introduction in 0.4.
...
> **· Intranasal corticosteroid — first-line for moderate to severe persistent rhinitis**, and more effective than antihistamines for congestion.
> **The technique determines whether it works**: **spray with the head slightly forward, using the opposite hand, aiming AWAY from the septum and toward the outer wall, and do not sniff hard.** Aiming at the septum causes epistaxis, irritation and, rarely, perforation — and it is what most patients do. **Demonstrating the technique is more valuable than the prescription.**
> **· Non-sedating oral antihistamines** — useful for sneeze, itch and rhinorrhoea, less so for congestion. **Avoid first-generation sedating antihistamines**, which impair cognition and driving and are still widely bought over the counter.
> **· Saline nasal irrigation** — cheap, effective, and under-recommended.
> **· Montelukast** — has a role, but carries **warnings about neuropsychiatric adverse effects including mood change, sleep disturbance and suicidal ideation**, which must be discussed and asked about at review.
> **· Intranasal decongestants** — **short-term only; prolonged use causes rhinitis medicamentosa with rebound congestion**, and patients become dependent on them.
> `UNVERIFIED — agents, doses, age restrictions and the current montelukast warnings.`

**Ix:** **Clinical diagnosis, with testing only where it will change management** — such as identifying a specific allergen for avoidance or for immunotherapy (*why:* rhinitis is diagnosed on history and examination, and testing everyone adds nothing; *what:* targeted skin prick or specific IgE). Nasal examination (*why:* identifies polyps, septal deviation and mucosal appearance, and **nasal polyps with asthma and NSAID sensitivity is Samter triad**; *what:* polyps, pale boggy mucosa). Spirometry (*why:* undiagnosed asthma is common in allergic rhinitis; *what:* reversible obstruction).

### 0.5.1 Mx – Immediate
Not applicable.

### 0.5.2 Mx – Definitive
Intranasal corticosteroid with taught technique, antihistamine, saline, and consideration of immunotherapy (0.7).

### 0.5.3 Mx – Chronic/long-term
Review technique and adherence, treat coexisting asthma, and consider immunotherapy in those with persistent symptoms despite optimal treatment.
...
> **Chronic urticaria (six weeks or more) is usually spontaneous and idiopathic, with an autoimmune basis in a substantial proportion. It is NOT usually caused by a food or an environmental allergen.**
> **Patients almost always want allergy testing**, and it almost always finds nothing relevant. **Explaining this well is the clinical skill** — the message is that the immune system is releasing histamine without an external trigger, that it is not dangerous, that it usually remits over months to years, and that it is treatable.
> **Treatment: a regular non-sedating antihistamine, taken DAILY rather than as needed — and up-titrated above the standard dose if required**, which is standard practice in urticaria and surprises patients and clinicians. **Omalizumab** for antihistamine-refractory disease. `UNVERIFIED — the permissible degree of up-dosing and the criteria for omalizumab.`
> **Chronic inducible urticarias** — **cold, cholinergic (heat and exertion), delayed pressure, dermographism, solar, aquagenic** — are diagnosed by the trigger and by provocation testing.

> [!danger] Angioedema WITHOUT urticaria is bradykinin-mediated until proven otherwise
> **This is the key distinction in angioedema, and it changes the treatment completely.**
...
> [!warning] Red flags in urticaria that suggest it is something else
> **· Individual lesions lasting MORE than 24 hours in the same place** — ordinary urticarial weals migrate and resolve within hours.
> **· Painful or burning rather than itchy lesions.**
> **· Bruising or pigmentation as the lesion resolves.**
> **· Fever, arthralgia, or systemic upset.**
> **These suggest URTICARIAL VASCULITIS**, which requires **skin biopsy** and a search for an underlying cause (connective tissue disease, infection, malignancy, drugs) — a different disease with a different workup.

> [!tip] Mast cell disorders
> **Recurrent unexplained flushing, hypotension, syncope, abdominal pain and diarrhoea**, sometimes with anaphylaxis to stings or without an identifiable trigger.
> **A raised BASELINE tryptase is the screening clue** — either **mastocytosis** (with cutaneous urticaria pigmentosa and characteristic bone marrow findings) or **hereditary alpha tryptasaemia**, an increasingly recognised common genetic cause of an elevated baseline tryptase.
> **Anyone with anaphylaxis and no identifiable trigger, or unusually severe insect sting reactions, should have a baseline tryptase measured.**

**Ix:** **Baseline tryptase** (*why:* screens for mastocytosis and hereditary alpha tryptasaemia, both of which change risk and management; *what:* persistently elevated level). **C4, C1 inhibitor level AND C1 inhibitor function** in angioedema without urticaria (*why:* **C1 inhibitor may be present but non-functional in one subtype, so measuring only the level misses it — the functional assay is required**; *what:* low C4, low level or function). FBC, ESR, CRP (*why:* systemic inflammation suggesting vasculitis or an underlying disorder; *what:* raised markers). **Skin biopsy where lesions last beyond 24 hours or leave bruising** (*why:* urticarial vasculitis; *what:* leukocytoclastic vasculitis). Thyroid function and autoantibodies (*why:* autoimmune thyroid disease is associated with chronic spontaneous urticaria; *what:* abnormal TSH, antibodies). **Medication review, including ACE inhibitors and NSAIDs** (*why:* both cause or exacerbate; *what:* culprit drug). **Extensive food and environmental allergy testing is NOT indicated in chronic spontaneous urticaria** (*why:* it does not find a cause and generates misleading positives; *what:* not indicated).

### 0.6.1 Mx – Immediate
Airway assessment in any angioedema involving the tongue or larynx. **Adrenaline if anaphylaxis cannot be excluded**, even in suspected bradykinin-mediated angioedema — but recognise it may not work, and give the specific agent where hereditary angioedema is known.

### 0.6.2 Mx – Definitive
Regular up-titrated antihistamine for chronic urticaria. Cessation and permanent documentation of an ACE inhibitor. Specific therapy and a management plan for hereditary angioedema.

### 0.6.3 Mx – Chronic/long-term
**Family screening in hereditary angioedema.** Patient-held emergency medication and a written plan, including **prophylaxis before dental and surgical procedures.** Immunology follow-up.

---

## 0.7 Immunotherapy and Long-Term Allergy Management

> [!tip] Allergen immunotherapy — the only disease-modifying treatment in allergy
> Repeated administration of increasing doses of allergen, **subcutaneously or sublingually**, over a course of years, inducing tolerance.
> **Established indications: allergic rhinitis and rhinoconjunctivitis not controlled by optimal medical therapy · selected allergic asthma · and — with the strongest evidence of all — venom allergy.**
> **It requires a multi-year commitment**, and its benefit persists after the course is completed, which distinguishes it from symptomatic treatment.
> `UNVERIFIED — indications, duration, and Australian availability and funding.`

> [!info] Venom immunotherapy — and a distinctly Australian element
> **Venom immunotherapy is highly effective at preventing subsequent systemic sting reactions and is indicated after a systemic reaction to a sting**, particularly anaphylaxis.
> **In Australia the relevant insects are honey bees, wasps, and the JACK JUMPER ANT (*Myrmecia pilosula*)** — a significant cause of sting anaphylaxis in **Tasmania, Victoria and parts of South Australia.**
> **Jack jumper ant venom immunotherapy was developed in Australia and is a genuinely Australian contribution**, available through specialist centres. Worth knowing both clinically and as an example of locally relevant practice that overseas sources will not cover.
> **A large local reaction to a sting is not an indication for immunotherapy or an autoinjector** — only systemic reactions are.

> [!tip] Biologics in allergic disease
> **· Omalizumab (anti-IgE)** — severe allergic asthma and chronic spontaneous urticaria.
> **· Mepolizumab, benralizumab (anti-IL-5 pathway)** — severe eosinophilic asthma.
> **· Dupilumab (anti-IL-4/IL-13)** — severe atopic dermatitis, asthma, chronic rhinosinusitis with polyps.
> These are specialist-initiated with defined eligibility and PBS criteria. `UNVERIFIED — indications and PBS authority requirements.`

> [!danger] After anaphylaxis — the long-term package that is routinely incomplete
> **· An adrenaline autoinjector, with the technique DEMONSTRATED and the patient's return demonstration observed** — not simply prescribed. **Technique degrades over time, so re-check it at every opportunity.** Trainer devices should be provided.
> **· Two devices** where the patient is far from medical help or has had a severe reaction, since a second dose is sometimes needed.
> **· An ASCIA Action Plan** — the standardised Australian document, personalised and given to the patient, school or workplace.
> **· A medical alert bracelet or equivalent.**
> **· Written allergen avoidance advice**, including reading food labels and asking in restaurants.
...
### 0.7.2 Mx – Definitive
Immunotherapy or biologic therapy through a specialist service.

### 0.7.3 Mx – Chronic/long-term
**Re-check autoinjector technique and expiry at every contact.** Reassess childhood food allergies over time rather than assuming permanence. Ongoing avoidance education and action plan review.
