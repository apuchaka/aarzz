...
> [!note] **`04_Neurology` continues below this file, into `Exam_04_System_File_Examination_Fragments`.**
...
> [!note] **`F0-4_Resuscitation_Algorithms_and_Emergency_Procedures` continues below this file, into `Exam_04_System_File_Examination_Fragments`.**
> That source block is split across `Exam_01_ABCDE_Cardioresp_Abdominal_and_Perioperative` · `Exam_04_System_File_Examination_Fragments`.
...
> [!note] **`Examination` continues below this file, into `Exam_02_Neurological_Skin_and_Head_and_Neck`.**
...
> [!note] **`03a_Anaesthetics_Primer` continues below this file, into `Exam_04_System_File_Examination_Fragments`.**
> That source block is split across `Exam_01_ABCDE_Cardioresp_Abdominal_and_Perioperative` · `Exam_04_System_File_Examination_Fragments`.
...
> [!note] **`AN1_Perioperative_Care` continues below this file, into `Exam_04_System_File_Examination_Fragments`.**
> That source block is split across `Exam_01_ABCDE_Cardioresp_Abdominal_and_Perioperative` · `Exam_04_System_File_Examination_Fragments`.
