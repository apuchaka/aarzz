...
### 1.5.1 The Stages of Change (Prochaska and DiClemente's transtheoretical model)
...
### 1.5.2 Motivational interviewing — the method
...
## 1.6 Domestic and Family Violence — Identification and Initial Response
...
## 1.7 Clinical Handover (ISBAR) and Prioritisation of Jobs

> [!warning] **`EBM1 §0.5 Handover and Transitions of Care` is the DECLARED OWNER of this topic (C1 ruling, 2026-09-01).**
> `GER5` defers to `EBM1` for handover. This section is kept in full as the station treatment; `EBM1` owns the process. `CF-PAIR` with `[[EBM1_Evidence_and_Clinical_Process]] 0.5`.

> [!note] Gap-filled from CSV ("Giving/receiving handover and prioritisation of jobs," Medium yield). **A second account is now in `[[EBM1_Evidence_and_Clinical_Process]] §0.5 Handover and Transitions of Care`; this file already points at it from its own cross-reference line.** Both kept, neither reconciled. (This note previously reported zero corpus-wide hits for handover, ISBAR, iSoBAR and SBAR; that search was run against the pre-merge corpus.) The gap it was built for was real — despite structured handover being a National Safety and Quality Health Service Standard requirement and one of the tasks an intern performs most often. Verified against the Australian Commission on Safety and Quality in Health Care's ISBAR resources and NSQHS Standard 6 (Communicating for Safety), and SA Health clinical handover guidance, Aug 2026.
...
### 1.7.1 ISBAR — the framework used across Australian health services
...
### 1.7.2 Giving and receiving a shift handover
...
## 1.8 Talking to Angry Patients and Relatives, and Managing Complaints

`CF-PAIR` **`GER5 §0.3 Difficult Conversations` arrived in Part 2 and was NOT merged into this section.** Both copies kept in full.
...
### 1.9.1 First: does the family get told at all?
...
## 1.10 Referral and Discussion with Other Specialties
...
### 1.10.1 The phone referral or consult
...
## 1.11 The Family, and Families in Crisis
...
### 1.12.2 When the patient is the one crossing the boundary
...
**The full operational detail — who can act as an observer, what happens when a patient declines, and the separate right to a support person — is built in [[Exam_01_ABCDE_Cardioresp_Abdominal_and_Perioperative]] Observers in Clinical Examination and is not repeated here.** Two points belong specifically to this entry, because they are about boundaries rather than examination technique:
...
## 1.13 Explaining a Medical Error — Open Disclosure

> [!warning] **`EBM1 §0.6 Error, Incident Reporting and Open Disclosure` is the DECLARED OWNER of this topic (C1 ruling, 2026-09-01).**
> `GER5` defers to `EBM1` for open disclosure, so the declared owner wins and **this section is the duplicate.** It is kept in full and **not** deleted — it is the OSCE-station treatment, where `EBM1`'s is the process treatment. `CF-PAIR` with `[[EBM1_Evidence_and_Clinical_Process]] 0.6`.

> [!note] Gap-filled from CSV ("Explaining a medical error (e.g. incorrect medication)," Medium yield). **A second account is now in `[[EBM1_Evidence_and_Clinical_Process]] §0.6 Error, Incident Reporting and Open Disclosure`; this file already points at it from its own cross-reference line.** Both kept, neither reconciled. (This note previously reported zero corpus-wide hits for open disclosure, adverse event and apology in this sense; that search was run against the pre-merge corpus.) The gap it was built for was real — despite open disclosure being a national standard obligation and one of the harder OSCE stations. Verified against the **Australian Open Disclosure Framework** (Australian Commission on Safety and Quality in Health Care, 2026 edition) and Avant's guidance for Australian clinicians on responding when things go wrong, Aug 2026.
...
## 1.14 Management of Patients with Multiple Chronic Medical Problems
...
## 1.15 Caring for the Elderly in the Community (Dementia, Mobility, Parkinson's, Recurrent Falls)
...
# 2 Consultation and communication skills merged in from `GER5` (2026-09-01)

> [!info] **C1 executed.** `GER5`'s six sections are reproduced here **verbatim**.
> **`GER5` is written in actual forms of words** — its own note: *"the difference is whether
> you can say the sentence."* That is the OSCE-usable half and it is preserved as written;
> Part 1's treatment of the same ground is the abstract one and is kept in full beside it.
>
> **Nothing merged.** Two direct duplicates carry `CF-PAIR` markers at both ends.

<!-- ===== SOURCE: GER5_Communication_and_Consultation_Skills.md ===== -->
*Moved here from `GER5_Communication_and_Consultation_Skills.md` on 2026-09-01. Verbatim and unrenumbered.*

## 0.1 The Consultation — Structure and Core Skills

> [!tip] The structure examiners are marking against
> **The Calgary-Cambridge framework underpins most consultation assessment: INITIATING the session · GATHERING information · PHYSICAL EXAMINATION · EXPLANATION AND PLANNING · CLOSING — with BUILDING THE RELATIONSHIP and PROVIDING STRUCTURE running throughout.**
> **INITIATING:**
> **· Introduce yourself BY NAME AND ROLE, confirm who the patient is, and seek permission.**
> **· SIT DOWN.** **Patients consistently perceive a seated clinician as having spent longer with them, even when the time is identical.** It costs nothing.
> **· SET THE AGENDA UP FRONT: "what were you hoping to cover today?" and then "is there anything else?" — repeated until they say no.**
> **This prevents the "DOORKNOB PHENOMENON", where the real reason for the visit appears as you stand up to leave.** **Agenda-setting takes thirty seconds and reorganises the whole consultation.**

> [!danger] The golden minute, and ICE
> **CLINICIANS INTERRUPT THE OPENING STATEMENT WITHIN ABOUT TEN TO TWENTY SECONDS.**
> **If you do not interrupt, most patients finish within a minute or two — and you get a better history, in their own words, with the concern they actually came about.**
> **START WITH AN OPEN QUESTION AND THEN BE QUIET.** "Tell me what's been happening." Then listen, nod, and let the silence work.
> **ICE — the three questions that transform a history and are explicitly marked in OSCEs:**
> **· IDEAS: "What do you think might be going on?" / "Have you had any thoughts about what might be causing it?"**
> **· CONCERNS: "What's worrying you most about it?" / "Was there something in particular you were afraid it might be?"**
> **· EXPECTATIONS: "What were you hoping we might do today?" / "How were you hoping I could help?"**
> **The CONCERNS question is the highest-yield of the three.** A patient with a headache who is frightened of a brain tumour needs a different consultation from one who wants a certificate — and you will not find out unless you ask.
> **Ask them naturally and early, not as a recited list at the end.**

> [!tip] Empathy — naming the emotion is the technique
> **Empathy in a consultation is not a feeling you have; it is something you SAY OUT LOUD so the patient knows you noticed.**
> **THE MOVE: NAME the emotion, and connect it to the reason.**
> **· "This sounds like it's been really frightening."**
> **· "I can see how much this has taken out of you."**
> **· "That must have been very hard to talk about."**
> **· "Anyone would find that difficult."**
> **AND THEN STOP — do not immediately follow it with reassurance or a plan, which cancels it out.**
> **Useful additions: "Tell me more about that." · "What's been the hardest part?" · "How have you been coping?"**
> **AVOID: "I know exactly how you feel" (you don't) · "at least..." (minimising) · "don't worry" (an instruction nobody can follow) · and rushing to fix.**

> [!warning] Explaining well — chunk, check, and drop the jargon
> **· CHUNK AND CHECK — give one piece of information, then check understanding, then the next. Do not deliver a paragraph.**
> **· SIGNPOST — "there are three things I want to go through: what I think is going on, what we should do about it, and what to watch for."**
> **· USE THE PATIENT'S OWN WORDS for their symptoms.**
> **· AVOID JARGON — and be aware of the words that patients reliably MISUNDERSTAND: "POSITIVE" and "NEGATIVE" results (positive sounds good) · "chronic" (heard as severe) · "acute" (heard as mild) · "STABLE" (heard as fine) · "the scan was UNREMARKABLE" (heard as inconclusive) · "malignant" and "benign" · "shadow" · and "we'll observe you" (heard as doing nothing).**
...
## 0.4 Interpreters and Communicating Across Difference

> [!danger] Use a professional interpreter — never family, and never a child
> **THE RULE IS ABSOLUTE FOR ANY CLINICALLY SIGNIFICANT CONVERSATION.**
> **WHY FAMILY MEMBERS FAIL: they SUMMARISE and FILTER · they OMIT what they think is upsetting · they EDITORIALISE and answer on the patient's behalf · they may have their OWN INTERESTS in the outcome (inheritance, care arrangements, immigration) · they may BE the problem (family violence, elder abuse, coercion) · and their presence prevents the patient disclosing anything private.**
> **USING A CHILD TO INTERPRET FOR A PARENT IS HARMFUL TO THE CHILD — exposing them to adult information, reversing the family role, and placing them in an impossible position — AND UNRELIABLE FOR YOU.** **It must not happen, and the pressure of time is not a justification.**
> **In Australia: TIS National provides free telephone interpreting for medical practitioners, alongside state services, on-site interpreters, and ABORIGINAL LANGUAGE interpreter services — which are substantially UNDER-USED, because it is assumed that a person speaking some English does not need one.** `UNVERIFIED — the services and access arrangements.`

> [!tip] How to actually run the consultation
> **· BRIEF THE INTERPRETER beforehand where possible — the nature of the consultation, and whether difficult news is coming.**
> **· SPEAK TO THE PATIENT, NOT TO THE INTERPRETER. Say "do you have any pain?" while looking at the patient — NOT "ask her if she has any pain".** This is the most visible marker of doing it well or badly.
> **· POSITION yourself facing the patient with the interpreter to the side.**
> **· SHORT SEGMENTS, plain language, one idea at a time. Avoid idiom, metaphor and humour, which do not translate.**
> **· ALLOW ROUGHLY DOUBLE THE TIME, and book accordingly.**
> **· CHECK UNDERSTANDING with teach-back, through the interpreter.**
> **· BE AWARE that some concepts have no direct equivalent, and the interpreter may need to explain rather than translate — allow for that rather than assuming padding.**
...
> **· SILENCE is comfortable and meaningful in many cultures. Do not rush to fill it.**
> **· Sustained EYE CONTACT may be experienced as confronting; follow the person's lead rather than insisting.**
> **· ASK WHO SHOULD BE PRESENT and who should be involved in decisions — family and kinship structures differ, and the appropriate decision-maker may not be the recorded next of kin.**
> **· ASK ABOUT GENDER PREFERENCE for the examining clinician rather than assuming either way.**
> **· "WHAT DO YOU THINK CAUSED THIS?" is a cultural safety question as much as a clinical one — it surfaces the person's explanatory model, which is what your explanation has to connect with.**
> **· ENGAGE ABORIGINAL LIAISON OFFICERS AND HEALTH WORKERS EARLY, at admission — not at the point of crisis.**

---

## 0.5 Shared Decision-Making and Health Literacy

> [!tip] When it applies, and the three-talk model
> **Shared decision-making is appropriate where there is genuine EQUIPOISE, or — more often — where the right answer DEPENDS ON THE PERSON'S VALUES: screening decisions, elective surgery, anticoagulation, statins for primary prevention, dialysis, chemotherapy in advanced disease, and end-of-life choices.**
> **It is NOT appropriate to present a menu when there is a clear best option, or in an emergency — abdicating a recommendation is not shared decision-making, it is abandonment.**
> **THE THREE-TALK MODEL:**
> **1. TEAM TALK — "there's more than one reasonable option here, and the best one depends on what matters to you. Let's work it out together."**
> **2. OPTION TALK — lay out the options with their benefits AND harms, in absolute numbers.**
> **3. DECISION TALK — "what matters most to you as you think about this?" and then support the decision, including by making a recommendation if they want one.** **Many people DO want a recommendation, and asking "would it help if I told you what I'd suggest?" is part of the process, not a failure of it.**
...
> **· AVOID VERBAL DESCRIPTORS ALONE.** **People interpret "common", "rare" and "a small risk" enormously differently from each other and from clinicians — and clinicians use them inconsistently.**
> **· And frame both ways: "97 out of 100 will be fine" and "3 out of 100 will have a problem" are the same fact and land differently, so give both.**

> [!warning] Health literacy — assume nothing, and use teach-back
> **A LARGE PROPORTION OF AUSTRALIAN ADULTS HAVE HEALTH LITERACY BELOW THE LEVEL NEEDED TO MANAGE THEIR OWN HEALTH — and it is NOT predictable from education, occupation, articulacy or vocabulary.**
> **PEOPLE CONCEAL IT.** They nod, they say yes, they take the leaflet — because admitting you did not understand the doctor is embarrassing.
> **THEREFORE USE A "UNIVERSAL PRECAUTIONS" APPROACH: communicate as though anyone might struggle, with everyone.**
> **TEACH-BACK IS THE TECHNIQUE, and the phrasing matters enormously:**
> **· SAY: "I want to make sure I've explained this properly — can you tell me what you'll do when you get home?"**
> **· NOT: "Do you understand?" (invites yes) or "Can you repeat that back?" (sounds like a test).**
> **Placing the responsibility on YOUR EXPLANATION rather than on their comprehension is what makes it usable and non-shaming.**
> **If they cannot teach it back, RE-EXPLAIN DIFFERENTLY — not louder, and not the same way again — then check once more.**
> **Also: write things down · use diagrams · limit to three key points · put the most important thing FIRST and repeat it LAST · and involve a family member with the patient's consent.**

---

## 0.6 Telehealth, Phone and Written Communication
...
> **· BE MORE CONSERVATIVE WITH SAFETY NETTING than face-to-face, and have a low threshold for converting to an in-person review.** **"I can't examine you over the phone, so if X happens, I need you to be seen."**
