...
| D-15 | **5** × `**Focused Hx:**` + **5** × `**Examination:**` *(count corrected 2026-09-01 — measured, not re-estimated)* in `NEW_Dermatology` | 2264–2318 | **History-Taking.md / Examination.md** | L2274 *"full skin examination with the patient undressed"*; L2304 *"Nikolsky's sign"* **✅ RESOLVED 2026-09-01 — Option 1: left in place, indexed in `Examination.md` §3 and `History-Taking.md` §2 (`bcf7515`/`fab04f5`)** |
