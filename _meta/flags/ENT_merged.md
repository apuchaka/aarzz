...
| T-2 | 4 × `**Focused Hx:**` + 4 × `**Examination:**` in `NEW_ENT_and_Oral` | 1779–1819 | **History-Taking.md / Examination.md** | L1780 *"assess the airway before the throat"*; L1793 *"otoscopy of both ears"*; L1819 *"listen to the voice and characterise it"* **✅ RESOLVED 2026-09-01 — Option 1: left in place, indexed in `Examination.md` §3 and `History-Taking.md` §2 (`bcf7515`/`fab04f5`)** |
