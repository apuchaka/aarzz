...
`### Who gets a CT head for head injury?` (which carries the live note that Australian pathways use the **✅ EXECUTED 2026-09-01 → `Investigation-Interpretation.md` (ac620de)**
