...
| P-2 | `## 0.1 Adolescent Development and the Consultation` (M7) | 3944 | **Communication.md** | how to run the consultation, incl. seeing the young person alone **✅ EXECUTED 2026-09-01 → `Communication.md` (block 5)** |
| P-3 | `## 0.3 Confidentiality, Consent and the Mature Minor` (M7) | 3992 | **`A10_Ethics__Capacity__Consent_and_Certification`** | Gillick/mature minor is a **consent and capacity** topic. `A10` is the owner **✅ EXECUTED 2026-09-01 → `A10_Ethics__Capacity__Consent_and_Certification.md` (block 5)** |
