...
aliases:
  ...
  - "M6"
  - "M7"
  - "15_01a_Paeds_-_Paediatric_and_Newborn_Life_Support"
  - "15_01b_Paeds_-_Anaphylaxis"
  - "15_02_Paeds_-_Ill_and_Feverish_Child__Meningitis__Encephalitis"
  - "15_03a_Paeds_-_Childhood_Viral_Exanthems"
  - "15_03b_Paeds_-_HIV_in_Children"
  - "15_04a_Paeds_-_URTI_and_LRTI"
  - "15_04b_Paeds_-_Asthma_in_Children"
  - "15_05_Paeds_-_Acyanotic_Congenital_Heart_Disease"
  - "15_06_Paeds_-_Cyanotic_CHD__Kawasaki_Disease__Murmurs"
  - "15_07_Paeds_-_Abdominal_Pain__Neuroblastoma__Coeliac_Disease__Malnutrition__Diarrhoea_and_Vomiting"
  - "15_08_Paeds_-_Surgical_Abdomen__Appendicitis__Intussusception__Pyloric_Stenosis__Hirschsprung__Oesophageal_Atresia_"
  - "15_09a_Paeds_-_Congenital_Abdominal_Wall_and_GI_Anomalies"
  - "15_09b_Paeds_-_Infant_Feeding_Problems"
  - "15_10_Paeds_-_UTI__Nephrotic_Syndrome__Glomerulonephritis"
  - "15_11_Paeds_-_Urological_and_Renal_Anomalies__Wilms_Tumour__HUS"
  - "15_12a_Paeds_-_Epilepsy_Syndromes_and_Status_Epilepticus"
  - "15_12b_Paeds_-_Brain_Tumours"
  - "15_13a_Paeds_-_Neural_Tube_Defects"
  - "15_13b_Paeds_-_Autism_Spectrum_Disorder_and_Cleft_Lip_Palate"
  - "15_14_Paeds_-_Anaemia__Sickle_Cell__Hereditary_Spherocytosis__HSP"
  - "15_15a_Paeds_-_ITP_and_Acute_Lymphoblastic_Leukaemia"
  - "15_15b_Paeds_-_Primary_Immunodeficiencies_and_SCID"
  - "15_16a_Paeds_-_Hypothyroidism"
  - "15_16b_Paeds_-_Diabetes_Mellitus__MODY__DKA"
  - "15_17a_Paeds_-_Hyperthyroidism_and_Approach_to_Inherited_Metabolic_Disease"
  - "15_17b_Paeds_-_Glycogen_Storage_Disorders__PKU__Lysosomal_Storage_Diseases"
  - "15_18a_Paeds_-_Precocious_and_Delayed_Puberty__CAH"
  - "15_18b_Paeds_-_Genetic_Disorders_Inheritance_Summary"
  - "15_19a_Paeds_-_Developmental_Milestones_and_Delay"
  - "15_19b_Paeds_-_Cerebral_Palsy_and_Muscular_Dystrophies"
  - "15_20a_Paeds_-_Trisomies_and_Sex_Chromosome_Disorders"
  - "15_20b_Paeds_-_Imprinting_Disorders__Prader-Willi__Angelman_"
  - "15_21a_Paeds_-_Microdeletion_Syndromes__Cri_du_Chat__DiGeorge__Williams_"
  - "15_21b_Paeds_-_Fragile_X__Achondroplasia__Noonan__Marfan"
  - "15_22a_Paeds_-_Neonatal_Sepsis_and_Seizures"
  - "15_22b_Paeds_-_Neonatal_Respiratory_Distress_and_Jaundice"
  - "15_23a_Paeds_-_NEC__Neonatal_Hypoglycaemia__Hypotonia"
  - "15_23b_Paeds_-_Minor_Neonatal_Problems"
  - "M1_The_Seriously_Unwell_Child"
  - "M2_Fever_in_Children"
  - "M3_Neonatal_Problems"
  - "M4_Growth_and_Development"
  - "M5_Paediatric_GI__GU_and_Limb"
  - "M6_Paediatric_Respiratory_and_Neurology"
  - "M7_Adolescent_and_Behavioural_Health"
---
...
<!-- ===== SOURCE: 15_01b_Paeds_-_Anaphylaxis.md ===== -->
...
<!-- ===== SOURCE: 15_03a_Paeds_-_Childhood_Viral_Exanthems.md ===== -->
...
<!-- ===== SOURCE: 15_03b_Paeds_-_HIV_in_Children.md ===== -->
...
<!-- ===== SOURCE: 15_04b_Paeds_-_Asthma_in_Children.md ===== -->
...
<!-- ===== SOURCE: 15_08_Paeds_-_Surgical_Abdomen__Appendicitis__Intussusception__Pyloric_Stenosis__Hirschsprung__Oesophageal_Atresia_.md ===== -->
...
<!-- ===== SOURCE: 15_09a_Paeds_-_Congenital_Abdominal_Wall_and_GI_Anomalies.md ===== -->


## Congenital diaphragmatic hernia

- **D:** protrusion of abdominal contents into the thoracic cavity due to a defect in the diaphragm. Incidence 1:2400 — only 50% survival.
- **S/Smx:** usually diagnosed prenatally by ultrasound. On birth: respiratory distress, cyanosis, ↓breath sounds + bowel sounds in the hemithorax, displaced heart sounds, scaphoid abdomen. Small hernias may present later with minor problems. 61% have other abnormalities.
- **Dx/Ix:** prenatal ultrasound, postnatal CXR.
- **Mx:**
  - Prenatal: fetal tracheal obstruction by balloon, which encourages lung growth and pushes out viscera.
  - Postnatal: intubate, ventilate, paralyse with minimal pressures.

> [!danger] DO NOT use facemask ventilation, as air may enter the gut.

  - Surgery in a tertiary centre.

## Inguinal hernia

- **D:** protrusion of abdominal or pelvic contents through a dilated internal inguinal ring or attenuated inguinal floor into the inguinal canal.
- **S/Smx:** bulge lateral to the pubic tubercle when abdominal pressure increases (e.g. crying). R>L. M>F 5:1.

> [!tip] Important DDx: hydrocele — similar aetiology, but only allows fluid from the peritoneal cavity to pass through. Generally closes during the 1st year of life. If it persists after 2 years, may need surgical closure.

- **Mx — "6-2 rule":**
  - Baby <6 weeks: repair within 2 days (greatest risk of strangulation).
  - <6 months: repair within 2 weeks.
  - <6 years: repair within 2 months.

*(See [[03_Gastrointestinal]] Hernias for more, not repeated here.)*

## Imperforate anus

- **D:** congenital anorectal malformation where a normal anal opening is absent at birth. 1 in 5000 births in the US. M>F slightly. Associated with some specific syndromes, trisomies, and other abnormalities.
- **S/Smx:** failure to pass meconium within 24h. Meconium in urine — girls may have a fourchette fistula; boys may have a posterior urethral fistula.
- **Dx/Ix:** GU imaging to find other anomalies.
...
- **P:** malrotation increases susceptibility to volvulus, ischaemia, necrosis.
- **S/Smx of volvulus (3–7 days after birth):** bilious neonatal vomiting → immediate surgical referral (+NGT). Also epigastric distention, pain, associated with abnormalities of adjacent organs; ± feeding difficulties.

> [!danger] Blood PR (possible mid-gut necrosis) → emergency surgical decompression.

- **Dx/Ix:** UGI contrast study — the DJ flexure is more medially placed. Ultrasound may show abnormal orientation of the SMA and SMV.
- **Mx:** Ladd's procedure.

## Gastroschisis and omphalocele

- **D:** congenital defects of the abdominal wall resulting in intestinal herniation from the abdominal cavity.
  - **Gastroschisis** (1 in 3000): para-umbilical defect with evisceration of abdominal contents.
  - **Omphalocele:** defect of the umbilical ring with herniation of abdominal viscera, covered by peritoneum and amniotic membrane. Major >4cm, minor <4cm. 72% associated with other malformations. Associated with Beckwith-Wiedemann syndrome, Down syndrome.
- **R:** maternal age <20 (gastroschisis) or >35 (omphalocele), M>F, smoking.
- **Dx/Ix:** antenatal ultrasound.
- **Mx of gastroschisis:** vaginal delivery may be attempted. Surgical emergency! At delivery, cover exposed bowel in cling film, avoid heat and fluid loss. Theatre ASAP (within 4h). TPN may be required for a while.
- **Mx of omphalocele:** C-section to reduce risk of sac rupture. Staged repair if needed — allows the sac to granulate and epithelialise over coming weeks; as the infant grows, the sac contents will be able to fit within the abdominal cavity, then the shell is removed and the abdomen closed.

## Meckel's diverticulum

- **D:** congenital diverticulum of the small intestine — contains mucosa.

> [!tip] "Rule of 2s": occurs in 2% of the population; 2% are symptomatic; 2× more common in males; 2 feet from the ileocaecal valve; 2 inches long.

- **S/Smx:** generally symptomatic when the patient is younger. Painless rectal bleeding ("currant jelly" coloured stool) in children, or melaena in adults. Abdominal pain — can present similarly to appendicitis.
- **Ix:** "Meckel's scan" (usually in kids) — technetium scan, or mesenteric arteriography in more severe cases.
- **Mx:** if active bleeding + large blood loss, may need blood transfusion. Definitively, resection of the diverticulum.


<!-- ===== SOURCE: 15_09b_Paeds_-_Infant_Feeding_Problems.md ===== -->
...
- **Mx:** watch and wait. **Simeticone and lactase are not recommended** — see the box below: the evidence against them is general rather than UK-specific, and Australian Prescriber and RCH Melbourne reach the same position. (Previously attributed to NICE in this line, which read as though the recommendation were a UK one.)
...
<!-- ===== SOURCE: 15_10_Paeds_-_UTI__Nephrotic_Syndrome__Glomerulonephritis.md ===== -->
...
<!-- ===== SOURCE: 15_11_Paeds_-_Urological_and_Renal_Anomalies__Wilms_Tumour__HUS.md ===== -->
...
<!-- ===== SOURCE: 15_15a_Paeds_-_ITP_and_Acute_Lymphoblastic_Leukaemia.md ===== -->


## Immune thrombocytopenia (ITP)

> [!note] Full entry (definition, pathophysiology, Ix, Mx including the child-vs-adult natural history distinction — 80% spontaneous resolution in children within 6 months vs only 5–10% in adults — and the paediatric-specific safety-netting/splenectomy-timing detail) already built in [[10_07_Haemonc_-_Platelet_and_Clotting_Disorders__Neutropaenia]] Immune thrombocytopenia (ITP), not duplicated here. That entry was merged to include the paediatric-specific detail originally in this file.

## Acute lymphoblastic leukaemia (ALL)

> [!note] Full entry (definition, prognosis box, Ix, Mx, complications including neutropenic sepsis prophylaxis and revaccination timing, and the febrile neutropenia management approach) already built in [[10_01_Haemonc_-_Leukaemias_and_Myeloproliferative_Disorders]] Acute lymphoblastic leukaemia (ALL), not duplicated here — genuinely the more appropriate home given ALL is predominantly a paediatric disease and that entry has since been merged to include all the paediatric-specific complications and febrile neutropenia detail originally in this file, cross-referencing [[10_10a_Haemonc_-_Haematological_and_Oncological_Emergencies]] for the AU-verified piperacillin-tazobactam neutropenic sepsis regimen.


<!-- ===== SOURCE: 15_15b_Paeds_-_Primary_Immunodeficiencies_and_SCID.md ===== -->
...
<!-- ===== SOURCE: 15_16a_Paeds_-_Hypothyroidism.md ===== -->


## Hypothyroidism in children

- **D:** deficiency of thyroid hormones, leading to a generalised slowing of metabolic processes.

## Congenital hypothyroidism (cretinism)

- **Causes:** thyroid dysgenesis (85%); dyshormonogenesis (15%).
- **S/Smx:** mostly late — hence the importance of screening.

> [!warning] Prolonged neonatal jaundice; widely opened posterior fontanelle; poor feeding; hypotonia; dry skin; ± inactivity, ↑sleepiness, hoarse cry, constipation.

- **Late signs:** flat nasal bridge, protruding tongue, umbilical hernia, slowly relaxing deep tendon reflexes, ↓pulse. If untreated, poor growth, cognitive disability.
- **Dx:** Day 5 dried blood spot — tests for ↑TSH to detect primary hypothyroidism. Other tests: T4, thyroid imaging (for secondary or central hypothyroidism), thyroid antibody screen ± pituitary function.

## Acquired hypothyroidism

- **Primary:** prematurity, Hashimoto's thyroiditis (associated with Down syndrome, T1DM, coeliac disease, Turner syndrome), iodine deficiency, drugs, irradiation, etc.
- **Secondary:** hypopituitarism.

## Management

> [!info] Verified against Safer Care Victoria neonatal hypothyroidism guidance, Aug 2026, and current international literature (2023 AAP consensus, multiple recent dosing studies) — **the original ~15mcg/kg/day neonatal starting dose is genuinely too high** compared to current Australian and broader international guidance, not merely a UK-specific figure needing swap-out. Australian guidance recommends starting at **8–10mcg/kg/day as a single daily dose**; international guidelines more broadly cite a 10–15mcg/kg/day range, but recent evidence specifically shows **higher starting doses within that range are associated with a substantial rate of iatrogenic hyperthyroidism at follow-up** (over one-third of infants started at the higher end required dose reduction in one dosing study), while lower starting doses (10–12.5mcg/kg/day) achieve equivalent neurodevelopmental and growth outcomes without this overshoot risk. **The practical adjustment: start toward the lower end of the range (8–10mcg/kg/day) rather than 15mcg/kg/day**, with the tablets ground and mixed with a small amount of milk for administration in neonates, given this age group can't take tablets whole. Treatment should begin as soon as the diagnosis is confirmed, ideally within the first 2 weeks of life, given delayed treatment beyond 6 weeks carries a substantial risk of permanent cognitive impairment — this timing urgency is genuinely internationally consistent, not the part needing correction.

- Lifelong levothyroxine.
  - Neonates: start ~8–10mcg/kg/day as a single daily dose (see the verified note above — genuinely lower than the original 15mcg/kg/day figure), adjust by 5mcg/kg every 2 weeks to a typical dose of 20–50mcg/day.
  - <2 years old: start with 5mcg/kg/day (max 50mcg/day), adjust by 10–25mcg every 2 weeks.
  - >2 years old: start with 50mcg/day, adjust by 25mcg every 2 weeks.
- Adjust according to growth and clinical state. Aim for high-normal T4 and low-normal TSH levels.
...
- **D:** conditions resulting from defects in enzymes required for synthesis and degradation of glycogen.
- **A:** genetic (mostly autosomal recessive). **P:** abnormal glycogen stores are deposited in the liver, muscle, heart, or kidney ± CNS.

| Type | Features |
|---|---|
| Cori disease (type III) | Hypoglycaemia, hepatomegaly, ↓growth |
| Anderson disease (type IV) | — |
| McArdle disease (type V) | The most common GSD in teens. Secondary to myophosphorylase deficiency → stiffness or myalgia after exercise. Bloods after exercise: ↓lactate and pyruvate ± myoglobinuria. Biopsy: ↓phosphorylase |
| Hers disease (type VI) | — |
| Tauri disease (type VII) | — |

- **Mx:** depends on type. Specialised diets; enzyme replacement therapy; no extreme exercise; prevention of hypoglycaemia (e.g. a bedtime meal of slowly digested complex carbohydrates).

## Phenylketonuria (PKU)

- **D:** autosomal recessive inborn error of amino acid metabolism characterised by ↑blood phenylalanine (>6mg/dL or >363mmol/L). Also known as phenylalanine hydroxylase (PAH) deficiency.
- **R:** positive family history, white ethnicity.
- **A/P:** no PAH enzyme, or a defective PAH enzyme → ↑blood phenylalanine levels → ↑phenylalanine to the brain → neurotoxicity. Classic PKU leads to gradual cognitive impairment: ↓CNS dopamine, ↓protein synthesis, demyelination.
- **S/Smx:** fair hair, fits, eczema, musty urine.

> [!danger] ↓IQ (e.g. poor spelling, ↓cognition, inability to calculate) if untreated.

- **Dx:** newborn screening — tests for ↑blood phenylalanine (>120µmol/L).
- **Mx:** treatment started if >360µmol/L. Dietary restriction with a phenylalanine-free protein substitute enriched in tyrosine, and <300mg to 8g of natural protein per day (depending on severity). Aim to keep levels <360µmol/L. Adherence may be poor, and other problems (e.g. mental health) may arise.

> [!warning] Maternal PKU: preconception counselling is important. Effects on the baby if maternal phenylalanine is uncontrolled: facial dysmorphism, microcephaly, growth retardation, ↓IQ.

## Lysosomal storage diseases

- **A:** genetic mutations, usually autosomal recessive, but some are sex-linked (e.g. Fabry's disease).
- **P:** accumulation of undegraded substrates; enlargement of cells and organs; ± ↑apoptosis of neurons.

### Fabry's disease

- α-galactosidase deficiency.
- **S/Smx:** torturing, lancinating pains in the extremities ± abdomen — worse in cold, heat, exercise; secondary to neuritis (vasculitis of the vasa nervorum). Angiokeratomata (clusters of dark, non-blanching petechiae) in the "bathing trunk" area, especially the umbilicus and scrotum. ± Paraesthesia, corneal opacities, hypohidrosis, proteinuria, renal failure.
- **Mx:** enzyme replacement therapy ± carbamazepine.

### Tay-Sachs disease

- β-hexosaminidase A deficiency. Gangliosides accumulate in lysosomes, especially in neurons. More common in Ashkenazi Jews.
- **S/Smx:**
  - Infants: hyperacusia, macular "cherry red spot".
...
<!-- ===== SOURCE: 15_18b_Paeds_-_Genetic_Disorders_Inheritance_Summary.md ===== -->


## Genetic disorders — quick reference by inheritance pattern

> [!info] Disorders of chromosome number
> - **Trisomies:** trisomy 21 (Down syndrome); trisomy 13 (Patau syndrome); trisomy 18 (Edward syndrome); 47,XXY (Klinefelter syndrome); 47,XXX (Triple X syndrome).
> - **Monosomies:** 45,XO (Turner syndrome).

> [!info] Disorders of chromosome structure (microdeletions)
> - 5p: Cri du chat syndrome.
> - 22q11.2: DiGeorge syndrome.
> - 7q11: Williams syndrome.

> [!info] Autosomal dominant inheritance
> Achondroplasia; Marfan syndrome; Huntington disease; myotonic dystrophy; neurofibromatosis; Noonan syndrome; osteogenesis imperfecta (most forms); otosclerosis; polyposis coli; tuberous sclerosis; familial hypercholesterolaemia (almost all cases).

> [!info] Autosomal recessive inheritance
> Congenital adrenal hyperplasia; cystic fibrosis; Friedreich ataxia; galactosaemia; Hurler syndrome; glycogen storage diseases; oculocutaneous albinism; phenylketonuria; sickle cell disease; Tay-Sachs disease; thalassaemia; Werdnig-Hoffmann disease (SMA type 1).

> [!info] X-linked recessive inheritance
> Colour blindness (red-green); Duchenne and Becker muscular dystrophies; Fragile X syndrome; G6PD deficiency; haemophilia A and B; Hunter syndrome.

> [!info] Imprinting and uniparental disomy
...
- **D:** trisomy 21. 1:800 births.
- **R:** ↑maternal age (age 20 → 1:1500 risk; age 40 → 1:100 risk), previous child with Down syndrome, parental karyotype with translocation.
- **A:** extra chromosome 21. **P:** may be due to non-disjunction of chromosome pairs during gamete formation, Robertsonian translocation, or mosaicism.

> [!info] Features in the neonatal period: hypotonia; poor Moro reflex; hyper-flexibility of joints; extra skin on back of neck; flat facial profile; slanted palpebral fissures; anomalous auricles; hypoplasia of iliac wings; short middle phalanx of the fifth finger; single palmar crease.

### Associated conditions

- **GI:** duodenal atresia, Hirschsprung's disease.
- **Cardiac:** AVSD (40%, most common); VSD (30%); ASD (10%); Tetralogy of Fallot (~5%); isolated PDA (~5%).
- **Vision:** refractive errors more common; strabismus (20–40%); cataracts (congenital or acquired); recurrent blepharitis; glaucoma.
- **Hearing:** otitis media very common.
- **Haematological:** infants may be born with transient abnormal myelopoiesis (TAM) that may progress to ALL or AML.
- **Neurological:** learning difficulties; associated with Alzheimer's disease (onset in early 50s); epilepsy in 8%.
- **Respiratory:** obstructive sleep apnoea; recurrent infections.
- **Thyroid:** hypothyroidism more common.
- **Others:** atlantoaxial instability.

- **Ix:** chromosomal karyotype for diagnosis. Other tests according to complications (e.g. echocardiogram).
- **Mx:** assessment + specialist consultation; parental genetic counselling.
- **P:** average life expectancy 50–60 years old.

## Patau syndrome (Trisomy 13)

- **R:** ↑maternal age. **A/P:** as with Down syndrome; typically causes "midline" defects (e.g. cleft lip/palate).
- **S/Smx:** microcephaly; small or no eyes; cleft lip or palate; polydactyly; scalp lesions; cardiac abnormalities (any); other organ abnormalities. After infancy, patients have severe psychomotor disorder, failure to thrive, intellectual disability, and seizures.
- **P:** median survival 7–10 days; 90% live <1 year.

## Edwards syndrome (Trisomy 18)

- **R:** ↑maternal age.
- **S/Smx:** micrognathia; low-set ears; rocker bottom feet; overlapping of fingers; cardiac defects in 90%; all organ systems may be affected.
- **P:** median survival 3–14 days; 90–95% live <1 year.

## Turner syndrome

- **D:** monosomy 45,XO — absence of the second sex chromosome in phenotypical females. ~1:5000 females.
- **R:** no known risk factors.
- **S/Smx:** abnormal facies (narrow or high arched palate, short/broad/webbed neck, low-set anomalous pinnae). Short stature (usually <5th percentile — rule out other causes of poor growth). Shield chest, widely spaced nipples. Cystic hygroma. Short fourth metacarpal. Multiple pigmented naevi.
- **Cardiac:** bicuspid aortic valve (15%); coarctation of the aorta (5–10%); ↑risk of aortic dilation and dissection.
- **Endocrine:** primary amenorrhoea; ↑gonadotropin levels; hypothyroidism.
- **Renal:** horseshoe kidney.
- Lymphoedema in neonates. ↑risk of autoimmune disease and Crohn's disease.
- May not be diagnosed until the teens, when patients present due to short stature and delayed puberty.
- **Ix:** karyotype for diagnosis.
- **Mx:** surveillance and preventative care. Once the patient has cyclical bleeding — ovarian HRT (oral or transdermal oestrogen therapy, continued until ~50 years old). Education on reproductive issues — most women with Turner syndrome are infertile, but spontaneous menses and pregnancies occur in 2–3%; genetic counselling required.

## Klinefelter syndrome

- **D:** ≥2 X chromosomes in a phenotypical male. 47,XXY is the most common form. ~1:1000 males.
- **R:** ↑maternal & paternal age.
- **S/Smx:** often taller than average. Genital abnormalities — lack of secondary sexual characteristics; small, firm testes (↑gonadotropins & low testosterone); infertility (the most common presentation). Gynaecomastia (associated with ↑breast cancer risk). Intelligence usually in the normal range, but some have educational and psychological problems.

## Triple X syndrome

- **D:** trisomy X — 47,XXX. 1:1000 females.
- **S/Smx:** wide range of phenotypes — estimated that only 10% are clinically diagnosed (the other 90% likely subclinical). At birth: hypotonia, clinodactyly (a finger that curves to one side). Physical features: tall, epicanthal folds, widely spaced eyes (hypertelorism). Other associated conditions: genitourinary malformations, seizure disorder, intention tremor, congenital hip dysplasia, constipation or abdominal pains — may only be diagnosed in the teens due to late menarche, menstrual irregularities, or subfertility.


<!-- ===== SOURCE: 15_20b_Paeds_-_Imprinting_Disorders__Prader-Willi__Angelman_.md ===== -->


## Prader-Willi syndrome (PWS)

- **D:** genetically inherited complex neurological disorder caused by absence of expression of paternally inherited imprinted genes on chromosome 15q11-q13.
- **R:** ↑maternal age (↑risk of maternal uniparental disomy), hydrocarbon exposure (in the father), conception using assisted reproductive technology, sibling with PWS.
- **A:** 70% due to paternal deletion, 30% due to maternal disomy. **P:** attributed to hypothalamic dysfunction.
- **S/Smx:** hypotonia in infancy (associated with breathing problems); dysmorphic features; short stature; learning difficulties; hypogonadism and infertility; hyperphagia + obesity in later childhood.
- **P:** shorter life expectancy, mainly due to complications of hyperphagia and obesity.

## Angelman syndrome

- **D:** neurodevelopmental disorder due to absence of expression of maternally inherited imprinted genes on chromosome 15q11-q13.
- **S/Smx:** severe intellectual disability; postnatal microcephaly; movement or balance disorder (gait ataxia or tremor of limbs); behavioural abnormalities (apparent happy demeanour with emotional lability, excitable personality); seizure disorder, baseline EEG changes, and sleep disorder; GI problems.


<!-- ===== SOURCE: 15_21a_Paeds_-_Microdeletion_Syndromes__Cri_du_Chat__DiGeorge__Williams_.md ===== -->


## Cri du chat syndrome

- **D:** 5p microdeletion. Most deletions occur de novo, 80–90% paternal.
- **S/Smx:** high pitched cry in infancy; hypotonia; microcephaly and micrognathism; intellectual disability (severity depends on size of deletion); feeding difficulties.
- **P:** 10% survive >1 year. Morbidity & mortality decrease after the first few years of life.

## DiGeorge syndrome

- **D:** 22q11 deletion syndrome, aka velocardiofacial syndrome.
- **R:** family history. **A:** 22q11.2 deletion. **P:** deletion → ↓TBX1, a key transcription factor for development of the pharyngeal arches.

> [!tip] Mnemonic — "CATCH-22"
> - **C**onotruncal cardiac defects (e.g. Tetralogy of Fallot).
> - **A**bnormal facies.
> - **T**hymic a/hypoplasia.
> - **C**left palate.
> - **H**ypocalcaemia.
> - Others: intellectual disability, autism, ADHD.

- **Mx:** supportive treatment of complications (no cure).
- **P:** complete DGS (<1% of patients) has a very poor prognosis — most die by age 1. Depending on severity, patients can survive into adulthood.

## Williams syndrome

- **D:** 7q11 microdeletion, including the elastin gene.
- **S/Smx:** elfin-like facial features; supravalvular aortic stenosis; mild-to-moderate learning difficulties; short stature; endocrine abnormalities (hypercalcaemia, hypothyroidism, delayed growth or early puberty).
- **P:** 50% chance of a parent with Williams syndrome passing the microdeletion to their children. If cardiac abnormalities are managed, patients can have a relatively normal life.


<!-- ===== SOURCE: 15_21b_Paeds_-_Fragile_X__Achondroplasia__Noonan__Marfan.md ===== -->


## Fragile X syndrome

- **D:** X-linked recessive trinucleotide repeat disorder. The most common monogenic cause of autism spectrum disorder.
- **R:** family history. **A/P:** CGG repetition within the fragile X mental retardation 1 gene → ↓gene expression.
- **S/Smx:** not apparent in newborns; symptoms develop in early childhood (average diagnosis at ~32 months, or 2 years 8 months). Characteristic facies — elongated, narrow face, broad forehead and philtrum, high-arched palate, protruding/large ears.
- **May present due to:** autistic behaviours (e.g. hand flapping, repetitive tasks); poor eye contact; developmental delay; seizures; psychiatric symptoms (anxiety, depression, ADHD); sleep disturbance; aggression.
- In males, macro-orchidism is a hallmark of FXS. A Prader-Willi-like phenotype may also be observed.
- **P:** depending on severity, some patients can lead relatively normal lives.
- **Premutation carriers** have less severe cognitive deficits BUT a high risk of developing Fragile X-associated tremor/ataxia syndrome (FXTAS) — presents in the 6th decade of life with tremors, ataxia, and neuropsychiatric conditions.

## Achondroplasia

- **D:** autosomal dominantly inherited skeletal dysplastic disorder resulting in disproportionately short stature.
- **R:** family history, ↑parental age (for de novo mutations).
- **A:** de novo mutation in 70–80% of cases. **P:** gain of function mutation in the FGFR3 gene → inhibits chondrocyte proliferation → ↓endochondral bone formation, growth restriction, bone shortening, etc.
- **S/Smx:** distinctive craniofacial features — macrocephaly, frontal bossing, midface retrusion, saddle nose deformity. Disproportionate short stature with shortening of arms & legs. Shortening of fingers and toes (brachydactyly) + trident hands. Kyphoscoliosis. Accentuated lumbar lordosis.
- **P:** ↑mortality in childhood. Mean lifespan ~61 years old (~10 years less than the general population).

## Noonan syndrome

- **D:** autosomal dominant inherited disorder characterised by short stature and congenital heart disease. 1:1000–2500 births.
- **R:** family history, ↑paternal age. **A:** gain of function mutation in various genes.
- **S/Smx** (sometimes described as "male Turner's syndrome"): short stature; webbed neck; pectus carinatum or excavatum; widely spaced nipples. Facial features: ptosis, triangular-shaped face, low-set ears. Cardiac: pulmonary valve stenosis. Haematological: factor XI deficiency.
- **Ix:** ECG + echo.
- **Mx:** monitor for cardiac complications. Cryptorchidism — refer to urology. If poor growth, refer to endocrinology (may start on growth hormone).
- **P:** the majority have normal lives; prognosis depends on the type and severity of cardiac disease.

## Marfan syndrome

- **D:** autosomal dominant inherited disorder of connective tissue characterised by loss of elastic tissue. 1:3000 births.
- **R:** family history of Marfan's, family history of aortic dissection or aneurysm, ↑paternal age (in de novo mutations).
- **A:** inherited in 75%, de novo in 25%. **P:** mutation on the FBN1 gene on chromosome 15 → ↓fibrillin-1.
- **S/Smx:**
  - Physical: tall with long arms; high-arched palate; long fingers (arachnodactyly); pectus excavatum; pes planus; scoliosis >20°.
  - Cardiac: dilation of the aortic sinuses (90%) — aortic aneurysms, aortic dissection, aortic regurgitation; mitral valve prolapse (75%).
  - Lungs: repeated pneumothoraces.
  - Eyes: upward lens dislocation; blue sclera; myopia.
  - Others: dural ectasia (ballooning of the dural sac at the lumbosacral level).
- **Ix:** aortic root imaging (echo, thorax CT, or thorax MRI); visualising the descending aorta (abdominal US, CT, or MRI); CXR for pneumothorax.
- **Mx:**
  - Aortic monitoring.
  - In patients with aortic dilation, beta-blockers used to prevent further dilation — if contraindicated (e.g. asthma), losartan or verapamil may be used. If aortic diameter >4.5cm, or symptomatic (e.g. chest pain), consider surgery.
...
## 0.5 School Refusal and Behavioural Concerns

> [!danger] School refusal is not truancy — and the distinction changes everything
> | | **SCHOOL REFUSAL** | **TRUANCY** |
> |---|---|---|
> | Where are they? | **AT HOME, and the parents KNOW** | Elsewhere, CONCEALED from parents |
> | Emotional state | **SEVERE DISTRESS and anxiety about attending** | No distress about missing school |
> | Antisocial behaviour | Absent | Often present |
> | Schoolwork | **Willing to do it at home** | Not interested |
> | Underlying driver | **ANXIETY or mood disorder** | Conduct issues, disengagement |
> **School refusal is an ANXIETY problem presenting as an attendance problem, and treating it as defiance guarantees failure.**

> [!warning] Somatic symptoms are the usual presentation
...
> **THEREFORE: EARLY INTERVENTION IS THE PRIORITY, and prolonged medical certification of absence is actively harmful.**
> **Writing a certificate that endorses ongoing absence — however sympathetically intended — reinforces the avoidance and entrenches the problem.** **Certify what is needed for an acute illness, and otherwise work toward return rather than absence.**
> **What helps: a GRADED RETURN plan (partial days, a specific safe person and place at school, building up) · liaison with the SCHOOL, which is essential and requires consent · treating the underlying anxiety or depression · identifying and addressing BULLYING · identifying UNDIAGNOSED learning difficulty or neurodevelopmental condition · and supporting the parents, who are usually exhausted and receiving conflicting advice.**

> [!warning] Behavioural concerns — look for what is underneath
...
> **· SUBSTANCE USE.**
> **· SLEEP disorder.**
> **· An environment that is not meeting the child's needs.**
> **Parenting programs and behavioural interventions have good evidence and should be offered without implying blame** — parents of a difficult child are usually doing their best under strain and have often been told they are the problem.
...
> **THE MULTIPLE-SETTINGS REQUIREMENT IS THE ONE THAT DOES THE WORK.** **Behaviour that occurs only at home, or only at school, points to something in that environment — a family issue, a specific learning difficulty, bullying, a particular teacher — rather than to ADHD.**
> **This is why information from SCHOOL is essential and the diagnosis cannot be made from a single consultation.**

> [!warning] The inattentive presentation is the one that gets missed
> **· PREDOMINANTLY INATTENTIVE — disorganisation, losing things, not finishing work, appearing not to listen, daydreaming, careless errors, avoiding sustained mental effort.** **These children are NOT disruptive, so they do not come to attention.** **They present later, as academic underachievement, or as anxiety, or not at all.**
> **· GIRLS ARE SUBSTANTIALLY UNDER-DIAGNOSED**, both because the inattentive presentation predominates and because they compensate and mask, often at considerable cost, until demands increase. **Many are diagnosed in adulthood, frequently after their own child is assessed.**
> **· PREDOMINANTLY HYPERACTIVE-IMPULSIVE and COMBINED presentations are more visible and are diagnosed earlier.**
...
> **· AUTISM — which frequently coexists.**
> **· IRON DEFICIENCY, thyroid dysfunction, and substance use in adolescents.**
> **COMORBIDITY IS THE RULE, NOT THE EXCEPTION** — most children with ADHD have at least one coexisting condition, and treating only the ADHD leaves the child impaired.

> [!tip] Management is multimodal — medication is one component
> **· PARENT AND TEACHER EDUCATION about the condition, which reframes the behaviour and reduces punitive responses.**
> **· BEHAVIOURAL strategies and parent training programs, with good evidence.**
> **· EDUCATIONAL ADJUSTMENTS — seating, chunked tasks, extra time, movement breaks, and a formal learning plan.**
> **· Treatment of comorbid conditions.**
> **· MEDICATION — stimulants (methylphenidate, dexamfetamine, lisdexamfetamine) are highly effective for core symptoms; non-stimulants (atomoxetine, guanfacine) are alternatives.**
> **Monitoring on stimulants: APPETITE SUPPRESSION with monitoring of HEIGHT AND WEIGHT on a growth chart · sleep · mood and irritability, including rebound as the dose wears off · tics · and CARDIOVASCULAR effects.**
> **BEFORE STARTING A STIMULANT: take a cardiac history and a FAMILY HISTORY OF SUDDEN CARDIAC DEATH, and record baseline heart rate, blood pressure, height and weight.** `UNVERIFIED — the requirement for an ECG, and all doses.`
> **In Australia, stimulant prescribing is REGULATED and generally requires specialist involvement and a state authority.** `UNVERIFIED — the SA requirements.`
> **DIVERSION AND MISUSE of prescribed stimulants is a genuine issue among adolescents and students** — ask about it non-judgementally, and think about quantity, supervision and storage.
