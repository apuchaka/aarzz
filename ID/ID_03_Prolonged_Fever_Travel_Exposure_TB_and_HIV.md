...
split_from: "Infectious Disease_merged.md"
part: "3 of 9"
---

> [!note] **Continues `08_09_Infectious_Disease_-_Miscellaneous` from `ID_02_Skin_and_Soft_Tissue_Infection_and_Sepsis`.**
> That source block is split across `ID_02_Skin_and_Soft_Tissue_Infection_and_Sepsis` · `ID_03_Prolonged_Fever_Travel_Exposure_TB_and_HIV`.
> The alias `08_09_Infectious_Disease_-_Miscellaneous` resolves to `ID_02_Skin_and_Soft_Tissue_Infection_and_Sepsis`, which holds its largest part.
...
`CF-PAIR` **`ID_01_Fever_Approach_and_Workup K1 §0.3 Fever of Unknown Origin and Prolonged Fever` marks the threshold, the duration and the definition of "appropriate initial investigation" `UNVERIFIED` and states none of them.** Both kept, neither reconciled.
