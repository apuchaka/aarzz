...
> 2. **Clinical process / ethics / legal → [[Clinical-Process-EBM-Consent-Capacity]]**: documenting in the medical notes, mandatory reporting as a general duty. **Both moved on 2026-09-01 to `[[A10_Ethics__Capacity__Consent_and_Certification]] ## Documenting in the Medical Notes` and `## Mandatory Reporting — the Overarching Duty`** — go there, not to the split file.
