...
> [!warning] Sourcing
> Written from model knowledge, not retrieved from guidelines. Principles, mechanism and clinical reasoning are reliable at intern level. **Every score, threshold, dose and program name carries an `UNVERIFIED` marker naming what to check, or has been omitted with the omission stated in place.**
> **Two areas need particular care.** First, **the Australian aged care system is mid-reform** — the Support at Home program is replacing existing home care arrangements, and program names, eligibility and funding have changed. Verify everything in 0.3 against **My Aged Care** and current Department of Health and Aged Care material. Second, **osteoporosis pharmacotherapy has PBS authority criteria** that determine what can actually be prescribed — verify against the PBS and current Healthy Bones Australia / RACGP guidance.

---

## 0.1 Comprehensive Geriatric Assessment
...
## 0.3 Functional Assessment and the Australian Aged Care System
...
## 0.4 Polypharmacy and Deprescribing
...
> [!note] Gap-filled from CSV ("Frailty phenotype / frailty assessment," High yield). **A second account of frailty is in this file at `GER1 §0.2 Frailty` (L70)** — Fried phenotype, Clinical Frailty Scale, sarcopenia, Ix and Mx. Both retained, neither reconciled. (This note previously asserted frailty was absent from the corpus; that was written against the pre-merge corpus and is no longer true.) Verified against the RACGP aged care clinical guide (Silver Book, 5th edition) Part A "Frailty", the Australian Consensus Statement on the Prevention and Management of Frailty Among Community-Dwelling Older Adults (MJA, modified Delphi), and the AJGP review of sarcopenia in general practice, Aug 2026.
...
- **Goals of care conversations become timely**, not premature — see [[A10_Ethics__Capacity__Consent_and_Certification]] §1.3 Discussing "Do Not Attempt Cardiopulmonary Resuscitation" (DNACPR / Not-for-Resuscitation) for that conversation, and [[A10_Ethics__Capacity__Consent_and_Certification]] Capacity assessment — the general framework for the capacity question that underlies it.
...
> [!note] Gap-filled from CSV ("Polypharmacy review / deprescribing in the elderly," High yield). **A second account is in this file at `GER1 §0.4 Polypharmacy and Deprescribing` (L153)**, which carries Beers, STOPP/START, the prescribing cascade and tapering. Both retained, neither reconciled. The OSCE framing is in [[Communication]] Management of Patients with Multiple Chronic Medical Problems and [[Communication]] Caring for the Elderly in the Community (Dementia, Mobility, Parkinson's, Recurrent Falls). (This note previously asserted all four were absent from the corpus; that was written against the pre-merge corpus and is no longer true.) Verified against the RACGP aged care clinical guide (Silver Book, 5th edition) Parts A "Polypharmacy" and "Deprescribing", and the *Deprescribing in Older People: A Clinical Practice Guideline* summary (MJA, 2026), Aug 2026.
...
> - Other pathways: the **Office of the Public Advocate** and the relevant state tribunal (**SACAT** in South Australia) where guardianship or financial administration is in question — the same bodies already named in [[A10_Ethics__Capacity__Consent_and_Certification]] Consent to Medical Treatment and Palliative Care Act 1995 (SA) for capacity disputes.
...
## 0.6 Advance Care Planning in Practice

**D:** The process by which a person reflects on their values and preferences for future care, discusses them with those close to them and with their clinicians, and — where they choose — records them and appoints a substitute decision-maker.
...
> Better:
> **· "Have you ever thought about what would be important to you if you became more unwell?"**
> **· "Some people have strong views about what they would and wouldn't want. Have you thought about that?"**
> **· "If you couldn't speak for yourself, who would you want to speak for you? Do they know what you'd want?"**
> **· "What worries you most about the future?"**
> **· "What would a good day look like for you?"**
> **Anchor it in values and outcomes rather than in a checklist of procedures.** Most people cannot meaningfully consent to or refuse "intubation" in the abstract, but they can say clearly whether they would accept a treatment that left them permanently unable to recognise their family or live at home.

> [!warning] Goals-of-care documentation
> Australian hospitals use structured goals-of-care or resuscitation planning forms to translate these discussions into an actionable clinical order — specifying the ceiling of care, whether ICU or CPR is appropriate, and what the focus of treatment is.
> **Complete it early in the admission for anyone in whom deterioration is plausible**, rather than after hours when the patient is already deteriorating and the family is being called for the first time.
> **A "not for CPR" order is not "not for treatment"** — this must be stated explicitly to families and documented, because the assumption that one implies the other leads to genuine undertreatment. Specify what IS being provided.
> `UNVERIFIED — the SA Health goals-of-care and resuscitation planning forms and their current names and structure.`

> [!danger] A directive nobody can find is useless
> **The single commonest practical failure: the advance care directive exists, and it is in a drawer at home.**
...
### 0.6.1 Mx – Immediate
Complete goals-of-care documentation early in any admission where deterioration is foreseeable.

### 0.6.2 Mx – Definitive
Support completion of an advance care directive and appointment of a substitute decision-maker while capacity is retained.

### 0.6.3 Mx – Chronic/long-term
**Communicate the plan to everyone who needs it — GP, family, residential facility, My Health Record — and review it at intervals and after any significant change in health.**
...
> [!note] Two sources moved out of this file on 2026-09-01
> **`GER3_Preventive_and_Occupational_Health` is now [[Preventive-Health]]** and
> **`GER4_Safeguarding_and_Forensic` is now [[Safeguarding]]**. Both were filed here because of the
> `GER` prefix and nothing else: `GER4` had **37 inbound references, 14 of them from Paediatrics and
> only 1 from geriatrics content**; `GER3` had 31.
> **The `[[GER3]]` and `[[GER4]]` wikilinks throughout the vault still resolve** — they name the
> source file, which is unchanged.
> **What stays here is genuinely geriatric:** `18_Geriatrics_and_Older_Persons_Health` ·
> `GER1_Comprehensive_Geriatric_Assessment` · `GER2_Geriatric_Syndromes_and_End_of_Life_Care`.
> **`GER4 §0.6 Elder Abuse and Adults at Risk` was the one part with a geriatric claim** — its
...
> [!note] **Nothing was built in this category.** Geriatrics has exactly one topic on the build list, **Falls [T1]**, and it matched existing corpus headers. This file exists to record that decision rather than leaving a Tier 1 topic with no trace.

## Topics skipped in this category

| Topic | Tier | Matched header | File | Match type |
|---|---|---|---|---|
| **Falls** | **T1** | `## Falls in Older People` | `18_Geriatrics_and_Older_Persons_Health.md` | Partial — the topic name appears in the header |
| | | `### Assessment — the multifactorial falls risk assessment` | `18_Geriatrics_and_Older_Persons_Health.md` | Supporting match — an assessment section already exists |
| | | `### Distinguishing a fall from a collapse — do the...` | `18_Geriatrics_and_Older_Persons_Health.md` | Supporting match |

> [!warning] **This is a Tier 1 topic that was skipped, so please check it specifically.**
> The existing corpus content looks substantial — a main entry plus a multifactorial risk assessment section plus an explicit fall-versus-collapse discriminator, which is the highest-yield distinction in the presentation. On that basis the skip looks safe, and safer than the `Stridor` T1 skip recorded in `NEW_Respiratory.md`.
> **What I did not verify** is whether the existing entry delivers this build list's specific product — **differential diagnosis, focused history, examination, first-line investigations** — as opposed to management and risk-reduction content. Confirming that needs a reading of the existing entry, which is a review task rather than a header check, and the brief was explicit that a header match means skip and report.
> Note also that `18_Geriatrics_and_Older_Persons_Health.md` carries an **open item in `PENDING_GUIDELINE_CHECKS.md` (B17)** on the Timed Up and Go cut-off, where sources genuinely disagree between >10 s and >12 s and the entry deliberately states the range. If you build or revise falls content, that open question sits inside it.
