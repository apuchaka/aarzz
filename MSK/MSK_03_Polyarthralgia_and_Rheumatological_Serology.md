...
> [!note] **Continues `Investigation-Interpretation` from `MSK_02_Hot_Swollen_Joint_and_Orthopaedic_Emergencies`.**
> That source block is split across `MSK_02_Hot_Swollen_Joint_and_Orthopaedic_Emergencies` · `MSK_03_Polyarthralgia_and_Rheumatological_Serology` · `MSK_07_Soft_Tissue_Injury_and_Fractures`.
> The alias `Investigation-Interpretation` resolves to `MSK_03_Polyarthralgia_and_Rheumatological_Serology`, which holds its largest part.
