...
> [!note] **MERGED INTO `[[Procedures]]` — C2 / AXIS-2, 2026-09-01.**
> All six sections (`§0.1` Procedural Safety · `§0.2` Gastroscopy · `§0.3` Gastrografin ·
> `§0.4` PTC · `§0.5` Arthrocentesis · `§0.6` Arthroscopy) reproduced verbatim there under a
> `SOURCE:` divider naming this file.
>
> **`GER8` has its real parent now.** It was filed under Geriatrics because of the `GER` prefix
> and has no geriatric content — the same folder error as `GER3` and `GER4`.
