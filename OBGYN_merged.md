...
> [!note] **Moved to `[[Investigation-Interpretation]]` Part 2 on 2026-09-01 — 12 sections from this source block.**
>
> `0.1 Cervical Screening Test and Cervical Screening Abnormality (Austra` · `0.2 Liquid-Based Cytology (LBC)` · `0.3 Genital / Cervical Swab Panel` · `0.4 Hormone Panel (Gynaecological / Reproductive)` · `0.5 Prenatal Screening Panel` · `0.6 Chorionic Villus Sampling (CVS)` · `0.7 Amniocentesis` · `0.8 Cordocentesis (Percutaneous Umbilical Blood Sampling, PUBS)` · `0.9 Kleihauer-Betke Test (Fetomaternal Haemorrhage Quantification)` · `0.10 Ferning Test and Nitrazine Test (Confirming Rupture of Membranes)` · `0.11 Fetal Fibronectin (fFN)` · `0.12 Biophysical Profile (BPP)`
>
