...
> [!note] **Moved to `[[Investigation-Interpretation]]` Part 2 on 2026-09-01 — 8 sections from this source block.**
>
> `0.1 Nasopharyngeal Swab (Respiratory Virus / Atypical PCR)` · `0.2 Pulmonary Function Tests (Spirometry, Lung Volumes, DLCO)` · `0.3 Pulse Oximetry (SpO₂)` · `0.4 Sleep Studies (Polysomnography, Home Sleep Apnoea Testing)` · `0.5 Sputum Culture (with Gram Stain and Microscopy)` · `0.6 Sweat Chloride Test` · `0.7 Tuberculosis Screening (Tuberculin Skin Test / Mantoux, and IGRA)` · `0.8 V/Q Scan (Ventilation–Perfusion Scintigraphy, including V/Q SPECT)`
>
> Moved under the standing rule as extended to investigation interpretation: **how to read the
> test** is owned by `[[Investigation-Interpretation]]`; **what the result means in this disease**
> stays here, in each condition's own `Ix:` entry. The sections are reproduced there **verbatim and
...
> **Progressive exertional dyspnoea and a persistent DRY cough**, developing over months.
> **Fine, dry, end-inspiratory crackles — described as "velcro" crackles — typically at the bases and not clearing with coughing.**
> **CLUBBING**, particularly in idiopathic pulmonary fibrosis.
> **Exertional desaturation** — **and this is the key physiological point: the resting saturation can be entirely normal while the patient desaturates markedly on walking.** **A resting saturation is not a screening test for ILD — walk them.**

> [!info] Classification, which drives everything
> **· KNOWN CAUSE** — **drugs · connective tissue disease · occupational and environmental exposure · radiation · infection.**
> **· IDIOPATHIC INTERSTITIAL PNEUMONIAS** — of which **idiopathic pulmonary fibrosis (IPF)** is the commonest and most important.
> **· GRANULOMATOUS** — **sarcoidosis, hypersensitivity pneumonitis.**
> **· OTHER** — lymphangioleiomyomatosis, pulmonary alveolar proteinosis, eosinophilic pneumonias.
> **The first task in any new ILD is to look for a cause, because several are reversible and the treatment differs completely between fibrotic and inflammatory disease.**

> [!danger] Idiopathic pulmonary fibrosis — and why steroids are the wrong reflex
> **Older patients, more often male, usually with a smoking history.** A **usual interstitial pneumonia (UIP) pattern** on high-resolution CT — **subpleural and basal predominant reticulation, HONEYCOMBING, and traction bronchiectasis.**
> **Progressive and ultimately fatal, with a median survival that compares unfavourably with many cancers.**
> **ANTIFIBROTIC therapy (pirfenidone, nintedanib) slows the decline in lung function** and is the mainstay.
...
> **This produced an epidemic of ACCELERATED SILICOSIS in young Australian stonemasons — a disease of years rather than decades, in workers in their twenties and thirties, some requiring lung transplantation.**
...
> **"Are your symptoms better on days off, on weekends, or on holiday, and worse when you go back?"**
> **A clear improvement away from work and deterioration on return is the hallmark**, and it is the single most useful question.
> **Common agents: ISOCYANATES (spray painting, polyurethane), flour and grain dust (bakers), latex, laboratory animals, wood dusts, epoxy resins, colophony (soldering flux), persulfates (hairdressing), and cleaning agents.**
> **EARLY REMOVAL FROM EXPOSURE IS CRITICAL.** **Continued exposure after sensitisation leads to persistent asthma that does not resolve even after the exposure ends** — so the diagnosis is time-sensitive in a way that ordinary asthma is not.
> Confirmed with **serial peak flow monitoring at and away from work**, and specialist assessment.
> **Distinguish from work-EXACERBATED asthma** — pre-existing asthma worsened by irritants at work — which has different implications for employment and compensation.

> [!tip] The other occupational lung diseases
> **· Coal workers' pneumoconiosis** — **re-emerged in Australian coal mining, notably in Queensland, after a period of assumed elimination**, following failures of dust monitoring and health surveillance.
> **· Asbestos-related disease** — see 0.3.
> **· Hypersensitivity pneumonitis** — farmer's lung, bird fancier's lung, and many others. See 0.1.
> **· Occupational COPD** — **a meaningful proportion of COPD is attributable to occupational dust, gas and fume exposure rather than to smoking**, and this is under-recognised in both diagnosis and compensation.
...
> `UNVERIFIED — the SA notification requirements, forms and thresholds.`

**Ix:** **Detailed occupational and exposure history, including a chronological job list** (*why:* the diagnosis is made by the history; *what:* the exposure and its timing). **Serial peak expiratory flow measurements at work and away from work** (*why:* the practical way to demonstrate occupational asthma; *what:* work-related variability). Spirometry with reversibility (*why:* obstruction and its reversibility; *what:* airflow limitation). **Chest radiograph and HRCT** (*why:* pneumoconiosis pattern and complications; *what:* nodules, eggshell calcification, progressive massive fibrosis, pleural disease). Specific IgE or skin prick testing to occupational allergens where available (*why:* confirms sensitisation to a specific agent; *what:* positive result). **TB screening in silicosis** (*why:* substantially increased risk; *what:* latent or active TB).

---

## 0.3 Asbestos-Related Disease

> [!warning] Australia's exposure history is unusually high, and home renovation is now a leading source
> **Australia had among the highest per-capita rates of asbestos use in the world**, with widespread use in building products until the 1980s and a total ban from the early 2000s. **Wittenoom in Western Australia is one of the most contaminated sites in the southern hemisphere.**
> **The occupational exposures — construction, insulation, shipbuilding, power stations, brake linings, carpentry, plumbing and electrical work — are now decades in the past, and the disease is presenting now because of the LONG LATENCY.**
> **The contemporary exposure that matters is DIY HOME RENOVATION**, disturbing asbestos cement sheeting in houses built before the ban. **Ask about renovation, not just about occupation** — and this is a public health message worth giving.

> [!info] The spectrum — benign to malignant
> **BENIGN:**
> **· PLEURAL PLAQUES — discrete areas of pleural thickening, often calcified. They are a MARKER OF EXPOSURE, not a disease: they do not cause symptoms, do not impair function meaningfully, and do not become malignant.** **Explaining this clearly matters**, because their discovery causes considerable and often unnecessary alarm — while still confirming an exposure that warrants awareness of the other risks.
> **· Benign asbestos-related pleural effusion** — typically the earliest manifestation.
> **· Diffuse pleural thickening** — which unlike plaques CAN cause restrictive impairment.
> **· Rounded atelectasis** — a mass-like lesion that mimics malignancy on imaging.
> **MALIGNANT AND FIBROTIC:**
> **· ASBESTOSIS — interstitial fibrosis, dose-related, basal and subpleural**, requiring substantial cumulative exposure.
> **· LUNG CANCER — and the risk from asbestos and smoking is MULTIPLICATIVE, not additive.** **This makes smoking cessation disproportionately valuable in asbestos-exposed people**, and it is a concrete and motivating thing to tell them.
> **· MESOTHELIOMA.**

> [!danger] Mesothelioma
> **Latency of decades, and it can follow relatively LOW-level exposure — including domestic and bystander exposure (washing a worker's clothes, living near a site).** There is no clear safe threshold.
> **Usually PLEURAL, occasionally peritoneal.** Presents with **breathlessness, a unilateral pleural effusion, and chest wall pain that is often persistent and non-pleuritic.**
> **Diagnosis usually requires PLEURAL TISSUE — cytology alone is frequently insufficient** — so **local anaesthetic thoracoscopy or image-guided biopsy is generally needed rather than repeated aspirations.**
> **Tract seeding along procedure sites occurs**, which is a reason to plan the diagnostic approach with the respiratory or thoracic team rather than performing repeated ad hoc pleural procedures.
> **Prognosis remains poor.** Management involves oncology, palliative care, and pleural symptom control.
> **COMPENSATION IS A CENTRAL PART OF MANAGEMENT.** **Australian dust diseases schemes and legal avenues exist, and the diagnosis should trigger prompt advice**, because claims are time-sensitive and prognosis is short. **Raising this early is a kindness, not an intrusion**, and failing to mention it deprives families of significant support.

**Ix:** **Detailed exposure history including occupation, second-hand exposure and home renovation, with dates** (*why:* establishes attribution, which matters both clinically and for compensation; *what:* the exposure timeline). **Chest radiograph and HRCT** (*why:* distinguishes plaques from thickening, fibrosis and malignancy; *what:* pleural plaques, diffuse thickening, fibrosis, effusion, mass). **Pleural fluid analysis and PLEURAL BIOPSY where mesothelioma is suspected** (*why:* cytology is often non-diagnostic and tissue is required; *what:* histology with immunohistochemistry). Pulmonary function tests (*why:* quantifies restriction and gas transfer for management and compensation; *what:* restrictive defect, reduced DLCO). PET-CT (*why:* staging and biopsy targeting in suspected mesothelioma; *what:* pleural uptake, nodal and distant disease).

### 0.3.1 Mx – Immediate
Drainage of a symptomatic effusion, with the diagnostic plan agreed in advance.

### 0.3.2 Mx – Definitive
Disease-specific. **Reassurance and explanation for isolated pleural plaques.**

### 0.3.3 Mx – Chronic/long-term
**Smoking cessation, emphasised because of the multiplicative lung cancer risk.** **Compensation and legal referral.** Vaccination. **Notification where required.** Symptom-focused and palliative care in mesothelioma, involved early.

---

## 0.4 Bronchiectasis

**A/P:** **Permanent, abnormal dilatation of the bronchi.** The mechanism is a **self-perpetuating vicious cycle: impaired mucociliary clearance → bacterial colonisation and infection → neutrophilic inflammation → structural airway damage → further impaired clearance.**
**Breaking that cycle — principally through AIRWAY CLEARANCE and control of infection — is the entire treatment strategy.**

> [!warning] Look for a cause — it changes management in a meaningful proportion
...
> [!tip] Management — airway clearance is the foundation
> **· AIRWAY CLEARANCE, taught by a respiratory physiotherapist, performed daily and lifelong** — active cycle of breathing, autogenic drainage, positive expiratory pressure devices. **This is the single most important intervention and the one most often not arranged.**
> **· EXERCISE and pulmonary rehabilitation.**
> **· Treat exacerbations with LONGER antibiotic courses than in ordinary chest infection, guided by previous sputum cultures.**
> **· ERADICATION therapy for newly isolated *Pseudomonas aeruginosa*** — because chronic *Pseudomonas* colonisation is associated with worse outcomes, and there is a window to eradicate it.
> **· Long-term macrolide (azithromycin) in frequent exacerbators** — **but SCREEN FOR NON-TUBERCULOUS MYCOBACTERIA FIRST**, because macrolide monotherapy in undiagnosed NTM infection induces resistance and compromises future treatment. **Also check the QT interval and consider hearing.**
> **· Vaccination — influenza, pneumococcal, COVID-19.**
> **· DO NOT use inhaled corticosteroids routinely** unless there is coexisting asthma or COPD — they increase pneumonia risk without benefit in bronchiectasis alone.
> **· Surgery for localised disease, and transplantation in end-stage disease.**
> `UNVERIFIED — antibiotic regimens, durations, eradication protocols and macrolide dosing.`
...
**Physiotherapy, exercise, vaccination, sputum surveillance, nutrition, and monitoring for *Pseudomonas* and NTM acquisition.**

---

## 0.5 Sleep-Disordered Breathing

> [!tip] Obstructive sleep apnoea
> **Repetitive collapse of the upper airway during sleep, producing apnoeas and hypopnoeas with arousals and intermittent hypoxaemia.**
> **Risk factors: obesity and increased neck circumference · male sex · increasing age · retrognathia and craniofacial structure · nasal obstruction · alcohol and sedatives · hypothyroidism and acromegaly · menopause · and, in children, ADENOTONSILLAR HYPERTROPHY.**
> **Symptoms: snoring, witnessed apnoeas, choking or gasping arousals, unrefreshing sleep, morning headache, nocturia, and EXCESSIVE DAYTIME SLEEPINESS** — though **sleepiness is often denied, and the bed partner's account is more reliable than the patient's.**
...
> **· CPAP — first-line for moderate to severe disease.** Adherence is the main determinant of benefit, and **mask fit, humidification, pressure titration and early follow-up determine whether the patient continues.** Someone abandoning CPAP usually has a solvable practical problem.
> **· Mandibular advancement splint** — effective in mild to moderate disease and for those who cannot tolerate CPAP.
> **· Positional therapy** where the apnoeas are supine-predominant.
> **· Avoidance of alcohol and sedatives**, and treatment of nasal obstruction.
> **· Surgery** — adenotonsillectomy is curative in most children; upper airway surgery in selected adults.
> **CENTRAL sleep apnoea** is a different entity — **heart failure (with Cheyne-Stokes respiration), opioids, stroke, and high altitude.** **Opioid-induced central sleep apnoea is increasingly recognised and is a reason to review opioid dosing.**
> `UNVERIFIED — AHI severity thresholds, screening tool cut-offs (STOP-BANG, Epworth) and CPAP eligibility.`

**Ix:** **Polysomnography, or a home sleep study in appropriate patients** (*why:* diagnostic and grades severity, which determines treatment and driving advice; *what:* apnoea-hypopnoea index, oxygen desaturation, sleep architecture). **Epworth Sleepiness Scale and STOP-BANG** (*why:* screening and quantifying sleepiness, and useful for documenting the driving discussion; *what:* scores). **Serum bicarbonate, then arterial or venous blood gas** (*why:* screens for and confirms chronic hypercapnia; *what:* raised bicarbonate, raised pCO₂). TFTs (*why:* hypothyroidism contributes and is reversible; *what:* raised TSH). Echocardiography where pulmonary hypertension or heart failure is suspected (*why:* cor pulmonale and cardiac contribution; *what:* right heart changes). **Collateral history from the bed partner** (*why:* patients under-report sleepiness and cannot report their own apnoeas; *what:* witnessed apnoeas, snoring, restlessness).

---

## 0.6 Chronic Respiratory Failure and Long-Term Management

> [!danger] Long-term oxygen therapy — narrow criteria, and it is not a treatment for breathlessness
> **LTOT improves SURVIVAL in COPD only in patients with SEVERE RESTING HYPOXAEMIA who meet defined criteria and who use it for at least 15 hours per day**, including overnight.
> **It does NOT improve survival, and generally does not improve symptoms, in patients with:**
> **· Breathlessness WITHOUT resting hypoxaemia.**
> **· ISOLATED EXERTIONAL desaturation.**
> **· Mild or moderate hypoxaemia.**
> **Prescribing oxygen for breathlessness in a non-hypoxaemic patient is common, ineffective, and burdensome** — and a handheld fan works better (see below).
> **SMOKING IS A CONTRAINDICATION — home oxygen and cigarettes cause fires, burns and deaths, and this is not a theoretical concern.**
> **Assessment must be made when the patient is STABLE, not during or immediately after an exacerbation**, when hypoxaemia may be transient. `UNVERIFIED — the PaO₂ and saturation criteria, the stability interval before assessment, and TSANZ eligibility.`
...
> **It is offered to a small fraction of eligible patients.**
> **Referral after an exacerbation is particularly valuable and particularly neglected.**
> **If there is one thing to remember to do for a patient with chronic lung disease, it is to refer them.**

> [!tip] Refractory breathlessness — what actually helps
...
> [!warning] Advance care planning in chronic lung disease is systematically neglected
